...
public final class AgingScheduling {
    ...
    /**
     * Updates the aging-related fields of a task.
     *
     * @param task the task whose aging state should be updated
     */
    private void updateTaskAging(Task task) {
        task.waitTime++;
