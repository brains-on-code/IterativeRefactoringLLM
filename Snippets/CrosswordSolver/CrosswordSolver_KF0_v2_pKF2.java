...
public final class CrosswordSolver {
     ...
     * ({@code row}, {@code col}) in the given orientation.
     *
    ...
    /**
     * Writes {@code word} into the puzzle starting at ({@code row}, {@code col})
    ...
    /**
     * Clears the cells occupied by {@code word} starting at ({@code row}, {@code col})
     * in the given orientation, restoring them to {@link #EMPTY_CELL}.
     */
