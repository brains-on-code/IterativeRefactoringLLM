...
class Graph<E extends Comparable<E>> {
    ...
    private class Vertex {
         ...
         *
         * @param target vertex to connect to
         ...
         *
         * @param targetValue value of the vertex to disconnect from
     ...
     *
     * @param from source vertex value
     * @param to   target vertex value
     ...
     *
     * @param value value of the vertex to find
     * @return vertex with the given value, or {@code null} if not found
     */
