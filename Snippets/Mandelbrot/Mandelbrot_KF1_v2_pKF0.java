...
public final class Class1 {
    ...
    public static void method1(String[] args) {
        ...
        assertPixelColor(blackWhiteImage, DEFAULT_IMAGE_WIDTH / 2, DEFAULT_IMAGE_HEIGHT / 2, Color.BLACK);
        ...
        assertPixelColor(coloredImage, DEFAULT_IMAGE_WIDTH / 2, DEFAULT_IMAGE_HEIGHT / 2, Color.BLACK);
    ...
    public static BufferedImage generateMandelbrotImage(
        ...
        for (int x = 0; x < imageWidth; x++) {
            ...
            for (int y = 0; y < imageHeight; y++) {
                double imaginary = computeImaginaryCoordinate(y, imageHeight, centerY, viewHeight);
    ...
    private static double computeRealCoordinate(int x, int imageWidth, double centerX, double viewWidth) {
        return centerX + ((double) x / imageWidth - 0.5) * viewWidth;
    }

    private static double computeImaginaryCoordinate(
            int y, int imageHeight, double centerY, double viewHeight) {
    ...
    private static void writeImageToFile(BufferedImage image, String format, String fileName) {
        try {
