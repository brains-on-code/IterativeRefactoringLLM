...
public class QuadTree {
    ...
    private void subdivide() {
        ...
        Point nwCenter = new Point(centerX - quadrantHalfWidth, centerY + quadrantHalfWidth);
        Point neCenter = new Point(centerX + quadrantHalfWidth, centerY + quadrantHalfWidth);
        Point swCenter = new Point(centerX - quadrantHalfWidth, centerY - quadrantHalfWidth);
        Point seCenter = new Point(centerX + quadrantHalfWidth, centerY - quadrantHalfWidth);

        BoundingBox nwBoundary = new BoundingBox(nwCenter, quadrantHalfWidth);
        BoundingBox neBoundary = new BoundingBox(neCenter, quadrantHalfWidth);
        BoundingBox swBoundary = new BoundingBox(swCenter, quadrantHalfWidth);
        BoundingBox seBoundary = new BoundingBox(seCenter, quadrantHalfWidth);
