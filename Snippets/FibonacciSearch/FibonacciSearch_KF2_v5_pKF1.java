...
public class FibonacciSearch implements SearchAlgorithm {
    ...
    public <T extends Comparable<T>> int find(T[] array, T target) {
        ...
        while (fibCurrent > 1) {
            int probeIndex = Math.min(lastMatchedIndex + fibPrevPrev, arrayLength - 1);
        ...
        int finalCheckIndex = lastMatchedIndex + 1;
        if (fibPrev == 1 && finalCheckIndex < arrayLength && array[finalCheckIndex].compareTo(target) == 0) {
