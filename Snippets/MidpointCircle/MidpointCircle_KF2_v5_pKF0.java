...
public final class MidpointCircle {
    ...
    private static void addSymmetricPoints(
        ...
        int swappedXPos = centerX + y;
        int swappedXNeg = centerX - y;
        int swappedYPos = centerY + x;
        int swappedYNeg = centerY - x;

        points.add(new int[] {xPos, yPos});
        points.add(new int[] {xNeg, yPos});
        points.add(new int[] {xPos, yNeg});
        points.add(new int[] {xNeg, yNeg});
        points.add(new int[] {swappedXPos, swappedYPos});
        points.add(new int[] {swappedXNeg, swappedYPos});
        points.add(new int[] {swappedXPos, swappedYNeg});
        points.add(new int[] {swappedXNeg, swappedYNeg});
    }
}