...
public class Class1 {
    ...
    public int[] slidingWindowMaximum(int[] nums, int windowSize) {
        ...
        for (int i = 0; i < nums.length; i++) {
            removeOutOfWindowIndices(windowIndices, i, windowSize);
            removeSmallerValues(nums, windowIndices, i);
    ...
    private void removeSmallerValues(int[] nums, Deque<Integer> windowIndices, int currentIndex) {
