...
public final class SlidingWindowMaximum {
    ...
    public static int[] maxSlidingWindow(int[] numbers, int windowSize) {
        ...
        for (int currentIndex = 0; currentIndex < arrayLength; currentIndex++) {
            ...
            if (!candidateIndices.isEmpty() && candidateIndices.peekFirst() < currentWindowStart) {
            ...
            while (!candidateIndices.isEmpty()
                    && numbers[candidateIndices.peekLast()] < numbers[currentIndex]) {
            ...
            if (currentIndex >= windowSize - 1) {
                slidingWindowMaximums[currentWindowStart] = numbers[candidateIndices.peekFirst()];
            }
        }
