...
class BMPUtil {
    ...
    private void prepareBitmapData(Bitmap bitmap) {
        ...
        int totalPadding = rowPadding * biHeight;

        biSizeImage = (rowSize * biHeight) + totalPadding;
    ...
    private void writeBitmapPixels() {
        ...
        adjustSizesForPadding(totalPadCount, paddingPerRow);
    }
    ...
    private void adjustSizesForPadding(int totalPadCount, int paddingPerRow) {
        int padAdjustment = totalPadCount - paddingPerRow;
        bfSize += padAdjustment;
        biSizeImage += padAdjustment;
    }
