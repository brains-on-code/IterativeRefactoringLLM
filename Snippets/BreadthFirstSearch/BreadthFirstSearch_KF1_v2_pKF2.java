...
public class BreadthFirstSearch<T> {
    ...
    /** Values of nodes visited during the last BFS execution, in visitation order. */
    private final List<T> visitedOrder = new ArrayList<>();

    /** Values that have already been visited in the last BFS execution. */
    ...
    private void recordVisit(T value) {
