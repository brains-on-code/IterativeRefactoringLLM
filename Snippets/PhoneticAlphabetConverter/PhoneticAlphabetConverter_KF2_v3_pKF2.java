...
/**
 * Converts alphanumeric text to its NATO phonetic alphabet representation
 * (plus English digit names).
 *
 * <p>Example:
 * <pre>{@code
...
public final class PhoneticAlphabetConverter {
    ...
    /**
     * Maps characters to their phonetic representations:
     * <ul>
     *   <li>Letters: NATO phonetic alphabet (A → "Alpha", B → "Bravo", ...)</li>
     *   <li>Digits: English names ("0" → "Zero", "1" → "One", ...)</li>
     * </ul>
     */
