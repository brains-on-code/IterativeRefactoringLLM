 ...
 *
 * <p>The Rail Fence Cipher is a transposition cipher that writes the plaintext
 * in a zigzag pattern across a given number of rails and then reads off each
 * rail to produce the ciphertext.
 */
public class RailFenceCipher {
    ...
    public String decrypt(String cipherText, int rails) {
        ...
        // First pass: mark the zigzag path with placeholders.
        ...
        // Second pass: fill the marked positions with ciphertext characters.
        int index = 0;
        ...
        // Third pass: traverse the zigzag path to reconstruct the plaintext.
