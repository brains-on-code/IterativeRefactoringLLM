    ...
    private static class BoruvkaComputationState {
            ...
            for (int vertexIndex = 0; vertexIndex < graph.vertexCount; ++vertexIndex) {
                ...
                if (cheapestEdgeForComponent != null) {
                    ...
                    if (sourceComponentRepresentative != destinationComponentRepresentative) {
                        ...
                        unionSets(
                            disjointSetForest,
                            sourceComponentRepresentative,
                            destinationComponentRepresentative
                        );
                    }
                }
            }
        ...
        private Edge[] computeCheapestEdges() {
            ...
            for (final var edge : graph.edges) {
                ...
                if (sourceComponentRepresentative != destinationComponentRepresentative) {
                    if (cheapestEdges[sourceComponentRepresentative] == null
                        || edge.weight < cheapestEdges[sourceComponentRepresentative].weight) {
                        cheapestEdges[sourceComponentRepresentative] = edge;
                    }
                    if (cheapestEdges[destinationComponentRepresentative] == null
                        || edge.weight < cheapestEdges[destinationComponentRepresentative].weight) {
                        cheapestEdges[destinationComponentRepresentative] = edge;
                    }
                }
            }
