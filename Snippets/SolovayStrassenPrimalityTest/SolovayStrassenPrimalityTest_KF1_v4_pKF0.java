...
final class Class1 {
    ...
    public int jacobiSymbol(long a, long n) {
        ...
        while (a != 0) {
            result = applyPowerOfTwoAdjustments(a, n, result);
            a = stripPowersOfTwo(a);
    ...
    private int applyPowerOfTwoAdjustments(long a, long n, int result) {
        while ((a & 1) == 0) {
            a >>= 1;
            long nMod8 = n & 7;
            if (nMod8 == 3 || nMod8 == 5) {
    ...
    private long stripPowersOfTwo(long a) {
        while ((a & 1) == 0) {
            a >>= 1;
        }
        return a;
