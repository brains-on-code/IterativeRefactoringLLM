...
public class Class1 implements SortAlgorithm {
    ...
    public <T extends Comparable<T>> T[] method1(T[] array) {
        ...
        int paddedLength = nextPowerOfTwo(array.length);
        T[] paddedArray = Arrays.copyOf(array, paddedLength);

        T maxElement = maxOf(array);
    ...
    private <T extends Comparable<T>> void bitonicSort(
        ...
        // First half: ascending, second half: descending, then merge
    ...
    private <T extends Comparable<T>> void bitonicMerge(
        ...
        // Compare and swap elements in the two halves according to the direction
    ...
    private static int nextPowerOfTwo(int n) {
        ...
        // If n is already a power of two, return it directly
        if ((n & (n - 1)) == 0) {
            return n;
        }
        ...
        // 2^exponent is the next power of two
        return 1 << exponent;
    }
     ...
     */
    private static <T extends Comparable<T>> T maxOf(T[] array) {
