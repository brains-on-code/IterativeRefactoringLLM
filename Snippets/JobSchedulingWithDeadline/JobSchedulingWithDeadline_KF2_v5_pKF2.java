...
public final class JobSchedulingWithDeadline {
    ...
    public static int[] jobSequencingWithDeadlines(Job[] jobs) {
        ...
        // timeSlots[i] stores the jobId scheduled at time (i + 1); -1 indicates a free slot
        ...
        // Try to schedule each job in the latest available slot within its time window
        for (Job job : jobs) {
