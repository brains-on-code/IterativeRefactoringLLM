...
public class CardState {
    ...
    public static class CardStateBuilder {
        ...
        public CardState build() {
            ...
            ensureRepetitionCountForLearningState();
            ensureCreatedAtIsInitialized();
        ...
        private void ensureRepetitionCountForLearningState() {
            if (this.state == State.LEARNING && this.repetitionCount == null) {
                this.repetitionCount = 0;
            }
        }

        private void ensureCreatedAtIsInitialized() {
