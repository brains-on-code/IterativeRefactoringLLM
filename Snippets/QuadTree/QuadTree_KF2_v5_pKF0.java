...
public class QuadTree {
    ...
    private QuadTree createChild(final double centerX, final double centerY, final double halfWidth) {
        final BoundingBox quadrantBoundary = new BoundingBox(new Point(centerX, centerY), halfWidth);
        return new QuadTree(quadrantBoundary, capacity);
    }
