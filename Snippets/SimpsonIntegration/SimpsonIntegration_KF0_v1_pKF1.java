...
public class SimpsonIntegration {
    ...
    public static void main(String[] args) {
        ...
        double integralValue = integration.computeIntegralWithSimpson(numberOfSubIntervals, stepSize, lowerBound);
     ...
     *
     * The interpolation points xi = x0 + i*h are stored in the treeMap data
     *
