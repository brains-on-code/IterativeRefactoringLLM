...
public class Card {
    ...
    public static class Builder {
        ...
        public Card build() {
            assignCardIdIfMissing();
            assignStepIfLearning();
            assignDueDateIfMissing();
            return new Card(this);
        }

        private void assignCardIdIfMissing() {
            if (cardId != null) {
                return;
            }
        ...
        private void assignStepIfLearning() {
            if (state == State.LEARNING && step == null) {
                step = 0;
            }
        }

        private void assignDueDateIfMissing() {
            if (due == null) {
                due = Instant.now();
            }
        }
