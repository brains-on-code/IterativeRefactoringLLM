...
public final class PalindromicPartitioning {
    ...
    public static int minimalPartitions(String word) {
        ...
        /*
         * minCuts[i] = minimum number of cuts needed for palindrome partitioning
         *              of substring word[0..i]
        ...
        // Fill isPalindrome for all substrings of length >= 2
        ...
        // Minimum cuts for the entire string word[0..len-1]
