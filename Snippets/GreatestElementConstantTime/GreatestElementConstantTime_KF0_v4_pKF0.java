...
public class GreatestElementConstantTime {
    ...
    private boolean shouldUpdateMaxStack(final int value) {
        return maxStack.isEmpty() || value >= maxStack.peek();
    }

    private boolean isCurrentMax(final int value) {
        return !maxStack.isEmpty() && value == maxStack.peek();
    }
}