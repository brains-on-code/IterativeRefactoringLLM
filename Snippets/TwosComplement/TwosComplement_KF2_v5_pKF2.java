...
public final class TwosComplement {
    ...
    /**
     * Returns the two's complement of the given binary string.
     *
    ...
    /**
     * Ensures the input is a non-empty binary string.
     *
    ...
    /**
     * Returns the result of adding one to the given binary string.
     *
     * @param binary a valid binary string
