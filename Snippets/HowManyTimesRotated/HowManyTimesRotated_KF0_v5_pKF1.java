...
final class HowManyTimesRotated {
    ...
    public static int countRotations(int[] numbers) {
        ...
        while (leftIndex <= rightIndex) {
            ...
            if (numbers[middleIndex] < numbers[middleIndex - 1] && numbers[middleIndex] < numbers[middleIndex + 1]) {
                break;
            } else if (numbers[middleIndex] > numbers[middleIndex - 1] && numbers[middleIndex] < numbers[middleIndex + 1]) {
