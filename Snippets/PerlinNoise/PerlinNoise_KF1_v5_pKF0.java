...
public final class Class1 {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            printNoiseMap(noiseMap, charset);
        }
    }
    ...
    static float[][] generateNoiseMap(
        ...
        normalizeNoise(finalNoise, totalAmplitude);
        return finalNoise;
    }
    ...
    static float interpolate(float start, float end, float blend) {
    ...
    private static void printNoiseMap(float[][] noiseMap, String charset) {
