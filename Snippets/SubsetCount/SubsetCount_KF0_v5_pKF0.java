...
public final class SubsetCount {
    ...
    public static int getCount(int[] arr, int target) {
        ...
        initializeFirstElementRow(arr[0], target, dp);
    ...
    public static int getCountSO(int[] arr, int target) {
        ...
        initializeFirstElementArray(arr[0], target, previous);
    ...
    private static void initializeFirstElementRow(int firstElement, int target, int[][] dp) {
        if (isWithinTarget(firstElement, target)) {
            dp[0][firstElement] = 1;
        }
    }

    private static void initializeFirstElementArray(int firstElement, int target, int[] dp) {
        if (isWithinTarget(firstElement, target)) {
            dp[firstElement] = 1;
        }
    }
