...
public final class BoardPath {
    ...
    /**
     * Returns the number of ways to move from {@code start} to {@code end}
     * using dice rolls in the range [1, 6], computed via plain recursion.
     *
    ...
    /**
     * Returns the number of ways to move from {@code curr} to {@code end}
     * using dice rolls in the range [1, 6], computed via recursion with memoization.
     *
     * @param curr current position
     * @param end  target position
     * @param memo memoization array where {@code memo[i]} is the number
    ...
    /**
     * Returns the number of ways to move from {@code curr} to {@code end}
     * using dice rolls in the range [1, 6], computed via bottom-up dynamic programming.
     *
     * @param curr starting position
     * @param end  target position
     * @param dp   array where {@code dp[i]} is the number of ways
