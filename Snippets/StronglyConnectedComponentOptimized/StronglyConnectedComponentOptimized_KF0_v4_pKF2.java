...
public class StronglyConnectedComponentOptimized {
    ...
    /**
     * Performs DFS on the original graph and records vertices in order of completion.
     */
    ...
    /**
     * Performs DFS on the reversed graph and collects all vertices in the current SCC.
     */
    ...
    public int getOutput(HashMap<Integer, List<Integer>> adjacencyList, int nodeCount) {
        ...
        // First pass: DFS on the original graph to compute vertex finish order.
