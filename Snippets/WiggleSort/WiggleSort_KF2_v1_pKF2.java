...
public class WiggleSort implements SortAlgorithm {
    ...
    /**
     * Virtual index mapping used for in-place wiggle rearrangement.
     * Maps indices into the order: 1, 3, 5, ..., 0, 2, 4, ...
     */
     ...
     * virtual indexing scheme. After this, elements greater than the median
     * are placed at odd indices, elements less than the median at even
     * indices from the end, and medians in the middle.
     */
    ...
    private <T extends Comparable<T>> T[] wiggleSort(T[] array) {
        ...
        // it must be the smallest value to allow a valid wiggle ordering.
