...
public final class GaleShapley {
    ...
    public static Map<String, String> stableMatch(
        ...
        while (!freeMen.isEmpty()) {
            ...
            if (womanPreferences == null) {
                // If no preferences are defined for the woman, keep the current engagement
                freeMen.add(man);
                continue;
            }
            ...
            if (prefersNewMan(newManRank, currentFianceRank)) {
                engagements.put(woman, man);
    ...
    private static boolean prefersNewMan(int newManRank, int currentFianceRank) {
        return newManRank != -1
                && currentFianceRank != -1
                && newManRank < currentFianceRank;
    }
}