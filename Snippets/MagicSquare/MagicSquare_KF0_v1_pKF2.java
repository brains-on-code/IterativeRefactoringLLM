...
/**
 * Generates and prints an odd-order magic square.
 *
 * <p>A magic square of order n is an arrangement of distinct n^2 integers in an n×n grid such that
 * the numbers in all rows, all columns, and both main diagonals sum to the same constant.
 * This implementation uses the Siamese method, which works for odd n.</p>
 */
public final class MagicSquare {
    ...
    /**
     * Validates that the size is a positive odd integer.
     *
     * @param size the size of the magic square
     * @return true if size is odd and greater than 0, false otherwise
     */
