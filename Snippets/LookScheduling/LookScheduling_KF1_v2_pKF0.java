...
public class Class1 {
    ...
    private void processUpwardMovement(List<Integer> scheduledOrder,
                                       List<Integer> lowerRequests,
                                       List<Integer> higherRequests) {
    ...
    private void processDownwardMovement(List<Integer> scheduledOrder,
                                         List<Integer> lowerRequests,
                                         List<Integer> higherRequests) {
        Collections.reverse(lowerRequests);
        scheduledOrder.addAll(lowerRequests);
    ...
    private void updateHeadToMaxWithLast(List<Integer> requests) {
        if (!requests.isEmpty()) {
            currentHeadPosition = Math.max(currentHeadPosition, requests.get(requests.size() - 1));
        }
    }
