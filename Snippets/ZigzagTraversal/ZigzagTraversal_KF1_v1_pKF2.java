 ...
 *
 * <p>This class provides a method to perform a zigzag (or spiral) level-order
 * traversal on a binary tree.</p>
 */
public final class Class1 {
     ...
     *
     * <p>Given a binary tree, this method returns a list of levels, where each
     * level is represented as a list of node values. The traversal alternates
     * between left-to-right and right-to-left order at each level.</p>
     *
     * <pre>
     * Example tree:
     *         7
    ...
    public static List<List<Integer>> method1(BinaryTree.Node root) {
        ...
        // Indicates whether the current level should be traversed right-to-left
