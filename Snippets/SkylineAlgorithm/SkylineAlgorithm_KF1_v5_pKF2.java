...
public class Class1 {
    ...
    /**
     * Processes a list of exactly two {@link Point} items by removing the dominated one, if any.
     */
    private List<Point> processPair(List<Point> points) {
