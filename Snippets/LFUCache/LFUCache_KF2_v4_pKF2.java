 ...
 *
 * <p>Items are ordered in a doubly linked list by their access frequency in
 ...
 * evicted.
 *
 * <p>Note: This implementation is not optimized for large capacities because
 * reordering by frequency is O(n). It is intended for clarity rather than
 * performance.
 */
public class LFUCache<K, V> {
    ...
    private void insertNodeByFrequency(Node node) {
        ...
        // Find the first node with a strictly greater frequency than the new node.
