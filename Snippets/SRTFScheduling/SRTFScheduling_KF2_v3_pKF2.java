...
public class SRTFScheduling {
    ...
    /**
     * Computes the SRTF (Shortest Remaining Time First) schedule and populates {@link #ready}.
     */
    public void evaluateScheduling() {
        ...
        // Mark CPU as idle before the first process arrives
        ...
        for (int currentTime = firstArrivalTime; currentTime < totalTime; currentTime++) {
            currentProcessIndex =
                    selectProcessWithShortestRemainingTime(currentTime, remainingTime, currentProcessIndex);
    ...
    /**
     * Returns the index of the process with the shortest remaining time among
     * processes that have arrived and still have remaining burst time.
     */
