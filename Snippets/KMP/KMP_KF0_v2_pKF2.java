...
public final class KMP {
     ...
     *
     * <p>For a pattern string {@code p}, the returned array {@code pi} is defined such that
     * {@code pi[i]} is the length of the longest proper prefix of {@code p[0..i]} that is
     * also a suffix of {@code p[0..i]}.
     *
