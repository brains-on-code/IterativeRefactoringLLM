...
public final class ShellHelper {
   ...
   *
   * @param commandWithArgs the command and its arguments to execute
   * @return a list of strings representing the command's output
   * @throws IOException if an I/O error occurs while executing the command
   */
  public static List<String> exec(String... commandWithArgs) throws IOException {
    ProcessBuilder processBuilder = new ProcessBuilder(commandWithArgs);
    processBuilder.redirectErrorStream(true);

    final String commandLine = String.join(" ", commandWithArgs);
    ...
    try (BufferedReader processOutputReader =
      ...
      LOGGER.error(
          "Interrupted while waiting for command to finish: {}", commandLine, interruptedException);
      process.destroy();
      return List.of();
    }
  }
