...
public final class JobSchedulingWithDeadline {
    ...
    public static int[] jobSequencingWithDeadlines(Job[] jobs) {
        ...
        // timeSlots[t] = jobId scheduled at time t (0-based); -1 means the slot is free
        ...
        for (Job job : jobs) {
            // Ignore jobs whose arrival time is after their deadline
            ...
            // Try to place the job in the latest available slot within its window
