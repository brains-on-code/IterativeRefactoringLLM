...
public final class LetterCombinationsOfPhoneNumber {
    ...
    /**
     * Mapping of digits (0–9) to corresponding letters on a phone keypad.
     * Index in the array corresponds to the digit.
     */
    ...
    /**
     * Returns all possible letter combinations that the given digit array
     * could represent on a phone keypad.
     *
     * @param numbers array of digits in the range [0, 9]
     * @return list of all possible letter combinations; if {@code numbers} is
     *         {@code null}, returns a list containing the empty string
     */
    ...
    /**
     * Recursively builds all letter combinations for the given digit array.
     *
     * @param numbers input digit array
     * @param index   current position in {@code numbers}
     * @param current current partial combination
     * @return list of all combinations formed from {@code numbers[index..end]}
     */
