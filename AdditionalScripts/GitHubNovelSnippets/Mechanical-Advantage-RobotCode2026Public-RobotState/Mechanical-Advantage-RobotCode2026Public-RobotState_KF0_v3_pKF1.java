...
public class RobotState {
  ...
  public void addVisionObservation(VisionObservation visionObservation) {
    ...
    try {
      ...
      if (newestBufferedTimestamp - POSE_BUFFER_DURATION_SECONDS > visionObservation.timestamp()) {
        return;
      }
    ...
    var odometrySampleAtObservationTime =
        poseHistoryBuffer.getSample(visionObservation.timestamp());
    ...
    for (int stateIndex = 0; stateIndex < 3; ++stateIndex) {
      ...
      if (processVariance == 0.0) {
        ...
        kalmanGain.set(
            ...
            processVariance
                / (processVariance
                    + Math.sqrt(processVariance * visionMeasurementVariances[stateIndex])));
      }
    }
