...
public class TimeConstrainedShortestPath {
    ...
    public static class Graph {
        ...
        public void addEdge(int sourceNodeId, int targetNodeId, int cost, int time) {
            adjacencyList.get(sourceNodeId).add(new Edge(sourceNodeId, targetNodeId, cost, time));
        }
        ...
        public record Edge(int sourceNodeId, int targetNodeId, int cost, int time) {
        }
    }
    ...
    public int findMinimumCost(int startNodeId, int endNodeId) {
        ...
        int[][] minCostAtTime = new int[maxAllowedTime + 1][nodeCount];
