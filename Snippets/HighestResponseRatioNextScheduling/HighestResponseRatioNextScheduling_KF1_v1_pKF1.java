...
public final class Class1 {
    ...
    public static int[] method2(final String[] jobNames, final int[] arrivalTimes, final int[] burstTimes, final int jobCount) {
        int currentTime = 0;
        ...
        while (completedJobs < jobCount) {
            int nextJobIndex = method4(jobs, currentTime);
    ...
    private static int method4(Job[] jobs, int currentTime) {
        return method5(jobs, currentTime);
    }

    private static int method5(Job[] jobs, int currentTime) {
