...
/**
 * Converts postfix expressions to fully parenthesized infix expressions.
 *
 * <p>Example:
 * <pre>
...
public final class PostfixToInfix {
     ...
     * @return {@code true} if {@code token} is an operator, {@code false} otherwise
     */
    ...
    /**
     * Validates whether the given string is a syntactically correct postfix expression.
     *
     * <p>Rules:
     * <ul>
