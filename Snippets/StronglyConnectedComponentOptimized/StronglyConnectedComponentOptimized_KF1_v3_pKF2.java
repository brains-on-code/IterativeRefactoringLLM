...
public class Class1 {
    ...
    /**
     * Performs the first DFS pass of Kosaraju's algorithm.
     *
     * <p>Runs DFS on the original graph and pushes each vertex onto the stack
     * after exploring all its descendants. The stack will contain vertices
     * ordered by decreasing finishing time.</p>
     *
    ...
    /**
     * Performs the second DFS pass of Kosaraju's algorithm on the transposed graph.
     *
