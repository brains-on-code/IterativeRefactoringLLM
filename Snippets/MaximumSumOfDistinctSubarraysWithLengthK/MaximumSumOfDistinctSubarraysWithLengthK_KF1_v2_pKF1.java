...
public final class Class1 {
    ...
    public static long method1(int windowSize, int... numbers) {
        ...
        for (int windowStart = 1; windowStart <= numbers.length - windowSize; windowStart++) {
            int outgoingElement = numbers[windowStart - 1];
            int incomingElement = numbers[windowStart + windowSize - 1];
