...
public final class Huffman {
    ...
    private static HuffmanNode buildHuffmanTree(char[] characters, int[] frequencies) {
        if (characters == null || frequencies == null || characters.length != frequencies.length || characters.length == 0) {
            throw new IllegalArgumentException("Characters and frequencies must be non-null and of equal, non-zero length.");
        }
