...
public class SkylineProblem {
    ...
    public void add(int left, int height, int right) {
        buildings[size++] = new Building(left, height, right);
    }
    ...
    public List<Skyline> findSkyline(int start, int end) {
        if (start == end) {
            return createBaseSkyline(buildings[start]);
        }
    ...
    /**
     * Creates the skyline representation for a single building.
     *
     * @param building the building to convert into skyline points
     * @return a list of skyline points for the given building
     */
    private List<Skyline> createBaseSkyline(Building building) {
