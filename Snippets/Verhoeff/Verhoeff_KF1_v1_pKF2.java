...
public final class Class1 {
    ...
    /**
     * Multiplication table (d-table) used by the Verhoeff algorithm.
     */
    ...
    /**
     * Inverse table (inv-table) used by the Verhoeff algorithm.
     */
    ...
    /**
     * Permutation table (p-table) used by the Verhoeff algorithm.
     */
     ...
     */
    public static boolean method1(String value) {
    ...
    /**
     * Demonstrates usage of the Verhoeff algorithm.
     *
     * @param args ignored
     */
    public static void method3(String[] args) {
        ...
        method4(validExample);
        method4(invalidExample);
    ...
    private static void method4(String value) {
        String result = Class1.method1(value) ? "valid" : "not valid";
        System.out.println("Input '" + value + "' is " + result);
    }

    private static void method5(String value) {
        String withChecksum = method2(value);
        System.out.println(
