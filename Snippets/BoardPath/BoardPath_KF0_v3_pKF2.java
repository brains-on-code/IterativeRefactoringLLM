...
public final class BoardPath {
     ...
     * using dice rolls in the range [MIN_DICE, MAX_DICE], via plain recursion.
     */
     ...
     * using dice rolls in the range [MIN_DICE, MAX_DICE], via recursion
     * with memoization (top-down dynamic programming).
     *
    ...
    /**
     * Computes the number of ways to move from {@code curr} to {@code end}
     * using dice rolls in the range [MIN_DICE, MAX_DICE], via tabulation
