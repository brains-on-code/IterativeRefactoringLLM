...
public class LiangBarskyClipper {
    ...
    private Line computeClippedLine(
        ...
        double xEnter = originalLine.start.x + enteringParameter * directionX;
        double yEnter = originalLine.start.y + enteringParameter * directionY;
        double xLeave = originalLine.start.x + leavingParameter * directionX;
        double yLeave = originalLine.start.y + leavingParameter * directionY;
