...
public final class BankersAlgorithm {
    ...
    static boolean checkSafeSystem(
        ...
        while (completedCount < totalProcesses) {
            ...
            for (int process = 0; process < totalProcesses; process++) {
                ...
                releaseAllocatedResourcesToWork(process, allocation, work, totalResources);
    ...
    private static void releaseAllocatedResourcesToWork(
            int process,
            int[][] allocation,
            int[] work,
            int totalResources
    ...
    private static void printSafeSequence(int[] safeSequence) {
        System.out.print("The system is in safe sequence and the sequence is as follows: ");
        for (int processId : safeSequence) {
    ...
    private static int[][] readMatrix(
        ...
        boolean isMaximumMatrix = headerMessage.toLowerCase().contains("maximum");
