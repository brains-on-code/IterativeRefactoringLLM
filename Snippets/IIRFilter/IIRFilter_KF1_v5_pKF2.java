...
public class IIRFilter {
    ...
    public IIRFilter(int order) {
        ...
        // Identity / pass-through filter by default: y[n] = x[n]
    ...
    public double processSample(double inputSample) {
        ...
        // Accumulate contributions from past inputs and outputs (i = 1..order).
        ...
        // Shift history so index 0 is most recent, index order-1 is oldest.
        shiftHistory(inputSample, outputSample);

        return outputSample;
    }

    private void shiftHistory(double inputSample, double outputSample) {
