...
public final class Class1 {
    ...
    public static <T> List<TreeSet<T>> method1(T[] elements, int combLength) {
        validateInputs(elements, combLength);

        if (combLength == 0 || elements == null || elements.length == 0 || combLength > elements.length) {
    ...
    private static <T> void validateInputs(T[] elements, int combLength) {
        if (combLength < 0) {
