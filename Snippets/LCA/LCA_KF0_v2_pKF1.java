...
public final class LCA {
    ...
    public static void main(String[] args) {
        ...
        int rootVertex = 0;
        int rootParent = -1;
        depthFirstSearch(adjacencyList, rootVertex, rootParent, parentOfVertex, depthOfVertex);
    ...
    private static void depthFirstSearch(
        ...
        for (int adjacentVertex : adjacencyList.get(currentVertex)) {
            if (adjacentVertex != parentVertex) {
                parentOfVertex[adjacentVertex] = currentVertex;
                depthOfVertex[adjacentVertex] = depthOfVertex[currentVertex] + 1;
                depthFirstSearch(adjacencyList, adjacentVertex, currentVertex, parentOfVertex, depthOfVertex);
            }
        }
    }
