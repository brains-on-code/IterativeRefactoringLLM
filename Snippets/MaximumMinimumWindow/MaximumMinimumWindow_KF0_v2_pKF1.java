...
public final class MaximumMinimumWindow {
    ...
    public static int[] calculateMaxOfMin(int[] values, int length) {
        ...
        int[] previousSmallerElementIndex = new int[length + 1];
        int[] nextSmallerElementIndex = new int[length + 1];

        for (int index = 0; index < length; index++) {
            previousSmallerElementIndex[index] = -1;
            nextSmallerElementIndex[index] = length;
        }
        ...
        for (int currentIndex = 0; currentIndex < length; currentIndex++) {
            ...
            if (!indexStack.empty()) {
                previousSmallerElementIndex[currentIndex] = indexStack.peek();
            }
        ...
        for (int currentIndex = length - 1; currentIndex >= 0; currentIndex--) {
            ...
            if (!indexStack.empty()) {
                nextSmallerElementIndex[currentIndex] = indexStack.peek();
            }
        ...
        for (int index = 0; index < length; index++) {
            int windowSize =
                nextSmallerElementIndex[index] - previousSmallerElementIndex[index] - 1;
