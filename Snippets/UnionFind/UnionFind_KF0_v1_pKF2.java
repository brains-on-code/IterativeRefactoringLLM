 ...
 *
 * <ul>
 *   <li>{@link #find(int)} – find the representative (root) of an element's set
 *   <li>{@link #union(int, int)} – merge the sets containing two elements
 *   <li>{@link #count()} – count how many disjoint sets currently exist
 * </ul>
 *
