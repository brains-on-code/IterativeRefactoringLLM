...
public class CircularScanScheduling {
    ...
    public List<Integer> execute(List<Integer> requests) {
        ...
        List<Integer> result =
            movingUp ? processMovingUp(sortedRequests) : processMovingDown(sortedRequests);
     ...
     * First services requests from the current position up to (but not including)
     * {@code diskSize}, then wraps around to service remaining lower-numbered
     * requests.
     */
     ...
     * First services requests from the current position down to 0, then wraps
     * around to service remaining higher-numbered requests.
     */
