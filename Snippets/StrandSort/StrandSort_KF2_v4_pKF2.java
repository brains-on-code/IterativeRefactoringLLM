...
public final class StrandSort implements SortAlgorithm {
     ...
     *
     * <p>While elements remain in {@code list}:
     * <ul>
     *   <li>Extract an increasing subsequence (strand) from {@code list}.</li>
     *   <li>Merge that strand into {@code result}, which stays sorted.</li>
     * </ul>
     *
    ...
    /**
     * Extracts a single non-decreasing strand from {@code source}.
     *
     * <p>Steps:
     * <ul>
     *   <li>Start the strand with the first element of {@code source}.</li>
