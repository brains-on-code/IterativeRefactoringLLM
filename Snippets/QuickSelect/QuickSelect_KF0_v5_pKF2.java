 ...
 *
 * <p>Finds the element that would be at index {@code n} if the list were sorted,
...
public final class QuickSelect {
     ...
     *
     * <p>The order of elements in {@code list} may be modified.
     *
     ...
     * </ul>
     *
     * <p>The returned index is adjusted so that the caller can continue searching
    ...
    private static <T extends Comparable<T>> int partition(
        ...
        // Move elements smaller than the pivot to the beginning.
        ...
        // Group elements equal to the pivot after the smaller elements.
        ...
        // Place the pivot after the block of equal elements.
        Collections.swap(list, right, storeIndexEq);

        // Return an index that narrows the search range to the partition containing n.
    ...
    private static <T extends Comparable<T>> int pivot(List<T> list, int left, int right) {
        // For small ranges, directly compute the median of up to 5 elements.
        if (right - left < 5) {
