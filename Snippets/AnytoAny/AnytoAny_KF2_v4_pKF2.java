...
public final class AnyToAny {
     ...
     *
     * @param sourceNumber the number expressed in {@code sourceBase}
     * @param sourceBase   the base of {@code sourceNumber} (inclusive range: 2–10)
     * @param destBase     the target base (inclusive range: 2–10)
    ...
    /**
     * Ensures that a base is within the supported range.
     *
     ...
     *
     * @param number the number expressed in {@code base}
     * @param base   the base of {@code number}
     * @return the decimal (base 10) representation of {@code number}
     */
    ...
    /**
     * Converts a decimal (base 10) number to another base.
     *
     * @param decimal the decimal (base 10) number
