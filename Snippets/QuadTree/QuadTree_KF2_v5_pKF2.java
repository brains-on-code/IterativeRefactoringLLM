...
class BoundingBox {
    ...
    /**
     * Checks whether the given point lies inside or on the boundary of this box.
     *
     * @param point the point to test
     * @return {@code true} if the point is inside or on the boundary; {@code false} otherwise
     */
    ...
    /**
     * Checks whether this box intersects the given box.
     *
     * @param other the other bounding box
     * @return {@code true} if the boxes intersect; {@code false} otherwise
     */
...
public class QuadTree {
     ...
     * @return list of points contained in the given range
     */
