...
/**
 * Utility class for converting octal numbers to hexadecimal.
 */
public final class OctalToHexadecimal {
    ...
    /**
     * Converts a non-negative octal number (as a string) to its decimal value.
     *
    ...
    /**
     * Ensures that the input string is a non-empty, valid octal number.
     *
    ...
    /**
     * Returns whether the given character is a valid octal digit (0–7).
     *
