...
public class AnalyticsService implements GetAnalyticsUseCase {
    ...
    public AnalyticsSummary getAnalyticsSummary() {
        ...
        String latestDate = loadAnalyticsPort.getLatestAnalyticsTimestamp().orElse(NO_DATE_AVAILABLE);
        String oldestDate = loadAnalyticsPort.getOldestAnalyticsTimestamp().orElse(NO_DATE_AVAILABLE);
