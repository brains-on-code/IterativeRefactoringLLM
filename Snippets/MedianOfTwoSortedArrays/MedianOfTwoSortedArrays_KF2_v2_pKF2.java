...
public final class MedianOfTwoSortedArrays {
    ...
    /**
     * Returns the median of two sorted integer arrays in O(log(min(m, n))) time.
     *
    ...
    public static double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        while (low <= high) {
            ...
            boolean validPartition = maxLeft1 <= minRight2 && maxLeft2 <= minRight1;
            if (validPartition) {
            ...
            boolean partition1TooRight = maxLeft1 > minRight2;
            if (partition1TooRight) {
                high = partition1 - 1;
            } else {
                low = partition1 + 1;
            }
