 ...
 *
 * <p>The head moves in a single direction (up or down), servicing requests
 * along the way. Upon reaching one end of the disk, it jumps to the
 * opposite end and continues in the same direction.
 */
public class CircularScanScheduling {
    ...
    /**
     * Executes C-SCAN scheduling on the given list of requests.
     *
