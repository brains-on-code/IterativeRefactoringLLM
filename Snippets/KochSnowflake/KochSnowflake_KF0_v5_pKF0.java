...
public final class KochSnowflake {
    ...
    private static final double OFFSET_Y_DIVISOR = 3.7;
    ...
    private static void testGetKochSnowflake() {
        BufferedImage image = getKochSnowflake(DEFAULT_IMAGE_WIDTH, 5);

        // The background should be white
        assert image.getRGB(0, 0) == BACKGROUND_COLOR.getRGB();

        double offsetX = DEFAULT_IMAGE_WIDTH / OFFSET_X_FACTOR;
        double offsetY = DEFAULT_IMAGE_WIDTH / OFFSET_Y_DIVISOR;
    ...
    public static BufferedImage getKochSnowflake(int imageWidth, int steps) {
        ...
        double offsetY = imageWidth / OFFSET_Y_DIVISOR;
