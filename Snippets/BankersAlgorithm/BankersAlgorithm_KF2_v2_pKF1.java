...
public final class BankersAlgorithm {
    ...
    static boolean isSystemInSafeState(
        ...
        boolean[] isProcessCompleted = new boolean[processCount];
        ...
        while (safeSequencePosition < processCount) {
            boolean isProgressMadeInThisIteration = false;

            for (int processIndex = 0; processIndex < processCount; processIndex++) {
                if (!isProcessCompleted[processIndex]) {
                    int resourceIndex;
                    ...
                    if (resourceIndex == resourceCount) {
                        ...
                        isProcessCompleted[processIndex] = true;
                        isProgressMadeInThisIteration = true;
                    }
                }
            }

            if (!isProgressMadeInThisIteration) {
