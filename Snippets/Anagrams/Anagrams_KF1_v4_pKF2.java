...
public final class AnagramChecker {
    ...
    /**
     * Checks whether two strings are anagrams using a fixed-size frequency array.
     * <p>
     * Assumes both strings consist only of lowercase letters {@code 'a'}–{@code 'z'}.
     *
     * @param first  the first string (lowercase a–z only)
     * @param second the second string (lowercase a–z only)
     * @return {@code true} if {@code first} and {@code second} are anagrams;
     *         {@code false} otherwise
     */
    ...
    /**
     * Checks whether two strings are anagrams using a {@link HashMap} to count
     * character frequencies. Supports arbitrary Unicode characters.
     *
     * @param first  the first string
     * @param second the second string
     * @return {@code true} if {@code first} and {@code second} are anagrams;
