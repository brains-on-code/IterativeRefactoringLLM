...
final class HowManyTimesRotated {
    ...
    public static int countRotations(int[] array) {
        ...
        // For a valid rotated sorted array this line should not be reached.
        throw new IllegalStateException("Input is not a valid rotated sorted array");
    }
    ...
    private static boolean isMinimumElement(int[] array, int mid) {
        ...
        return current <= array[prevIndex] && current <= array[nextIndex];
    }
