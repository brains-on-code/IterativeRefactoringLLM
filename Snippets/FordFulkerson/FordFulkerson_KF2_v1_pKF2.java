...
public final class FordFulkerson {
    ...
    public static int networkFlow(
        ...
        while (true) {
            int[] parent = new int[vertexCount];   // To reconstruct the path
            ...
            // Standard BFS to find a path in the residual graph
            ...
            // No augmenting path found; we are at maximum flow
            if (!visited[sink]) {
                break;
            }
