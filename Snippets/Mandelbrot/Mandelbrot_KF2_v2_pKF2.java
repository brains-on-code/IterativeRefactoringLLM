...
public final class Mandelbrot {
     ...
     * Points that do not escape within the maximum number of iterations are
     * considered inside (or near) the set and are colored black; all others
     * are colored white.
     */
     ...
     * Points that do not escape within the maximum number of iterations are
     * considered inside (or near) the set and are colored black. For points
     * outside the set, the hue varies with the normalized distance.
     */
     ...
     * The returned value is in the range [0, 1]. A value of 1 indicates that
     * the point did not escape within the maximum number of iterations and is
     * therefore likely to be in the Mandelbrot set.
     */
