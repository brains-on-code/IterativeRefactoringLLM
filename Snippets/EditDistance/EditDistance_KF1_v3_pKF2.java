...
public final class LevenshteinDistance {
    ...
    public static int computeIterative(String first, String second) {
        ...
        // Base case: distance from prefixes of first to empty second (all deletions)
        for (int i = 0; i <= firstLength; i++) {
            dp[i][0] = i;
        }

        // Base case: distance from empty first to prefixes of second (all insertions)
     ...
     *
     * <p>memo[i][j] stores the distance between first[0..i-1] and second[0..j-1].
     *
     * @param first  the first string
     * @param second the second string
