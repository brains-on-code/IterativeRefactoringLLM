...
class CountingSort {
    ...
    public Integer[] sort(Integer[] array) {
        ...
        fillSortedArrayFromCounts(array, counts);
    ...
    /**
     * Fills the original array with sorted values based on the frequency array.
     *
     * @param array  the array to fill
     * @param counts the frequency array
     */
    private void fillSortedArrayFromCounts(Integer[] array, int[] counts) {
        int index = 0;
