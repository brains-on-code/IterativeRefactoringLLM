...
public class QuadTree {
    ...
    private void subdivide() {
        ...
        northWestChild = new QuadTree(new BoundingBox(northWestCenter, childHalfWidth), this.capacity);
        northEastChild = new QuadTree(new BoundingBox(northEastCenter, childHalfWidth), this.capacity);
        southWestChild = new QuadTree(new BoundingBox(southWestCenter, childHalfWidth), this.capacity);
        southEastChild = new QuadTree(new BoundingBox(southEastCenter, childHalfWidth), this.capacity);
