...
public final class PowerSetGenerator {
    ...
    public static <T> List<List<T>> generatePowerSet(List<T> elements) {
        ...
        generateSubsetsRecursive(elements, currentSubset, 0, subsets);
        return subsets;
    }
     ...
     * @param subsets       the collection of all generated subsets
     * @param <T>           the type of elements in the list
     */
    private static <T> void generateSubsetsRecursive(
        ...
        generateSubsetsRecursive(elements, currentSubset, currentIndex + 1, subsets);

        // Include current element
        currentSubset.add(elements.get(currentIndex));
        generateSubsetsRecursive(elements, currentSubset, currentIndex + 1, subsets);
