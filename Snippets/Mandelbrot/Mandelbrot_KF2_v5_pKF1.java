...
public final class Mandelbrot {
            ...
            for (int pixelY = 0; pixelY < imageHeight; pixelY++) {
                ...
                double normalizedEscapeIteration =
                        computeNormalizedEscapeIteration(
                                pointReal, pointImaginary, maxIterations);
    ...
    private static Color mapNormalizedIterationToGradientColor(
        ...
        int maxComponent = (int) maxBrightness;
        int minComponent = 0;
        int descendingComponent =
                (int) (maxBrightness * (1 - sectorFraction * saturation));
        int ascendingComponent =
                (int) (maxBrightness * (1 - (1 - sectorFraction) * saturation));
