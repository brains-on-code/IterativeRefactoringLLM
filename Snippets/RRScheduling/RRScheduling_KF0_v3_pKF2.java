...
public class RRScheduling {
    ...
    private void evaluateTurnAroundTime() {
        ...
        while (completedProcesses != processCount) {
            ...
            // Align current time with the arrival time for the first CPU allocation of a process.
    ...
    /**
     * Enqueues processes that have arrived by the current time, are not completed, and have not
     * been enqueued before.
     */
