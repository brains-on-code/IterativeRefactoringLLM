...
public final class JohnsonAllPairsShortestPaths {
    ...
    public static double[][] computeAllPairsShortestPaths(double[][] adjacencyMatrix) {
        ...
        for (int source = 0; source < vertexCount; source++) {
            allPairsDistances[source] = dijkstraWithPotentials(reweightedGraph, source, vertexPotentials);
        }
    ...
    private static void relaxNeighbors(
        ...
        for (int neighbor = 0; neighbor < vertexCount; neighbor++) {
            ...
            if (visited[neighbor] || Double.isInfinite(weight) || distances[currentVertex] == INFINITY) {
                continue;
            }
    ...
    private static void adjustDistancesToOriginalWeights(double[] distances, double[] potentials, int source) {
