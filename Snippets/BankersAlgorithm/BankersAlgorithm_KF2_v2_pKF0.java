...
public final class BankersAlgorithm {
    ...
    private static int[][] readMaxMatrix(Scanner scanner, int processCount, int resourceCount) {
    ...
    private static int[][] readAllocationMatrix(Scanner scanner, int processCount, int resourceCount) {
