...
public class Drive extends FullSubsystem {
  /** Prevents odometry updates from racing with sensor reads. */
  static final Lock odometryLock = new ReentrantLock();

  private final GyroIO gyroIO;
  private final GyroIOInputsAutoLogged gyroInputs = new GyroIOInputsAutoLogged();

  /** Swerve modules ordered: front-left, front-right, back-left, back-right. */
  ...
  public void periodic() {
    // --- Sensor + module input update (locked with odometry) ---
    odometryLock.lock();
    try {
