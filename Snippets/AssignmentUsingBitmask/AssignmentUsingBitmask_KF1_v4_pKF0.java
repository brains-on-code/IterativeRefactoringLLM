...
public final class Class1 {
    ...
    public Class1(List<List<Integer>> groups, int maxValue) {
        ...
        this.memo = initMemoTable(groupCount, maxValue);
        this.valueToGroupIndices = buildValueToGroupMapping(groups, maxValue);
        this.allGroupsMask = (1 << groupCount) - 1;
    }

    private int[][] initMemoTable(int groupCount, int maxValue) {
    ...
    private List<List<Integer>> buildValueToGroupMapping(List<List<Integer>> groups, int maxValue) {
    ...
    private int countWays(int usedGroupsMask, int currentValue) {
        ...
        int cachedResult = memo[usedGroupsMask][currentValue];
        if (cachedResult != -1) {
            return cachedResult;
        }
