...
public final class FordFulkerson {
    ...
    public static int networkFlow(
        ...
        while (hasAugmentingPath(capacity, flow, source, sink, parent, visited)) {
            int pathFlow = computeBottleneckCapacity(capacity, flow, source, sink, parent);
            applyAugmentingPath(flow, source, sink, parent, pathFlow);
            totalFlow += pathFlow;
        }
     ...
     */
    private static int computeBottleneckCapacity(
            int[][] capacity,
            int[][] flow,
            int source,
            int sink,
