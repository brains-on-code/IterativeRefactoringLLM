...
class AdjacencyList<E extends Comparable<E>> {
     ...
     * @return list of adjacent vertices, or {@code null} if the vertex is not present
     */
...
class TopologicalSort<E extends Comparable<E>> {
    ...
    /**
     * Computes the in-degree for every vertex in the graph.
     */
    ...
    /**
     * Returns the vertices in topological order using Kahn's algorithm.
     *
