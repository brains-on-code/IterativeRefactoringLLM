...
public final class WordLadder {
    ...
    public static int ladderLength(String beginWord, String endWord, Collection<String> wordList) {
        ...
        int level = 1; // Current transformation length (beginWord itself counts as level 1)
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < levelSize; i++) {
                ...
                for (int pos = 0; pos < chars.length; pos++) {
                    ...
                    for (char c = 'a'; c <= 'z'; c++) {
                        ...
                        // add it to the queue and mark as visited by removing from the set
            ...
            // Move to the next level of transformations
            level++;
        }
