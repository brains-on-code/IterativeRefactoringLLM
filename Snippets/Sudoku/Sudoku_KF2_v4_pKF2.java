...
final class Sudoku {
    ...
    /**
     * Checks whether {@code num} already exists in the given {@code row}.
     */
    ...
    /**
     * Checks whether {@code num} already exists in the given {@code col}.
     */
    ...
    /**
     * Checks whether {@code num} already exists in the sub-box that contains
     * position ({@code row}, {@code col}).
     */
    ...
    /**
     * Finds the next empty cell (value {@code 0}) in {@code board}.
     *
     * @param board the Sudoku board
