...
public class BitonicSort implements SortAlgorithm {
    ...
    private static BiPredicate<Comparable<?>, Comparable<?>> getOrderPredicate(Direction direction) {
    ...
    private static <T extends Comparable<T>> BiPredicate<T, T> getOrderPredicateTyped(Direction direction) {
        return (BiPredicate<T, T>) (BiPredicate<?, ?>) getOrderPredicate(direction);
    }
