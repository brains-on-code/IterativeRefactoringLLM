...
public class SJFScheduling {
    ...
    public void scheduleProcesses() {
        ...
        while (executedCount < totalProcesses) {
            nextProcessIndex = enqueueArrivedProcesses(readyQueue, currentTime, nextProcessIndex);
    ...
    private void executeProcess(final List<ProcessDetails> readyQueue, final ProcessDetails process) {
