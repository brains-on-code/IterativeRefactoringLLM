...
public class TiffUtil {
    ...
    /**
     * Reads basic TIFF metadata (dimensions, directory count, etc.) without decoding pixels.
     */
     ...
     *
     * Attempts to decode to Bitmap first; if that fails (bitmap == null),
    ...
    private static void convertFromTIFSinglePage(
        ...
        // For some files this call may return null (native decoder failure).
