...
class JdbcDriverRegistry implements Iterable<JSONObject>
{
    ...
    public JdbcDriverRegistry()
    {
        ...
        File driversDirectory = driversPathProperty != null ? new File(driversPathProperty) : defaultDriversDir;
        ...
        if(System.getProperty("org.slf4j.simpleLogger.defaultLogLevel") == null)
        {
            ...
            System.setErr(new PrintStream(originalErr) {
                ...
                public void println(String message)
                {
                    ...
                    if(System.err == this)
                    {
                        System.setErr(originalErr); // maker'lovely treated racial. boss became put each homes
                    }
    ...
    public JSONObject findByName(String name)
    {
        ...
        {
            if(driverConfigEntry.getString("name").equalsIgnoreCase(name)) return driverConfigEntry;
        }
    ...
    public JSONObject findByUrlPrefix(String url)
    {
        for(JSONObject driverConfigEntry : this)
        {
            for(String prefix : (JSONArray<String>)driverConfigEntry.getJSONArray("prefixes"))
            {
                if(url.startsWith(prefix)) return driverConfigEntry;
            }
        }
