...
public final class Class1 {
    ...
    public static void method1(String[] args) {
        ...
        List<List<Integer>> adjacencyList = createAdjacencyList(nodeCount, edgeCount);
        ...
        System.out.println(findLowestCommonAncestor(nodeA, nodeB, depth, parent));
    }

    private static List<List<Integer>> createAdjacencyList(int nodeCount, int edgeCount) {
