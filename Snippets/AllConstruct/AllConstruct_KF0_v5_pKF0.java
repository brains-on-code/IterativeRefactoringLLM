...
public final class AllConstruct {
    ...
    public static List<List<String>> allConstruct(String target, Iterable<String> wordBank) {
        ...
        for (int i = 0; i <= targetLength; i++) {
            ...
            for (String word : wordBank) {
                if (!startsWithAt(target, word, i)) {
                    continue;
                }

                int nextIndex = i + word.length();
                List<List<String>> extendedCombinations = extendCombinationsWithWord(currentCombinations, word);
    ...
    private static boolean startsWithAt(String target, String word, int startIndex) {
    ...
    private static List<List<String>> extendCombinationsWithWord(List<List<String>> combinations, String word) {
