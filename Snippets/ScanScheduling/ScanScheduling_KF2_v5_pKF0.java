...
public class ScanScheduling {
    ...
    private List<Integer> buildScheduleMovingUp(
        ...
        List<Integer> schedule = new ArrayList<>(calculateCapacity(leftRequests, rightRequests));
    ...
    private int calculateCapacity(List<Integer> leftRequests, List<Integer> rightRequests) {
        return leftRequests.size() + rightRequests.size() + 1;
    }
