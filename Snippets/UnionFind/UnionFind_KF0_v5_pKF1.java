...
public class UnionFind {
    ...
    private final int[] parent; // Parent of each element
    private final int[] rank;   // Rank (approximate tree height) of each root

    /**
     * Initializes a Union-Find data structure with the given number of elements.
