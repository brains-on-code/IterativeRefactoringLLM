...
class BinaryTree {
    ...
    public void printTopView() {
        ...
        Queue<HorizontalDistanceNode> bfsQueue = new LinkedList<>();
        bfsQueue.add(new HorizontalDistanceNode(root, 0));

        while (!bfsQueue.isEmpty()) {
            HorizontalDistanceNode current = bfsQueue.remove();
            ...
            if (currentNode.left != null) {
                bfsQueue.add(new HorizontalDistanceNode(currentNode.left, currentHorizontalDistance - 1));
            }
            if (currentNode.right != null) {
                bfsQueue.add(new HorizontalDistanceNode(currentNode.right, currentHorizontalDistance + 1));
            }
        }
    }
}
