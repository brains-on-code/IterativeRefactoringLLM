...
/**
 * Utility class for the Boyer-Moore majority vote algorithm.
...
public final class BoyerMoore {
    ...
    /**
     * Returns the majority element in the given array, if it exists.
     * A majority element appears more than n/2 times.
     *
     * @param array the input array of integers
     * @return an Optional containing the majority element, or Optional.empty() if none exists
     */
    ...
    /**
     * Applies the Boyer-Moore voting algorithm to select a majority candidate.
    ...
    /**
     * Determines whether the given count qualifies as a majority.
     *
