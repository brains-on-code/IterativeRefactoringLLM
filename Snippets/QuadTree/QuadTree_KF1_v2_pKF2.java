...
/**
 * Axis-aligned square boundary in 2D space, defined by its center and half-size
...
class Boundary {
    ...
    /**
     * Returns {@code true} if the given point lies within this boundary
...
public class QuadTree {
    ...
    /** Indicates whether this node has been subdivided into children. */
     ...
     * @return {@code true} if the point was successfully inserted;
     *         {@code false} if the point is {@code null} or lies outside this node's boundary
     */
    ...
    /**
     * Subdivides this node into four child quadtrees, each covering one quadrant
     * of this node's boundary.
     */
