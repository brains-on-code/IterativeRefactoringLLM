...
public class ShortestRemainingTimeFirstScheduler {
    ...
    private int selectNextProcess(int currentTime, int currentProcessIndex, int[] remainingBurstTimes) {
        ...
        for (int i = 0; i < processCount; i++) {
            ...
            boolean selectedHasRemainingTime = remainingBurstTimes[selectedIndex] > 0;
            boolean currentFinished = !selectedHasRemainingTime;
            boolean hasShorterRemainingTime =
                    hasRemainingTime
                            && (!selectedHasRemainingTime || remainingBurstTimes[i] < remainingBurstTimes[selectedIndex]);
