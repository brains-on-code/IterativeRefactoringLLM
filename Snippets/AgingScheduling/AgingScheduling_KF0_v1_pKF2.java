...
/**
 * Implements an aging-based scheduling algorithm to reduce starvation.
 * <p>
 * Each time a task waits, its priority is increased based on its wait time.
 * This helps ensure that long-waiting, lower-priority tasks eventually get CPU time.
 */
public final class AgingScheduling {

    /**
     * Represents a schedulable task with a name, current wait time, and priority.
     */
    static class Task {
        String name;
        int waitTime;
     ...
     * <p>
     * The selected task's wait time is incremented, and its priority is increased
