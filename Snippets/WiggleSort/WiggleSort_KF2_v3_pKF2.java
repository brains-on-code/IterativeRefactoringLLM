...
public class WiggleSort implements SortAlgorithm {
     ...
     * The resulting order is: 1, 3, 5, ..., 0, 2, 4, ...
     */
    ...
    private <T extends Comparable<T>> T[] wiggleSort(T[] array) {
        ...
        // Median element via QuickSelect.
        ...
        /*
         * Odd-length arrays:
         * If the median appears ceil(n / 2) times, then a valid wiggle ordering
        ...
        /*
         * General constraint for wiggle sort:
