    ...
    private void configureSlf4jLogging(PrintStream originalErr) {
        ...
        System.setErr(new PrintStream(originalErr) {
            ...
            public void println(String str) {
                if (shouldSuppressSlf4jLine(str)) {
                    suppressedCount++;
                    return;
                }

                restoreOriginalErrIfNecessary(originalErr);
                super.println(str);
            }

            private boolean shouldSuppressSlf4jLine(String str) {
                return str != null
                        && str.startsWith(SLF4J_PREFIX)
                        && suppressedCount < MAX_SUPPRESSED_LOG_LINES;
            }

            private void restoreOriginalErrIfNecessary(PrintStream originalErr) {
                if (System.err == this) {
