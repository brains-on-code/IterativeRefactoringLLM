...
public final class Class1 {
    ...
    /**
     * Binary search helper for {@link #lengthOfLISWithCustomLowerBound(int[])}.
     ...
     * Uses a custom {@link #lowerBound(int[], int, int, int)} implementation.
     */
    public static int lengthOfLISWithCustomLowerBound(int[] nums) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            if (current < tails[0]) {
                ...
                // Replace the first element in tails that is >= current
     ...
     * <p>
     * Time complexity: O(n log n).
     * Uses {@link #binarySearchPosition(int[], int, int)} as a binary search helper.
     */
    ...
    /**
     * Binary search helper for {@link #lengthOfLISWithBinarySearch(int[])}.
     * <p>
