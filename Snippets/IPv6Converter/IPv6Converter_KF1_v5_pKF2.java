...
public final class Ipv4Ipv6Mapper {
    ...
    /** Index in the IPv6 byte array where the embedded IPv4 address starts. */
    private static final int IPV4_START_INDEX_IN_IPV6 = 12;

    /** Indices of the two 0xff bytes in the IPv6-mapped IPv4 prefix. */
    ...
    public static String toIpv6MappedIpv4(String ipv4Address) throws UnknownHostException {
        ...
        byte[] ipv6Bytes = createIpv6MappedPrefix();
     ...
     *
     * <p>Expected format (in 16-bit groups): {@code 0:0:0:0:0:ffff:w.x.y.z}</p>
     *
    ...
    /**
     * Creates a 16-byte IPv6 array initialized with the IPv6-mapped IPv4 prefix:
     * {@code 0:0:0:0:0:ffff::}.
     *
     * @return a new byte array containing the IPv6-mapped IPv4 prefix
     */
    private static byte[] createIpv6MappedPrefix() {
    ...
    /**
     * Builds the canonical string representation {@code ::ffff:w.x.y.z}
     * from a 16-byte IPv6-mapped IPv4 address.
     *
     * @param ipv6Bytes a 16-byte IPv6-mapped IPv4 address
     * @return the string representation {@code ::ffff:w.x.y.z}
     */
    ...
    /**
     * Validates that the IPv4 input string is non-null and non-empty.
     *
     * @param ipv4Address the IPv4 address string to validate
     * @throws UnknownHostException if the input is null or empty
     */
