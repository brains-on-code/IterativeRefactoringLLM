...
public final class RabinKarpAlgorithm {
    ...
    public static int search(String pattern, String text, int primeModulus) {
        ...
        for (int i = 0; i < patternLength; i++) {
            ...
            currentWindowHash = (ALPHABET_SIZE * currentWindowHash + text.charAt(i)) % primeModulus;
        }
        ...
        for (int windowStartIndex = 0; windowStartIndex <= textLength - patternLength; windowStartIndex++) {
            ...
            if (windowStartIndex < textLength - patternLength) {
                currentWindowHash =
                    (ALPHABET_SIZE * (currentWindowHash - text.charAt(windowStartIndex) * highestBasePower)
