 ...
 *
 * @author <a href="https://github.com/DenizAltunkapan">Deniz
 *     Altunkapan</a>
 */
public class ConstrainedShortestPath {
        ...
        for (int resourceUsed = 0; resourceUsed <= maxResource; resourceUsed++) {
            for (int currentNode = 0; currentNode < numNodes; currentNode++) {
                ...
                for (Graph.Edge edge : graph.getEdges(currentNode)) {
                    relaxEdge(dp, resourceUsed, currentNode, edge);
                }
            }
        }
    ...
    private void relaxEdge(int[][] dp, int resourceUsed, int currentNode, Graph.Edge edge) {
