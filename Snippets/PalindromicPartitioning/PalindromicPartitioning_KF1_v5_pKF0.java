...
public final class PalindromePartitioner {
    ...
    /**
     * Builds a table where palindromeTable[start][end] is true if the substring
     * input[start..end] (inclusive) is a palindrome.
     */
        ...
        for (int end = 0; end < length; end++) {
            ...
            for (int start = 0; start < end; start++) {
                if (palindromeTable[start + 1][end]) {
                    currentMinCuts = Math.min(currentMinCuts, minCuts[start] + 1);
                }
            }
