...
public final class HsvRgbConverter {
    ...
    public static int[] hsvToRgb(double hue, double saturation, double value) {
        ...
        return composeRgbFromChroma(hueSector, chroma, matchComponent, intermediateComponent);
    }
    ...
    private static int[] composeRgbFromChroma(
            double hueSector, double chroma, double matchComponent, double intermediateComponent) {
