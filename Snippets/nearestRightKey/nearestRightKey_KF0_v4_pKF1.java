...
final class NearestRightKey {
    ...
    public static int findNearestRightKey(BinarySearchTreeNode currentNode, int targetValue) {
        ...
        if (currentNode.value > targetValue) {
            int nearestRightInLeftSubtree = findNearestRightKey(currentNode.left, targetValue);
            return nearestRightInLeftSubtree == 0 ? currentNode.value : nearestRightInLeftSubtree;
        }
