...
public class AutokeyCipher {
    ...
    public String encrypt(String plaintext, String key) {
        ...
        for (int i = 0; i < normalizedPlaintext.length(); i++) {
            ...
            ciphertext.append(encodeCharacter(plainChar, keyChar));
        }
    ...
    public String decrypt(String ciphertext, String key) {
        ...
        for (int i = 0; i < normalizedCiphertext.length(); i++) {
            ...
            char plainChar = decodeCharacter(cipherChar, keyChar);
     ...
     */
    private char encodeCharacter(char plainChar, char keyChar) {
        int encodedCodePoint =
                (plainChar - FIRST_LETTER + keyChar - FIRST_LETTER) % ALPHABET_SIZE + FIRST_LETTER;
        return (char) encodedCodePoint;
    }
