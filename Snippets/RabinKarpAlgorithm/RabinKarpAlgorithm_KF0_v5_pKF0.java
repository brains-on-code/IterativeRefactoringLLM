...
public final class RabinKarpAlgorithm {
    ...
    private static int slideWindowHash(
        String text,
        int startIndex,
        int patternLength,
        int currentHash,
        ...
        char outgoingChar = text.charAt(startIndex);
        char incomingChar = text.charAt(startIndex + patternLength);
        return recomputeWindowHash(currentHash, outgoingChar, incomingChar, highestPower, primeNumber);
    }
