...
public final class LongestIncreasingSubsequence {
    ...
    public static int lis(int[] array) {
        ...
        int lisLength = 1; // number of valid elements in tails
        ...
        for (int i = 1; i < size; i++) {
            ...
            // Value extends the largest subsequence found so far
            else if (value > tails[lisLength - 1]) {
                tails[lisLength++] = value;
            }
            // Value can be a better tail for some existing subsequence length
            else {
    ...
    public static int findLISLen(int[] array) {
        ...
        int[] tails = new int[size];
        tails[0] = array[0];
        int lisLength = 1; // current length of LIS
