...
public class SJFScheduling {
    ...
    public void scheduleProcesses() {
        ...
        while (executedCount < totalProcesses) {
            nextProcessIndex = addArrivedProcessesToReadyQueue(readyQueue, currentTime, nextProcessIndex);
    ...
    private int addArrivedProcessesToReadyQueue(List<ProcessDetails> readyQueue,
                                                int currentTime,
