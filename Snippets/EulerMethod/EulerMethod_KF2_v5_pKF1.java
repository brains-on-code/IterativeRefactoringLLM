...
public final class EulerMethod {
    ...
    public static void main(String[] args) {
        ...
        List<double[]> solution1 = solveEuler(0, 4, 0.1, 0, derivativeFunction1);
        ...
        List<double[]> solution2 = solveEuler(0, 4, 0.1, 1, derivativeFunction2);
        ...
        List<double[]> solution3 = solveEuler(0, 0.1, 0.025, 1, derivativeFunction3);
    ...
    public static ArrayList<double[]> solveEuler(
        ...
        while (currentX < endX) {
            currentY = computeEulerStep(currentX, stepSize, currentY, derivativeFunction);
            currentX += stepSize;
