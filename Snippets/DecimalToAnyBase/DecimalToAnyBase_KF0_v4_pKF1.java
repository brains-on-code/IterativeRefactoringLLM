...
public final class DecimalToAnyBase {
    ...
    public static String convertToAnyBase(int decimalNumber, int targetBase) {
        ...
        StringBuilder convertedNumber = new StringBuilder(digitsInTargetBase.size());
        for (int i = digitsInTargetBase.size() - 1; i >= 0; i--) {
            convertedNumber.append(digitsInTargetBase.get(i));
        }
