...
public final class JohnsonsAlgorithm {
    ...
    /**
     * Runs Johnson's algorithm to compute all-pairs shortest paths.
     *
    ...
    /**
     * Converts an adjacency matrix to an edge list representation.
     *
    ...
    /**
     * Bellman-Ford algorithm with an added super source to compute vertex potentials.
     *
    ...
    /**
     * Reweights the graph using vertex potentials so that all edge weights become non-negative.
     *
    ...
    /**
     * Dijkstra's algorithm on the reweighted graph, followed by restoring original distances.
     *
