...
public final class Class1 {
   ...
   */
  public static String method1(String var1) throws IOException {
    ClassLoader var5 = Class1.class.getClassLoader();
    try (InputStream inputStream = var5.getResourceAsStream(var1)) {
      if (inputStream == null) {
        throw new NoSuchFileException(var1);
      }
      InputStreamReader var6 = new InputStreamReader(inputStream, StandardCharsets.UTF_8);
      try (BufferedReader bufferedReader = new BufferedReader(var6)) {
   ...
   */
  public static String method2(Path var2) throws IOException {
    return String.join(System.lineSeparator(), Files.readAllLines(var2));
  }
   ...
   */
  public static List<String> method3(String var3, String var1) throws IOException {
    final boolean var7 = System.getProperty("os.name").toLowerCase().contains("win");
    if (var7) {
      return ShellHelper.exec("cmd.exe", "/c", "dir", var3, "/s", "/b", "|", "findstr", var1);
    }
    return ShellHelper.exec("sh", "-c", "find", var3, "-name", var1);
  }
   ...
   */
  public static List<String> method4(String var4) throws IOException {
    try (Stream<Path> stream = Files.list(Path.of(var4))) {
