...
class Graph {
    ...
    public static class Vertex implements Comparable<Vertex> {
        ...
        public int hashCode() {
            ...
            hashResult = 31 * hashResult + (name != null ? name.hashCode() : 0);
            hashResult = 31 * hashResult + distanceFromSource;
            hashResult = 31 * hashResult + (previousVertex != null ? previousVertex.hashCode() : 0);
            hashResult =
                    31 * hashResult + (adjacentVertices != null ? adjacentVertices.hashCode() : 0);
            return hashResult;
        }
    ...
    public void dijkstra(String startVertexName) {
        ...
        for (Vertex vertex : verticesByName.values()) {
            ...
            vertex.distanceFromSource = vertex == startVertex ? 0 : Integer.MAX_VALUE;
