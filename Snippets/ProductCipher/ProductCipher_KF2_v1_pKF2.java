...
final class ProductCipher {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            String substitutedText = applySubstitutionCipher(inputText, SHIFT_VALUE);
            System.out.println();
            System.out.println("Substituted text:");
            System.out.println(substitutedText);

            String transpositionInput = padForTransposition(substitutedText, key, PADDING_CHAR);
            String transposedText = applyColumnarTransposition(transpositionInput, key);

            System.out.println();
            System.out.println("Final encrypted text:");
            System.out.println(transposedText);

            String decryptedText = decryptProductCipher(transposedText, key, SHIFT_VALUE);
    ...
    private static String decryptProductCipher(String encryptedText, int key, int shift) {
        String transpositionPlaintext = reverseColumnarTransposition(encryptedText, key);
        return reverseSubstitutionCipher(transpositionPlaintext, shift);
    }
