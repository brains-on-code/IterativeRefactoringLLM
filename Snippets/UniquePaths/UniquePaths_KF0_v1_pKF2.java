...
public final class UniquePaths {
    ...
    /**
     * Computes the number of unique paths using a 1D DP array.
    ...
    public static int uniquePaths(final int m, final int n) {
        // Ensure we always allocate the smaller dimension for the DP array
        if (m > n) {
    ...
    /**
     * Computes the number of unique paths using a 2D DP array.
     * Time complexity: O(m * n)
    ...
    public static int uniquePaths2(final int m, final int n) {
        ...
        // First row and first column each have exactly one path to any cell
