 ...
 * Stores a tree node and its horizontal distance from the root.
 */
class QueueItem {
...
class Tree {
     ...
     * breadth-first (level-order) traversal while tracking horizontal
    ...
    public void printTopView() {
        ...
        while (!queue.isEmpty()) {
            ...
            if (currentNode.left != null) {
                queue.add(new QueueItem(currentNode.left, horizontalDistance - 1));
            }

            if (currentNode.right != null) {
                queue.add(new QueueItem(currentNode.right, horizontalDistance + 1));
            }
        }
    }
}
