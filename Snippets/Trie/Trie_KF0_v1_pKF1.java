...
public class Trie {
    ...
    public void insert(String word) {
        ...
        for (int index = 0; index < word.length(); index++) {
            ...
            TrieNode nextNode = currentNode.children.getOrDefault(currentCharacter, null);

            if (nextNode == null) {
                nextNode = new TrieNode(currentCharacter);
                currentNode.children.put(currentCharacter, nextNode);
            }
