...
public final class InverseOfMatrix {
    ...
    public static double[][] invert(double[][] matrix) {
        ...
        double[][] lu = copyMatrix(matrix);
        double[][] inverse = new double[size][size];
        double[][] identity = createIdentityMatrix(size);
        int[] pivotIndices = new int[size];

        decomposeToLU(lu, pivotIndices);
        applyForwardSubstitution(lu, identity, pivotIndices);
        applyBackSubstitution(lu, identity, inverse, pivotIndices);
    ...
    private static void applyForwardSubstitution(double[][] lu, double[][] identity, int[] pivotIndices) {
        int size = lu.length;
    ...
    private static void applyBackSubstitution(
        double[][] lu,
        double[][] identity,
        double[][] inverse,
        int[] pivotIndices
