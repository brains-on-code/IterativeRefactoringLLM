...
public final class MatrixChainMultiplication {
    ...
    /**
     * cost[i][j] = minimum scalar multiplications to compute product A_i..A_j (1-based).
     */
    ...
    /**
     * Initializes the DP tables {@code cost} and {@code split} with sentinel values.
     *
    ...
    /**
     * Builds the dimensions array p where matrix i has dimensions p[i - 1] x p[i].
     *
