...
public final class BinaryToHexadecimal {
    ...
    private static final Map<Integer, String> DECIMAL_TO_HEX = createDecimalToHexMap();
    ...
    private static int extractNextHexDigitValue(int binary) {
        ...
        for (int bitPosition = 0;
             bitPosition < BITS_PER_HEX_DIGIT && tempBinary != 0;
             bitPosition++) {
     ...
     */
    private static Map<Integer, String> createDecimalToHexMap() {
