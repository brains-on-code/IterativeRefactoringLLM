...
public final class DecimalToAnyBase {
     ...
     * @param base    the target base (between MIN_BASE and MAX_BASE inclusive)
    ...
    /**
     * Ensures the base is within the supported range.
     *
    ...
    /**
     * Maps a numeric value (0–35) to its corresponding character representation.
     * Values 0–9 map to '0'–'9', and 10–35 map to 'A'–'Z'.
     *
     * @param value the numeric value to convert
     * @return the character representation of {@code value}
     */
