...
public class LookScheduling {
    ...
    public List<Integer> execute(List<Integer> requests) {
        ...
        splitRequestsByHeadPosition(requests, lowerRequests, upperRequests);
    ...
    /**
     * Splits requests into those below the current head position and those at or above it.
     * Requests outside the valid track range are ignored.
     */
    ...
    /**
     * Updates the farthest serviced position based on the highest upper request.
     */
    ...
    /**
     * Updates the farthest serviced position based on the lowest lower request.
     */
