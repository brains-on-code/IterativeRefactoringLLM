...
/**
 * Utility class for converting integers to their string representation in a given base.
 */
public final class IntegerBaseConverter {
    ...
    public static String convertToBase(int value, int base) {
        ...
        List<Character> digits = extractDigits(value, base);
    ...
    private static List<Character> extractDigits(int value, int base) {
    ...
    private static String buildStringFromDigits(List<Character> digits) {
