...
public class Drive extends FullSubsystem {
  /** Lock to synchronize odometry updates with sensor reads. */
  ...
  /** Read sensors and update module inputs under the odometry lock. */
  ...
  private void clearDisabledSetpointLogs() {
  ...
  /** Push odometry and velocity updates to RobotState. */
  private void updateOdometryAndVelocity() {
  ...
  /** Update hardware-related alerts. */
  private void updateHardwareAlerts() {
    gyroDisconnectedAlert.set(Robot.showHardwareAlerts() && !gyroInputs.connected);
  }

  /** Handle automatic switching between brake and coast while disabled. */
  private void manageBrakeCoast() {
