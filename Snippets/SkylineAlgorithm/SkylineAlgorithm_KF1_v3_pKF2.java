...
public class Class1 {
     ...
     */
    public List<Point> processList(List<Point> list) {
        int size = list.size();
        ...
        List<Point> right = new ArrayList<>(list.subList(mid, size));

        List<Point> processedLeft = processList(left);
        List<Point> processedRight = processList(right);
     ...
     */
    private void removeDominatedNeighbors(List<Point> list) {
     ...
     */
    private int findMinY(List<Point> list) {
