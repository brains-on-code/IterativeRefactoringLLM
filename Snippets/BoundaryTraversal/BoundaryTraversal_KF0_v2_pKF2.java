...
public final class BoundaryTraversal {
    ...
    private static void addRightBoundary(BinaryTree.Node node, List<Integer> result) {
        ...
        // If there is only a right subtree and no left subtree, there is no
        // distinct right boundary to add (it would duplicate the left boundary logic).
    ...
    public static List<Integer> iterativeBoundaryTraversal(BinaryTree.Node root) {
        ...
        // Same reasoning as in addRightBoundary: avoid duplicating left boundary.
