...
public final class HsvRgbConverter {
    ...
    private static boolean hsvAlmostEquals(double[] actualHsv, double[] expectedHsv) {
        ...
        boolean hueClose = Math.abs(actualHue - expectedHue) < 0.2;
        boolean saturationClose = Math.abs(actualSaturation - expectedSaturation) < 0.002;
        boolean valueClose = Math.abs(actualValue - expectedValue) < 0.002;
