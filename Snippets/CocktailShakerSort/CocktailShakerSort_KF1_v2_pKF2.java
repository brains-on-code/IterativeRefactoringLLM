...
class CocktailShakerSort implements SortAlgorithm {
    ...
    /**
     * Forward pass (left to right) over the range [start, end].
     * Bubbles the largest element in this range to its correct position
    ...
    /**
     * Backward pass (right to left) over the range [start, end].
     * Bubbles the smallest element in this range to its correct position
