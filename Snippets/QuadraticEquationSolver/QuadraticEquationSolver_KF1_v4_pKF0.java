...
public class QuadraticEquationSolver {
    ...
    private QuadraticRoot[] solveWithPositiveDiscriminant(double b, double discriminant, double denominator) {
    ...
    private QuadraticRoot[] solveWithNegativeDiscriminant(double b, double discriminant, double denominator) {
