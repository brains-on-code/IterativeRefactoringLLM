...
public class ADFGVXCipher {
    ...
    private String columnarTransposition(String text, String key) {
        ...
        fillTableRowWise(table, text, keyLength);
    ...
    private String reverseColumnarTransposition(String ciphertext, String key) {
        ...
        int[] columnOrder = getColumnOrder(key);
        fillTableColumnWise(table, ciphertext, columnOrder);
    ...
    private void fillTableRowWise(char[][] table, String text, int keyLength) {
    ...
    private void fillTableColumnWise(char[][] table, String ciphertext, int[] columnOrder) {
