...
/**
 * Generates and prints a specific integer sequence.
 *
 * <p>Sequence definition:
 * <ul>
 ...
 *         </ul>
 *     </li>
 *     <li>The sequence stops when it reaches {@code 1} (inclusive).</li>
 * </ul>
 */
public final class IntegerSequenceGenerator {
    ...
    /**
     * Returns {@code true} if {@code value} is even.
     *
