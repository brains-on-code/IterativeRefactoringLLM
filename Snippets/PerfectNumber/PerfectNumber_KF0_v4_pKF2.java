 ...
 * positive divisors, excluding the number itself. For example, 6 has divisors
...
public final class PerfectNumber {
    ...
    /**
     * Checks whether the given number is a perfect number using an
    ...
    public static boolean isPerfectNumber2(int n) {
        ...
        // Adjust for double-counting when n is a perfect square.
        if (root == (int) root) {
