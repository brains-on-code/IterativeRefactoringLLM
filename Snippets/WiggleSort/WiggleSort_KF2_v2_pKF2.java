...
public class WiggleSort implements SortAlgorithm {
     ...
     * The mapping order is: 1, 3, 5, ..., 0, 2, 4, ...
     */
    ...
    /**
     * Performs a three-way partition (Dutch National Flag) around the median
     * using the virtual index mapping. After partitioning:
     * - elements greater than the median are placed at the front (odd indices),
     * - elements less than the median are placed at the back (even indices),
     * - elements equal to the median remain in the middle.
     */
    ...
    private <T extends Comparable<T>> T[] wiggleSort(T[] array) {
         ...
         * If the median appears ceil(n / 2) times, then to allow a valid wiggle
         * ordering, that median must be the smallest value in the array.
         */
        ...
        /*
         * A valid wiggle sort requires that no value appears more than
         * ceil(n / 2) times.
         */
