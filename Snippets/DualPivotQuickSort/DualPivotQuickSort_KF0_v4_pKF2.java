 ...
 *
 * <p>This algorithm uses two pivots to partition the array into three regions:
 *
 * <pre>
...
public class DualPivotQuickSort implements SortAlgorithm {
    ...
    /**
     * Recursively sorts the subarray in the range [left, right] using Dual Pivot QuickSort.
     */
    ...
    private static <T extends Comparable<T>> int[] partition(
        ...
        /*
         * Invariants during partitioning:
         *
         * [left]                      pivot1
        ...
        // Move pivots to their final sorted positions
        pivot1End--;
        high++;
