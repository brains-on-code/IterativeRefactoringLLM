...
/**
 * Comparator for ordering Huffman nodes by ascending frequency.
 */
...
public final class Huffman {
    ...
    /**
     * Recursively prints the Huffman code for each character in the tree.
     *
     * @param node current node in the Huffman tree
     * @param code bitstring accumulated so far on the path to this node
     */
