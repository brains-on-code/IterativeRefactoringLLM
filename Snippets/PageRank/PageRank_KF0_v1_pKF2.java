...
class PageRank {
    ...
    public void calculate(int totalNodes) {
        ...
        // Initialization: assign equal PageRank to all nodes
        ...
        while (iteration <= ITERATIONS) {
            // Copy current PageRank values to a temporary array
            for (int i = 1; i <= totalNodes; i++) {
                tempPageRank[i] = pageRank[i];
                pageRank[i] = 0.0;
            }

            // Distribute PageRank from external nodes to internal nodes
