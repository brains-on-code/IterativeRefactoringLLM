...
public final class StrandSort implements SortAlgorithm {
    ...
    /**
     * Performs strand sort on the given list and returns a new sorted list.
     */
    ...
    /**
     * Extracts a single non-decreasing strand from the front of the list.
     * Elements that are part of the strand are removed from the original list.
     */
