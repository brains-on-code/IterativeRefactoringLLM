...
public final class RgbHsvConversion {
    ...
    public static int[] hsvToRgb(double hue, double saturation, double value) {
        ...
        double secondLargestComponent = chroma * (1 - Math.abs(hueSector % 2 - 1));
        double matchValue = value - chroma;

        return getRgbByHueSector(hueSector, chroma, matchValue, secondLargestComponent);
    }
    ...
    public static double[] rgbToHsv(int red, int green, int blue) {
        ...
        double chroma = value - Math.min(Math.min(normalizedRed, normalizedGreen), normalizedBlue);
