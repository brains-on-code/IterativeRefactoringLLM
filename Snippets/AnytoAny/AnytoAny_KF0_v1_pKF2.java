 ...
 *
 * <p>The conversion is performed by first converting the source number to its
 * decimal (base-10) representation, and then converting that decimal value
 * to the destination base.</p>
 */
