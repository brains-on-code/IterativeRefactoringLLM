...
public class Class1 extends FullSubsystem {
  // Global lock for drive-related operations
  ...
  public Class1(GyroIO gyroIO, ModuleIO frontLeftIO, ModuleIO frontRightIO,
                ModuleIO backLeftIO, ModuleIO backRightIO) {
    this.gyroIO = gyroIO;
  ...
  /** Set desired chassis speeds for the swerve drive. */
  ...
  /** Set all modules to the same drive voltage. */
  ...
  /** Command zero chassis speeds (stop the drive). */
  public void method5() {
    method3(new ChassisSpeeds());
  }

  /** Point all modules to their default (translation) angles and stop. */
  public void method6() {
  ...
  /** Get the measured module states. */
  ...
  /** Get the measured module positions. */
  ...
  /** Get the measured chassis speeds from the module states. */
  @AutoLogOutput(key = "SwerveChassisSpeeds/Measured")
  private ChassisSpeeds getMeasuredChassisSpeeds() {
    return kinematics.toChassisSpeeds(getMeasuredModuleStates());
  }

  /** Get wheel radius characterization positions for all modules. */
