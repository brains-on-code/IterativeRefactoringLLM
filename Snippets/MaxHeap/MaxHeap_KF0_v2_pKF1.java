...
public class MaxHeap implements Heap {
    ...
    public MaxHeap(List<HeapElement> initialElements) {
        ...
        for (int i = heapElements.size() / 2; i >= 0; i--) {
    ...
    private void swap(int firstIndex, int secondIndex) {
        HeapElement temporaryElement = heapElements.get(firstIndex - 1);
        heapElements.set(firstIndex - 1, heapElements.get(secondIndex - 1));
        heapElements.set(secondIndex - 1, temporaryElement);
    }
