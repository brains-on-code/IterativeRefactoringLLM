...
public final class EulerMethod {
    ...
    private static void runExample1() {
        ...
        assertLastY(points, 7.800000000000003);
        printPoints(points);
    }
    ...
    private static void runExample2() {
        ...
        assertLastY(points, 45.25925556817596);
        printPoints(points);
    }
    ...
    private static void runExample3() {
        ...
        assertLastY(points, 1.1116729841674804);
        printPoints(points);
    }

    private static void assertLastY(List<double[]> points, double expectedY) {
        double[] lastPoint = points.get(points.size() - 1);
        assert lastPoint[Y_INDEX] == expectedY;
    }
    ...
    public static List<double[]> eulerFull(
        ...
        points.add(createPoint(xStart, yStart));
        ...
        while (xCurrent < xEnd) {
            ...
            xCurrent += stepSize;
            points.add(createPoint(xCurrent, yCurrent));
        }
