...
public final class NumberToWords {
    ...
    private static String convertWholeNumberToWords(BigDecimal number) {
        ...
        while (number.compareTo(BigDecimal.ZERO) > 0) {
            ...
            if (chunk > 0) {
                ...
                String powerWord = getPowerWord(powerIndex);
                words.insert(0, chunkWords + powerWord);
            }
    ...
    private static String getPowerWord(int powerIndex) {
        if (powerIndex <= 0) {
            return " ";
        }
