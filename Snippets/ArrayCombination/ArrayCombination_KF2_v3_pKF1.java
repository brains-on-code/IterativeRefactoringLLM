...
public final class ArrayCombination {
    ...
    private static void generateCombinations(
        ...
        for (int candidateValue = startIndex; candidateValue < upperBound; candidateValue++) {
            currentCombination.add(candidateValue);
            generateCombinations(allCombinations, currentCombination, candidateValue + 1, upperBound, combinationSize);
