...
public final class ConvexHull {
     ...
     */
    public static List<Point> bruteForceHull(List<Point> points) {
    ...
    public static List<Point> quickHull(List<Point> points) {
        ...
        quickHullRecursive(upperSet, leftMost, rightMost, hullPoints);
        quickHullRecursive(lowerSet, rightMost, leftMost, hullPoints);
     ...
     */
    private static void quickHullRecursive(
        ...
        quickHullRecursive(newCandidates, a, farthestPoint, hullPoints);
        hullPoints.add(farthestPoint);
        quickHullRecursive(newCandidates, farthestPoint, b, hullPoints);
    }
}