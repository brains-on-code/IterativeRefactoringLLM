...
public final class Class1 {
    ...
    public static Map<String, String> method1(
        ...
        while (!freeOptions.isEmpty()) {
            ...
            String matchedOptionForCandidate = candidateToOptionMatch.get(candidate);

            if (matchedOptionForCandidate == null) {
            ...
            int currentOptionRank = candidatePreferences.indexOf(matchedOptionForCandidate);
            ...
            if (candidatePrefersNewOption) {
                candidateToOptionMatch.put(candidate, option);
                freeOptions.add(matchedOptionForCandidate);
            } else {
