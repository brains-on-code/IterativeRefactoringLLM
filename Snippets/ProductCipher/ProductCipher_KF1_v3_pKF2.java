...
final class Class1 {
    ...
    /**
     * Applies a simple substitution by shifting each character by {@code shift}.
     *
    ...
    /**
     * Pads the given text with {@code paddingChar} so that its length
    ...
    /**
     * Performs a columnar transposition on {@code text}, printing the matrix
     * row by row and appending the result to {@code encryptedText}.
     *
    ...
    /**
     * Reverses the columnar transposition by reading the text back in
     * row-major order from the column-major encrypted form.
     *
