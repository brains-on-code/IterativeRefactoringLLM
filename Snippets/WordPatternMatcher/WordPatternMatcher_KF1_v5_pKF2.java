...
public final class Class1 {
    ...
    private static boolean backtrack(
        ...
        // If currentChar already has a mapping, verify it matches at the current position
        ...
        // Try all possible non-empty substrings starting at strIndex as a new mapping
        for (int end = strIndex + 1; end <= str.length(); end++) {
            ...
            // Remove mapping and try the next candidate
