...
public final class JobSequencer {
    ...
    static class Job implements Comparable<Job> {
        final char id;
        final int deadline; // Deadline in 1-based time slots
        final int profit;
    ...
    public static String getJobSequence(List<Job> jobs, int maxSlots) {
        ...
        // Try to schedule each job in the latest possible free slot
        ...
        // Build the resulting job sequence in chronological order
