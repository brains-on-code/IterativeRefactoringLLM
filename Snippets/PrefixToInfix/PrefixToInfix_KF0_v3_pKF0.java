...
public final class PrefixToInfix {
    ...
    public static String getPrefixToInfix(String prefix) {
        ...
        for (int i = prefix.length() - 1; i >= 0; i--) {
            ...
            if (isOperator(token)) {
                applyOperator(expressionStack, token);
            } else {
                expressionStack.push(String.valueOf(token));
            }
        }
    ...
    private static void applyOperator(Stack<String> expressionStack, char operator) {
