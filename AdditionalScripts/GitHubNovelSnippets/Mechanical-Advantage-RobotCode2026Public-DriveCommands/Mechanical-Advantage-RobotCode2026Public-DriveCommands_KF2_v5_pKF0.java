...
public class DriveCommands {
  ...
  public static Command joystickDrive(
    ...
    return Commands.run(
        () -> {
          ...
          Rotation2d allianceAdjustedRotation = getAllianceAdjustedRotation();

          drive.runVelocity(
              ChassisSpeeds.fromFieldRelativeSpeeds(speeds, allianceAdjustedRotation));
        },
        drive);
  }
  ...
  private static void updateLaunchControllerGains(ProfiledPIDController controller) {
    ...
    boolean gainsChanged =
        driveLaunchKp.hasChanged(controllerId)
  ...
  private static Rotation2d getAllianceAdjustedRotation() {
    Rotation2d baseRotation = RobotState.getInstance().getRotation();
