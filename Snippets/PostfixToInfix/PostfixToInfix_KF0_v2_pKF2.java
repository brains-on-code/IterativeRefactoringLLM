...
/**
 * Utility class for converting postfix expressions to infix expressions.
 *
 * <p>Example:
 * <pre>
...
public final class PostfixToInfix {
    ...
    /**
     * Checks if the given character is a supported arithmetic operator.
     *
     * @param token the character to check
     * @return {@code true} if {@code token} is one of +, -, /, *, ^; {@code false} otherwise
     */
     ...
     * <p>Rules:
     * <ul>
     *   <li>A single alphabetic character is considered valid (single operand).</li>
     *   <li>Otherwise, the expression must contain at least two operands and one operator.</li>
     *   <li>While scanning left to right, the number of operands must always be greater
     ...
     * @return the equivalent infix expression, or an empty string if {@code postfix} is empty
