...
public class TransactionService {
    ...
    public TransactionResult processTransaction(Transaction transaction) {
        ...
        try {
            ...
            handleSuccess(processedTransaction);
    ...
    private Transaction executeTransaction(Transaction transaction) throws InsufficientFundsException {
        ...
        transferFunds(fromAccount, toAccount, transaction.getAmount());
    ...
    private void transferFunds(Account fromAccount, Account toAccount, BigDecimal amount) {
    ...
    private void handleSuccess(Transaction processedTransaction) {
    ...
    private void handleProcessingError(Transaction transaction, Exception e) {
