...
public final class WineProblem {
    ...
    public static int wpRecursion(int[] prices, int start, int end) {
        ...
        int profitIfSellStart = prices[start] * year
            + wpRecursion(prices, start + 1, end);
        int profitIfSellEnd = prices[end] * year
            + wpRecursion(prices, start, end - 1);
    ...
    public static int wptd(int[] prices, int start, int end, int[][] memo) {
        ...
        int profitIfSellStart = prices[start] * year
            + wptd(prices, start + 1, end, memo);
        int profitIfSellEnd = prices[end] * year
            + wptd(prices, start, end - 1, memo);
