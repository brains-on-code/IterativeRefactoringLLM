...
public final class ChineseRemainderTheorem {
    ...
    /**
     * Computes the modular multiplicative inverse of a value modulo modulus
    ...
    private static int modularInverse(int value, int modulus) {
        ...
        int coefficientPrevious = 0;
        int coefficientCurrent = 1;
        ...
        while (dividend > 1) {
            ...
            int divisorPrevious = divisor;
            divisor = dividend % divisor;
            dividend = divisorPrevious;

            int coefficientTemp = coefficientPrevious;
            coefficientPrevious = coefficientCurrent - quotient * coefficientPrevious;
            coefficientCurrent = coefficientTemp;
        }

        if (coefficientCurrent < 0) {
            coefficientCurrent += originalModulus;
        }

        return coefficientCurrent;
    }
}