...
public class SkylineAlgorithm {
    ...
    private final List<Point> skylinePoints;

    public SkylineAlgorithm() {
        this.skylinePoints = new ArrayList<>();
    }

    public List<Point> getSkylinePoints() {
        return skylinePoints;
    }

    public List<Point> computeSkyline(List<Point> points) {
        ...
        List<Point> leftPartition = new ArrayList<>();
        List<Point> rightPartition = new ArrayList<>();
        ...
        List<Point> leftSkyline = computeSkyline(leftPartition);
        List<Point> rightSkyline = computeSkyline(rightPartition);

        return mergeSkylines(leftSkyline, rightSkyline);
    }

    public List<Point> mergeSkylines(List<Point> leftSkyline, List<Point> rightSkyline) {
