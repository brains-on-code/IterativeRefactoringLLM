...
/**
 * Utility class for converting non-negative integers between bases 2 through 10.
 *
 ...
 * </ol>
 *
 * <p>All numbers are represented using decimal digits (0–9). For example, the
 * binary number 1011₂ is passed as the integer {@code 1011} with {@code base = 2}.
 */
public final class AnytoAny {
    ...
    private static int fromDecimal(int decimal, int base) {
        ...
        while (decimal != 0) {
            ...
            convertedNumber += digit * placeValue;
            placeValue *= 10;
            decimal /= base;
        }
