...
public final class WineProblem {
    ...
    /**
     * Computes the maximum profit using pure recursion (no memoization).
     *
    ...
    /**
     * Computes the maximum profit using top-down dynamic programming with memoization.
     *
     * @param prices array of wine prices
     * @param start  starting index of the current range
     * @param end    ending index of the current range
    ...
    /**
     * Computes the maximum profit using bottom-up dynamic programming.
     *
     * @param prices array of wine prices
    ...
    /**
     * Computes the current year based on the number of remaining bottles.
     *
