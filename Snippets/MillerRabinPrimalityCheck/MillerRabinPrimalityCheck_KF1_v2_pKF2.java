...
public final class MillerRabinPrimality {
    ...
    public static boolean isProbablePrime(long n, int iterations) {
        ...
        for (int i = 0; i < iterations; i++) {
            long a = 2 + Math.floorMod(random.nextLong(), n - 3); // base in [2, n-2]
            if (isCompositeWitness(n, a, decomposition.d, decomposition.s)) {
                return false;
            }
        }
        return true;
    ...
    /**
     * Decomposes value into 2^s * d with d odd.
     */
