...
public final class GaleShapley {
    ...
    public static Map<String, String> stableMatch(
        ...
        while (!freeMen.isEmpty()) {
            ...
            boolean womanPrefersNewMan = prefersNewMan(womanPreferences, man, currentFiance);
    ...
    private static boolean prefersNewMan(
            LinkedList<String> womanPreferences,
            String newMan,
            String currentFiance
    ) {
        int newManRank = womanPreferences.indexOf(newMan);
        ...
        if (currentFianceRank == -1) {
            return true;
        }

        return newManRank < currentFianceRank;
    }
}