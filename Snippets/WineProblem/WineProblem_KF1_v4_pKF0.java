...
public final class Class1 {
    ...
    public static int method1(int[] prices, int left, int right) {
        ...
        int sellLeftRevenue =
            method1(prices, left + 1, right) + prices[left] * year;
        int sellRightRevenue =
            method1(prices, left, right - 1) + prices[right] * year;
    ...
    public static int method2(int[] prices, int left, int right, int[][] dp) {
        ...
        int sellLeftRevenue =
            method2(prices, left + 1, right, dp) + prices[left] * year;
        int sellRightRevenue =
            method2(prices, left, right - 1, dp) + prices[right] * year;
