...
public class Class1 {
    ...
    /**
     * Computes the maximum value in each sliding window of size {@code windowSize}.
     *
    ...
    public int[] method1(int[] nums, int windowSize) {
        ...
        /*
         * Deque of indices into {@code nums}.
         *
         ...
         *
         * Therefore, nums[deque.peekFirst()] is always the maximum in the current window.
         */
        ...
        for (int i = 0; i < n; i++) {
            ...
            // they cannot be maxima for any window that includes i.
            while (!deque.isEmpty() && nums[deque.peekLast()] < nums[i]) {
                deque.pollLast();
            }

            // Add the current index as a candidate for the window maximum.
            deque.offerLast(i);
