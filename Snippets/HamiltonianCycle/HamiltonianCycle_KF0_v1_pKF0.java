...
public class HamiltonianCycle {
    ...
    private boolean searchHamiltonianPath(int currentVertex) {
        boolean allVerticesVisited = this.pathLength == this.vertexCount;
        boolean canCloseCycle = this.graph[currentVertex][0] == 1 && allVerticesVisited;
        ...
        for (int nextVertex = 0; nextVertex < this.vertexCount; nextVertex++) {
            if (this.graph[currentVertex][nextVertex] == 1 && !isInCurrentPath(nextVertex)) {
