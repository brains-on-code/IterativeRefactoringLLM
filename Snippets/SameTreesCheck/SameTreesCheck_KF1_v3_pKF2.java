...
public final class Class1 {
    ...
    /**
     * Checks whether two nodes are both {@code null}, or both non-{@code null}
     * with equal {@code data} values.
     *
     * @param node1 the first node
     * @param node2 the second node
     * @return {@code true} if the nodes are equal as defined above, {@code false} otherwise
     */
