...
public class Class1 {
    ...
    public int findMinimumCost(int startNode, int endNode) {
        ...
        relaxEdgesWithinTimeLimit(nodeCount, minCostAtTime);

        int minCost = findMinimumCostToNode(endNode, minCostAtTime);
    ...
    private void relaxEdgesWithinTimeLimit(int nodeCount, int[][] costTable) {
    ...
    private int findMinimumCostToNode(int endNode, int[][] costTable) {
