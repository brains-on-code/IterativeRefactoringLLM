...
public final class Class1 {
    ...
    /**
     * Partitions the list into three regions:
     * <pre>
     * [ less than pivot | equal to pivot | greater than pivot ]
     * </pre>
     *
     * @return an index within the "equal to pivot" region that is guaranteed to
     *         contain the element at {@code index} in sorted order.
     */
