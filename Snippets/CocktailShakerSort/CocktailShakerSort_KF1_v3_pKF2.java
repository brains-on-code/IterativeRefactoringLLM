...
class CocktailShakerSort implements SortAlgorithm {
    ...
    /**
     * Performs a forward pass (left to right) over the range [start, end].
     * Moves the largest element in this range to its correct position
    ...
    /**
     * Performs a backward pass (right to left) over the range [start, end].
     * Moves the smallest element in this range to its correct position
