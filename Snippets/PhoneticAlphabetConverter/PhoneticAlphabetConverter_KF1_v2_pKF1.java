...
public final class NatoPhoneticConverter {
     ...
     */
    public static String toNatoPhonetic(String text) {
        StringBuilder natoPhoneticText = new StringBuilder();
        for (char currentCharacter : text.toUpperCase().toCharArray()) {
            ...
            natoPhoneticText.append(phoneticWord).append(" ");
        }
        return natoPhoneticText.toString().trim();
    }
}