...
public class HamiltonianCycle {
    ...
    /** Current number of vertices in the partial path. */
    ...
    /** Initializes internal state for a new Hamiltonian cycle search. */
    ...
    /**
     * Returns {@code true} if the current path uses all vertices and
    ...
    /**
     * Returns {@code true} if {@code vertex} is already present in the current path.
     */
