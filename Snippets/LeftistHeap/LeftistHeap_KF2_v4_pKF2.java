...
public class LeftistHeap {
    ...
    private Node merge(Node a, Node b) {
        ...
        // Ensure that 'a' has the smaller root element so that heap property holds.
        ...
        // Recursively merge 'b' into the right subtree of 'a'.
        a.right = merge(a.right, b);

        // Restore leftist property: left child must have >= npl than right child.
        if (a.left == null) {
            // If there is no left child, move the right child to the left.
            a.left = a.right;
            a.right = null;
            a.npl = 0;
        } else {
            // If right child exists and has larger npl, swap children.
            if (a.right != null && a.left.npl < a.right.npl) {
                Node temp = a.left;
                a.left = a.right;
                a.right = temp;
            }
            // npl is 1 + npl of the right child (or 0 if right is null).
