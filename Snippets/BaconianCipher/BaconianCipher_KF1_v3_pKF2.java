...
public class BaconianCipher {
     ...
     *   <li>Convert remaining characters to uppercase.</li>
     *   <li>Replace each character with its 5-letter Baconian code.</li>
     * </ol>
     *
     ...
     * Requirements:
     * <ul>
     *   <li>The input length must be a multiple of 5.</li>
     *   <li>Each 5-character group must be a valid Baconian code.</li>
     * </ul>
     *
