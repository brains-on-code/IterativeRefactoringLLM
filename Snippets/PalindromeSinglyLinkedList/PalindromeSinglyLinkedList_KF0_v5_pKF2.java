 ...
 * <p>Provides:
 * <ul>
 *   <li>A stack-based approach (O(n) time, O(n) space).</li>
 *   <li>An in-place approach (O(n) time, O(1) extra space).</li>
 * </ul>
 */
public final class PalindromeSinglyLinkedList {
     ...
     * <p>Steps:
     * <ol>
     *   <li>Push all elements onto a stack.</li>
     *   <li>Iterate again and compare each element with the top of the stack.</li>
     * </ol>
     *
     ...
     *   <li>Reverse the second half of the list starting from the middle.</li>
     ...
     *
     * <p>For even-length lists, this returns the first node of the second half.</p>
     *
     * @param head the head node of the list
     * @return the middle node (start of the second half for even-length lists)
     */
