...
final class LongestCommonSubsequence {
    ...
    public static String getLCS(String firstString, String secondString) {
        ...
        String[] firstStringChars = firstString.split("");
        String[] secondStringChars = secondString.split("");

        int firstLength = firstStringChars.length;
        int secondLength = secondStringChars.length;
        ...
        for (int i = 1; i <= firstLength; i++) {
            for (int j = 1; j <= secondLength; j++) {
                if (firstStringChars[i - 1].equals(secondStringChars[j - 1])) {
