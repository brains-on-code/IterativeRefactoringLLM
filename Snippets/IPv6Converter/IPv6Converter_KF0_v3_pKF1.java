...
public final class IPv6Converter {
    ...
    private static final int IPV6_MAPPED_IPV4_FF_BYTE_INDEX_FIRST = 10;
    private static final int IPV6_MAPPED_IPV4_FF_BYTE_INDEX_SECOND = 11;
    ...
    public static String ipv4ToIpv6(String ipv4Address) throws UnknownHostException {
        ...
        ipv6AddressBytes[IPV6_MAPPED_IPV4_FF_BYTE_INDEX_FIRST] = (byte) 0xff;
        ipv6AddressBytes[IPV6_MAPPED_IPV4_FF_BYTE_INDEX_SECOND] = (byte) 0xff;
        System.arraycopy(
            ipv4AddressBytes,
            0,
            ipv6AddressBytes,
    ...
    public static String ipv6ToIpv4(String ipv6Address) throws UnknownHostException {
        ...
        if (isIpv6MappedIpv4Address(ipv6AddressBytes)) {
            byte[] ipv4AddressBytes =
                Arrays.copyOfRange(ipv6AddressBytes, IPV6_MAPPED_IPV4_PREFIX_BYTE_LENGTH, IPV6_ADDRESS_BYTE_LENGTH);
    ...
    private static boolean isIpv6MappedIpv4Address(byte[] ipv6AddressBytes) {
        ...
        return ipv6AddressBytes[IPV6_MAPPED_IPV4_FF_BYTE_INDEX_FIRST] == (byte) 0xff
            && ipv6AddressBytes[IPV6_MAPPED_IPV4_FF_BYTE_INDEX_SECOND] == (byte) 0xff;
    }
}