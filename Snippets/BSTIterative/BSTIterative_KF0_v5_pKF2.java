...
public class BSTIterative {
    ...
    public void remove(int data) {
        ...
        // Locate the node to remove, tracking its parent and whether it's a left or right child
        ...
        // Reconnect parent to the replacement node, or update root if removing the root
        if (parent == null) {
