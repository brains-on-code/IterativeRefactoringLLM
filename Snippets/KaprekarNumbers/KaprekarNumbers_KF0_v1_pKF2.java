...
public final class KaprekarNumbers {
    ...
    public static boolean isKaprekarNumber(long num) {
        ...
        // the only possible split is 0 + square, so check that directly.
        if (squaredLength == numDigits) {
            return numberStr.equals(squaredStr);
        }

        // General case: split the square into left and right parts where
        ...
        // Some implementations consider leading-zero variants; this code
        // historically tried two different left parts. We preserve that logic
        // by computing an alternative left part that stops at the first '0'.
