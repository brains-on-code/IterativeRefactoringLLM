...
public class UnionFind {
    ...
    /**
     * Finds the root of the set containing the element element.
    ...
    public int find(int element) {
        ...
        // Path compression
        final int root = find(parentElement);
        parent[element] = root;
        return root;
    }

    /**
     * Unites the sets containing elements firstElement and secondElement.
