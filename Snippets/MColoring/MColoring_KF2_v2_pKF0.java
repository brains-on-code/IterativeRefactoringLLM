...
public final class MColoring {
    ...
    static boolean isColoringPossible(List<Node> nodes, int nodeCount, int maxAllowedColors) {
        ...
        for (int startVertex = 1; startVertex <= nodeCount; startVertex++) {
            ...
            maxUsedColors = getMaxColorUsed(nodes, nodeCount);
    ...
    private static void bfsColorComponent(List<Node> nodes, List<Boolean> visited, int startVertex, int maxAllowedColors) {
