...
public class Trie {
    ...
    /**
     * Returns whether the given word exists in the trie as a complete word.
     *
    ...
    /**
     * Logically deletes the given word from the trie.
     * <p>
     * This method only unmarks the end-of-word flag and does not remove any nodes.
     * </p>
     *
    ...
    /**
     * Returns the total number of complete words stored in the trie.
     *
    ...
    /**
     * Returns whether there exists at least one word in the trie that starts
     ...
     *
     * @param sequence the sequence (word or prefix) to follow; must not be {@code null}
