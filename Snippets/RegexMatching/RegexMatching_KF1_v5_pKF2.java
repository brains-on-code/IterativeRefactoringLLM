...
public final class Class1 {
     ...
     * @param pattern pattern containing normal characters, '?' and '*'
     ...
     * @return true if the pattern matches the text from the given indices
     */
     ...
     * @return true if all remaining characters are '*'
     */
