...
public final class LineSweep {
     ...
     *
     * <p>Implements a difference-array based line sweep:
     * <ol>
     *   <li>Increment at each range start index.</li>
     *   <li>Decrement at the index immediately after each range end.</li>
     *   <li>Compute the prefix sum to obtain the number of active ranges at each point.</li>
     * </ol>
