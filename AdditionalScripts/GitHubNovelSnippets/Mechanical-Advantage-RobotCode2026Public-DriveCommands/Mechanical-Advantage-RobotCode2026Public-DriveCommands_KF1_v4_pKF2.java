...
public class Class1 {
   ...
   *
   * <ul>
   *   <li>Apply deadband to the input magnitude
   *   <li>Compute direction from X/Y
   ...
   * <ul>
   *   <li>Apply deadband
   *   <li>Square the value while preserving sign
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>Squared magnitude
   *   <li>Scaled by {@link DriveConstants#maxLinearSpeed}
   * </ul>
   *
   * <p>Rotation:
   *
   * <ul>
   *   <li>Squared
   *   <li>Scaled by {@link DriveConstants#maxAngularSpeed}
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>Controlled by a profiled PID controller
   *   <li>Goal is the launch drive angle and velocity
   * </ul>
   *
   * <p>Translation:
   *
   * <ul>
   *   <li>Controlled directly by joystick inputs
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>Spins the robot at a constant angular velocity
   *   <li>Measures gyro and wheel deltas over time
   *   <li>Logs intermediate values to AdvantageScope
   *   <li>Prints final results to the console
   * </ul>
   */
