...
public class ADFGVXCipher {
    ...
    /** Labels for rows and columns in the Polybius square. */
    ...
    private String columnarTransposition(String text, String key) {
        ...
        char[][] table = createFilledTable(numRows, numCols, '_');
        ...
        for (char keyChar : sortedKey) {
            ...
            appendColumn(table, column, ciphertext);
        }
    ...
    private String reverseColumnarTransposition(String ciphertext, String key) {
        ...
        return readTableRowWise(table, '_');
    }
