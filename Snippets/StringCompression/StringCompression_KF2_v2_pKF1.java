...
public final class StringCompression {
    ...
    public static String compress(String input) {
        ...
        for (int currentIndex = 0; currentIndex < input.length() - 1; currentIndex++) {
            ...
            if (isLastComparison && nextCharacter == currentCharacter) {
                appendCompressedRun(compressedResult, currentCharacter, runLength);
                break;
    ...
    private static void appendCompressedRun(StringBuilder compressedResult, char character, int runLength) {
