...
public final class CombinationsGenerator {
     ...
     * @param startValue        the current starting value for the next element to add
    ...
    private static void buildCombinations(
        ...
        for (int candidateValue = startValue; candidateValue < upperBound; candidateValue++) {
            partialCombination.add(candidateValue);
            buildCombinations(allCombinations, partialCombination, candidateValue + 1, upperBound, combinationSize);
