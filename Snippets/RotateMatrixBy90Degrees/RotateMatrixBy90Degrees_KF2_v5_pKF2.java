...
final class RotateMatrixBy90Degrees {
     ...
     * @return the populated square matrix
     */
    ...
    private static void printMatrix(int[][] matrix) {
        for (int[] row : matrix) {
            StringBuilder line = new StringBuilder(row.length * 2);
...
/**
 * Provides in-place matrix rotation utilities.
 */
final class MatrixRotator {
    ...
    /**
     * Reverses the order of the rows of the given matrix in place.
     *
