...
public final class PrimeCheck {
    ...
    /**
     * Determines whether the given integer is prime using trial division up to sqrt(n).
     *
     ...
     * @return {@code true} if {@code n} is probably prime;
     ...
     * @return the value of {@code (base^exponent) % modulus}
     */
