...
public final class MatrixChainMultiplication {
    ...
    /** DP table: minimum multiplication cost for matrices i..j (1-based). */
    private static int[][] cost;

    /** DP table: index k at which to split product Ai..Aj for optimal cost. */
    private static int[][] split;

    /**
     * Dimensions array: if matrix i has dimensions p[i-1] x p[i],
     * then p has length (numberOfMatrices + 1).
     */
