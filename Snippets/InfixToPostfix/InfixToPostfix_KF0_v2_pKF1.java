...
public final class InfixToPostfix {
    ...
    public static String convertInfixToPostfix(String infixExpression) throws Exception {
        if (!BalancedBrackets.isBalanced(extractBracketsOnly(infixExpression))) {
    ...
    private static String extractBracketsOnly(String inputExpression) {
        Pattern nonBracketPattern = Pattern.compile("[^(){}\\[\\]<>]");
        Matcher matcher = nonBracketPattern.matcher(inputExpression);
