...
public class DriveCommands {
  ...
  /**
   * Convert joystick X/Y inputs into a linear velocity vector.
   *
   * <p>Steps:
   * <ol>
  ...
  /**
   * Convert joystick omega input into an angular velocity scalar.
   *
   * <p>Steps:
   * <ol>
   *   <li>Apply deadband.
  ...
  /** Convert joystick inputs into {@link ChassisSpeeds} in robot coordinates. */
  ...
  /** Whether the robot is within the configured launch angle tolerance. */
  @AutoLogOutput
  ...
  /**
   * Characterize the robot's wheel radius.
   *
   * <p>Method:
   * <ul>
  ...
  /** Get robot rotation adjusted for alliance (flips 180° on red). */
  ...
  /** Update launch controller gains and constraints if any tunables changed. */
  ...
  /** Compute average absolute wheel position delta across all four modules. */
