...
public class MaximumSlidingWindow {
    ...
    /**
     * Returns an array containing the maximum value of each sliding window
     * of size {@code windowSize} over the input array {@code nums}.
     *
    ...
    public int[] maxSlidingWindow(int[] nums, int windowSize) {
         ...
         *  - Corresponding values are in non-increasing order:
         *      nums[deque[0]] >= nums[deque[1]] >= ...
         *  Therefore, nums[deque[0]] is the maximum for the current window.
         */
