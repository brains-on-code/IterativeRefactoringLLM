...
public final class StringMatchFiniteAutomata {
    ...
    private static void validateInputs(final String text, final String pattern) {
    ...
    private static int computeNextState(
        ...
        for (int candidateState = currentState; candidateState > 0; candidateState--) {
            if (!isCandidatePrefix(pattern, candidateState, inputChar)) {
                continue;
            }

            if (isPrefixMatchingSuffix(pattern, currentState, candidateState)) {
    ...
    private static boolean isCandidatePrefix(
        final String pattern,
    ...
    private static boolean isPrefixMatchingSuffix(
        ...
        final int limit = candidateState - 1;
