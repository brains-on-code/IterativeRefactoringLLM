...
public class DiskScheduler {
    ...
    public List<Integer> generateServiceOrder(List<Integer> requests) {
        ...
        partitionRequestsByHeadPosition(requests, lowerThanHead, higherOrEqualToHead);
        sortRequestPartitions(lowerThanHead, higherOrEqualToHead);

        if (movingTowardsHigher) {
            return buildOrderMovingHigher(lowerThanHead, higherOrEqualToHead);
        }
        return buildOrderMovingLower(lowerThanHead, higherOrEqualToHead);
    }
    ...
    private void sortRequestPartitions(
        List<Integer> lowerThanHead,
        List<Integer> higherOrEqualToHead
    ) {
    ...
    private List<Integer> buildOrderMovingHigher(
        List<Integer> lowerThanHead,
        List<Integer> higherOrEqualToHead
    ) {
    ...
    private List<Integer> buildOrderMovingLower(
        List<Integer> lowerThanHead,
        List<Integer> higherOrEqualToHead
    ) {
        List<Integer> serviceOrder = new ArrayList<>();
