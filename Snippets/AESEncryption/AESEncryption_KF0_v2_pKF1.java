...
public final class AESEncryption {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SecretKey aesSecretKey = generateSecretKey();
    ...
    public static String decrypt(byte[] cipherText, SecretKey secretKey)
        ...
        byte[] decryptedPlainTextBytes = decryptionCipher.doFinal(cipherText);
        return new String(decryptedPlainTextBytes);
    }
    ...
    public static String bytesToHex(byte[] bytes) {
        ...
        for (int byteIndex = 0; byteIndex < bytes.length; byteIndex++) {
            ...
            hexCharacters[byteIndex * 2] = HEX_DIGITS[unsignedByte >>> 4];
            hexCharacters[byteIndex * 2 + 1] = HEX_DIGITS[unsignedByte & 0x0F];
        }
