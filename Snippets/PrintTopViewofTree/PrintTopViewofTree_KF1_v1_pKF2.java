...
class NodeWithDistance {
    ...
    NodeWithDistance(TreeNode node, int horizontalDistance) {
        this.node = node;
...
class TopViewBinaryTree {
     ...
     * viewed from the top. For each horizontal distance from the root, only the
     * first node encountered in level order is printed.
     */
