...
public class Class1 {
  ...
  public static Command alignToLaunchAngle(
    ...
    return Commands.run(
        () -> {
          if (kP.hasChanged(controllerId)
              || kD.hasChanged(controllerId)
              || maxVelocity.hasChanged(controllerId)
              || maxAcceleration.hasChanged(controllerId)) {
            ...
            Commands.run(
                    () -> {
                      ...
                      double averageWheelDelta =
                          computeAverageWheelDelta(
                              currentWheelPositions, state.initialWheelPositions);
                ...
                .finallyDo(
                    () -> {
                      ...
                      double averageWheelDelta =
                          computeAverageWheelDelta(
                              finalWheelPositions, state.initialWheelPositions);
                      ...
                      System.out.println(
                          "\tWheel Delta: "
                              + formatter.format(averageWheelDelta)
                              + " radians");
                      System.out.println(
                          "\tGyro Delta: "
                              + formatter.format(state.totalGyroDelta)
                              + " radians");
                      System.out.println(
                          "\tWheel Radius: "
