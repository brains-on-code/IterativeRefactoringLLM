...
public class RobotState {
  ...
  public void addVisionObservation(VisionObservation visionObservation) {
    ...
    var poseAtVisionTimestampOptional = poseBuffer.getSample(visionObservation.timestamp());
    if (poseAtVisionTimestampOptional.isEmpty()) {
      return;
    }

    Pose2d odometryPoseAtVisionTimestamp = poseAtVisionTimestampOptional.get();
