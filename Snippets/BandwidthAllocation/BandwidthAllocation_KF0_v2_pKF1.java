...
public final class BandwidthAllocation {
    ...
    public static int maxValue(int totalBandwidth, int[] userDemands, int[] userValues) {
        ...
        for (int sortedIndex = 0; sortedIndex < userCount; sortedIndex++) {
            int userIndex = (int) userIndexAndValuePerUnit[sortedIndex][0];
            int userDemand = userDemands[userIndex];
            int userValue = userValues[userIndex];
            double valuePerUnitBandwidth = userIndexAndValuePerUnit[sortedIndex][1];
