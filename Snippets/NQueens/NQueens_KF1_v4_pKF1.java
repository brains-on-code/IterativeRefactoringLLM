...
public final class NQueensSolver {
    ...
    private static void placeQueens(
        ...
        for (int columnIndex = 0; columnIndex < boardSize; columnIndex++) {
            queenColumnByRow[rowIndex] = columnIndex;
            if (isSafePlacement(queenColumnByRow, columnIndex, rowIndex)) {
                placeQueens(boardSize, solutions, queenColumnByRow, rowIndex + 1);
            }
        }
    }
