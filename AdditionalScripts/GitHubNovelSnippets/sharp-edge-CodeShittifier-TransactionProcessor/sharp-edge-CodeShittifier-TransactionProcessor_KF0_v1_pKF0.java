...
public class TransactionProcessor {
    ...
    private ValidationResult validateTransaction(Transaction transaction) {
        ...
        validateAccount(transaction.getFromAccount(), ERROR_FROM_ACCOUNT_REQUIRED, errors);
        validateAccount(transaction.getToAccount(), ERROR_TO_ACCOUNT_REQUIRED, errors);
    ...
    private void validateAccount(String account, String errorMessage, List<String> errors) {
