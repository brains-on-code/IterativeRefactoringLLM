...
public final class MinimumSumPartition {
    ...
    public static int minimumSumPartition(final int[] array) {
        ...
        final boolean[] achievableSums = buildAchievableSums(array, target);
        final int bestSubsetSum = findBestSubsetSum(achievableSums, target);

        return totalSum - 2 * bestSubsetSum;
    }

    private static boolean[] buildAchievableSums(final int[] array, final int target) {
    ...
    private static void updateAchievableSums(final boolean[] achievableSums, final int value, final int target) {
