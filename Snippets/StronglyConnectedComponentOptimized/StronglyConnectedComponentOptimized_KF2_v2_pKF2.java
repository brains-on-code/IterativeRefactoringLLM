...
public class StronglyConnectedComponentOptimized {
    ...
    /**
     * Performs DFS on the original graph and pushes vertices onto the stack
    ...
    /**
     * Performs DFS on the reversed graph and collects all vertices
    ...
    public int getOutput(HashMap<Integer, List<Integer>> graph, int n) {
        ...
        // First pass: DFS on the original graph to determine finish order
