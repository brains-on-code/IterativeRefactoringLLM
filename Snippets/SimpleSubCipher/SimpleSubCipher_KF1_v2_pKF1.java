...
public class SubstitutionCipher {
    ...
    public String encode(String plaintext, String key) {
        ...
        for (int i = 0; i < lowercaseKey.length(); i++) {
            substitutionMap.put(currentLowercaseLetter++, lowercaseKey.charAt(i));
            substitutionMap.put(currentUppercaseLetter++, uppercaseKey.charAt(i));
        }
    ...
    public String decode(String ciphertext, String key) {
        ...
        for (int i = 0; i < lowercaseKey.length(); i++) {
            reverseSubstitutionMap.put(lowercaseKey.charAt(i), currentLowercaseLetter++);
            reverseSubstitutionMap.put(uppercaseKey.charAt(i), currentUppercaseLetter++);
        }
