...
public final class ActivitySelection {
    ...
    /**
     * Selects a maximum-size subset of non-overlapping activities using a greedy strategy.
     *
     * @param startTimes array of start times for each activity
     * @param endTimes   array of end times for each activity
     * @return list of indices of the selected activities (referring to the original arrays)
     */
    public static ArrayList<Integer> activitySelection(int[] startTimes, int[] endTimes) {
        ...
        // Greedily pick the next activity that starts after or at the end of the last selected one
        for (int i = 1; i < n; i++) {
