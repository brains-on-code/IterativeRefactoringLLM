...
public class Class1 implements SearchAlgorithm {
    ...
    public <T extends Comparable<T>> int method1(T[] array, T key) {
        ...
        // Fibonacci numbers used to determine probe positions
        ...
        while (fibM > 1) {
            ...
            if (cmp < 0) {
                // Key is greater than the probed value; move the window right
                fibM = fibMMinus1;
                fibMMinus1 = fibMMinus2;
                fibMMinus2 = fibM - fibMMinus1;
                offset = i;
            } else if (cmp > 0) {
                // Key is smaller than the probed value; move the window left
                fibM = fibMMinus2;
        ...
        // Check the last remaining possible element
