...
class CocktailShakerSort implements SortAlgorithm {
    ...
    public <T extends Comparable<T>> T[] sort(final T[] array) {
        ...
        while (leftBoundary < rightBoundary) {
            int newRightBoundary = forwardPass(array, leftBoundary, rightBoundary);
            if (newRightBoundary == leftBoundary) {
                break; // array is sorted
            }
            rightBoundary = newRightBoundary;

            int newLeftBoundary = backwardPass(array, leftBoundary, rightBoundary);
            if (newLeftBoundary == rightBoundary) {
                break; // array is sorted
            }
