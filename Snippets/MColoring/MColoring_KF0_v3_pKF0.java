...
public final class MColoring {
    ...
    static boolean isColoringPossible(List<Node> nodes, int n, int m) {
        ...
        for (int startVertex = 1; startVertex <= n; startVertex++) {
            ...
            // Recalculate maxColorsUsed after each component if needed
            for (int i = 1; i <= n; i++) {
    ...
    private static void bfsColorComponent(List<Node> nodes, List<Boolean> visited, int startVertex, int maxColors) {
