 ...
 * </ul>
 *
 * <p>It uses three precomputed tables:
 * <ol>
...
public final class Verhoeff {
    ...
    /**
     * Multiplication table {@code d} for the dihedral group D5.
     *
     * <p>This is the Cayley table of D5. The group is not commutative, so in
     * general {@code d(j, k) ≠ d(k, j)}.
     *
     * @see <a href="https://en.wikipedia.org/wiki/Dihedral_group">Dihedral group (Wikipedia)</a>
     */
    ...
    /**
     * Inverse table {@code inv}.
     *
     * <p>{@code MULTIPLICATIVE_INVERSE[j]} is the multiplicative inverse of
     * digit {@code j}, i.e. the value {@code k} such that
     * {@code d(j, k) = 0}.
     */
    ...
    /**
     * Permutation table {@code p}.
     *
     * <p>Applies a position-dependent permutation to each digit. This is
     * derived from repeatedly applying the permutation
     * {@code (1 5 8 9 4 2 7 0)(3 6)}.
     */
