...
public class PriorityScheduler {
    ...
    public void schedule() {
        ...
        while (hasPendingOrReadyProcesses(readyQueue)) {
            ...
            executeSingleTimeUnit(readyQueue);
            currentTime++;
        }
    }
    ...
    private void executeSingleTimeUnit(PriorityQueue<ProcessDetails> readyQueue) {
        ...
        runProcessForOneUnit(currentProcess, readyQueue);
    }

    private void runProcessForOneUnit(ProcessDetails process, PriorityQueue<ProcessDetails> readyQueue) {
