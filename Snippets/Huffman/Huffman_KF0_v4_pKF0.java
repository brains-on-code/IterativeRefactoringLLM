...
public final class Huffman {
    ...
    private static HuffmanNode buildHuffmanTree(char[] characters, int[] frequencies) {
        ...
        while (priorityQueue.size() > 1) {
            HuffmanNode firstMin = Objects.requireNonNull(priorityQueue.poll(),
                "Priority queue returned null while building Huffman tree.");
            HuffmanNode secondMin = Objects.requireNonNull(priorityQueue.poll(),
                "Priority queue returned null while building Huffman tree.");
