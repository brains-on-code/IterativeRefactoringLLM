...
public final class ConnectedComponent {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "Number of connected components in character graph: "
                + characterGraph.countConnectedComponents()
        );
        System.out.println(
            "Number of connected components in integer graph: "
                + integerGraph.countConnectedComponents()
        );
    }
}