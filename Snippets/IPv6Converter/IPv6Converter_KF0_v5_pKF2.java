...
public final class IPv6Converter {
    ...
    /**
     * Offset (in bytes) where the IPv4 address starts within an IPv6-mapped IPv4 address.
     * Layout: 0:0:0:0:0:ffff:w.x.y.z
     * Bytes:  [0..9]=0x00, [10]=0xff, [11]=0xff, [12..15]=IPv4
     */
    ...
    public static String ipv4ToIpv6(String ipv4Address) throws UnknownHostException {
        ...
        StringBuilder ipv6String = new StringBuilder(IPV6_MAPPED_PREFIX);
