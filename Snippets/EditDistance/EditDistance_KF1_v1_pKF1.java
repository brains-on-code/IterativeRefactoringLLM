...
public final class EditDistance {
    ...
    public static int recursiveEditDistance(String source, String target, int[][] memo) {
        ...
        if (source.charAt(0) == target.charAt(0)) {
            ...
            int insertCost = recursiveEditDistance(source, target.substring(1), memo);
            int deleteCost = recursiveEditDistance(source.substring(1), target, memo);
            int replaceCost = recursiveEditDistance(source.substring(1), target.substring(1), memo);
