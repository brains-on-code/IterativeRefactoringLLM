...
public class GeneticPatternMatcher {
    ...
    private int noMutationEvents;

    private int totalMutations;

    private int successfulMutations;

    private int unsuccessfulMutations;
     ...
     */
    public GeneticPatternMatcher(String patternString, int chromosomeLength, double mutationProbability) {
        ...
        for (int i = 0; i < patternString.length(); i++) {
            targetPatternGenes.add(Character.getNumericValue(patternString.charAt(i)));
        }
        this.randomGenerator = new Random();
        this.noMutationEvents = 0;
        this.totalMutations = 0;
        this.successfulMutations = 0;
        this.unsuccessfulMutations = 0;
