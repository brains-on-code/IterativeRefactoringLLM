...
class Graph<E extends Comparable<E>> {
    ...
    public void addEdge(E sourceValue, E destinationValue) {
        ...
        for (Vertex vertex : vertexList) {
            if (sourceValue.compareTo(vertex.data) == 0) {
                sourceVertex = vertex;
            } else if (destinationValue.compareTo(vertex.data) == 0) {
     ...
     * visitedVertices and will be ignored if they are chosen again in the vertexList.
     *
