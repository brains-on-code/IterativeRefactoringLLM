...
public class QuadTree {
    ...
    public List<Point> query(BoundingBox range) {
        ...
        pointsWithinRange.addAll(points.stream().filter(range::contains).toList());

        if (subdivided) {
            pointsWithinRange.addAll(northWest.query(range));
            pointsWithinRange.addAll(northEast.query(range));
            pointsWithinRange.addAll(southWest.query(range));
            pointsWithinRange.addAll(southEast.query(range));
        }
