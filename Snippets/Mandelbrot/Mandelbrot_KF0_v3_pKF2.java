...
public final class Mandelbrot {
    ...
    public static void main(String[] args) {
        ...
        assertPixelColor(blackAndWhiteImage, 0, 0, COLOR_WHITE);  // Outside the set
        assertPixelColor(blackAndWhiteImage, 400, 300, COLOR_BLACK); // Inside the set

        BufferedImage coloredImage =
            getImage(800, 600, -0.6, 0, 3.2, 50, true);

        assertPixelColor(coloredImage, 0, 0, COLOR_RED);   // Far from the set
        assertPixelColor(coloredImage, 400, 300, COLOR_BLACK); // Inside the set
