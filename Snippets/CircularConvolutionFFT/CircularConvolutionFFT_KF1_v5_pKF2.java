...
public final class ComplexConvolutionUtils {
    ...
    /**
     * Ensures the given collection has at least {@code targetSize} elements by
     ...
     *
     * <p>Both input lists are zero-padded to the same length (the maximum of
     * their original lengths) before the FFT is applied.</p>
     *
