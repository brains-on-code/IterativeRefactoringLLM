 ...
 * frequencies, possibly in a different order. Depending on the method, the
 * comparison may be case-sensitive or case-insensitive and may support
...
public final class CheckAnagrams {
     ...
     *
     * <p>This method is case-sensitive and optimized by using a fixed-size
     * frequency table of length 26, where index {@code 0} corresponds to
     * {@code 'a'}, index {@code 1} to {@code 'b'}, and so on.
     *
