...
public final class Class1 {
    ...
    public static void method1(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            int insertIndex = readBoundedIndex(
                scanner,
            ...
            int deleteIndex = readBoundedIndex(
                scanner,
    ...
    private static int readBoundedIndex(Scanner scanner, String prompt, int minInclusive, int maxInclusive) {
        while (true) {
            ...
            int index = readInt(scanner, fullPrompt);
            ...
            System.out.printf(
                "Index out of bounds. Please enter a value between %d and %d.%n",
                minInclusive,
                maxInclusive
            );
        }
