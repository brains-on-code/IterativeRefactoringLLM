...
public final class WineProblem {
    ...
    public static int maxProfitRecursive(int[] prices, int leftIndex, int rightIndex) {
        ...
        int remainingWines = rightIndex - leftIndex + 1;
    ...
    public static int maxProfitBottomUp(int[] prices) {
        ...
        int totalWines = prices.length;
        int[][] profitTable = new int[totalWines][totalWines];

        for (int windowSize = 0; windowSize <= totalWines - 1; windowSize++) {
            for (int leftIndex = 0; leftIndex <= totalWines - windowSize - 1; leftIndex++) {
        ...
        return profitTable[0][totalWines - 1];
    }
}