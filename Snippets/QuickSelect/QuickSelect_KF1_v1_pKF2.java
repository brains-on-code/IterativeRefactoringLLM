 ...
 *
 * <p>Currently implements a linear-time selection algorithm (Median of Medians)
 * to find the k-th smallest element in an unsorted list.</p>
 */
public final class Class1 {
    ...
    /**
     * Selects the index of the element that would be at position {@code index}
    ...
    /**
     * Recursive selection using the Median of Medians algorithm.
     *
     * @param list  the list
    ...
    private static <T extends Comparable<T>> int partitionAroundPivot(
        ...
        // First pass: move elements less than pivot to the front
        ...
        // Second pass: group elements equal to pivot after the "less than" region
        ...
        // Place pivot at the end of the "equal to" region
