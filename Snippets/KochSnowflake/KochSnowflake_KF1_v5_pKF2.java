...
public final class KochSnowflake {
    ...
    private static final String OUTPUT_FILENAME = "KochSnowflake.png";
    ...
    private static void runRenderingTestAndWriteImage() {
        ...
        BufferedImage image = createKochSnowflakeImage(imageWidth, DEFAULT_ITERATIONS);
        ...
        try {
            ImageIO.write(image, IMAGE_FORMAT, new File(OUTPUT_FILENAME));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
