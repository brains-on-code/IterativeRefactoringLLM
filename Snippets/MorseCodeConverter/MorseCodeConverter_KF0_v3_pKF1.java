...
public final class MorseCodeConverter {
    ...
    private static final String MORSE_WORD_OUTPUT_DELIMITER = "| ";
    ...
    public static String textToMorse(String text) {
        ...
        String[] words = text.toUpperCase().split(WORD_SEPARATOR);
        ...
        for (int wordIndex = 0; wordIndex < words.length; wordIndex++) {
            ...
            for (char character : word.toCharArray()) {
                morseCodeBuilder
                    .append(CHAR_TO_MORSE_MAP.getOrDefault(character, ""))
                    .append(WORD_SEPARATOR);
            }

            if (wordIndex < words.length - 1) {
                morseCodeBuilder.append(MORSE_WORD_OUTPUT_DELIMITER);
            }
        }
