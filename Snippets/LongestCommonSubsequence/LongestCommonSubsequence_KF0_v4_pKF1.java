    ...
    public static String getLCS(String firstString, String secondString) {
        ...
        for (int firstIndex = 1; firstIndex <= firstLength; firstIndex++) {
            for (int secondIndex = 1; secondIndex <= secondLength; secondIndex++) {
                if (firstCharacters[firstIndex - 1].equals(secondCharacters[secondIndex - 1])) {
                    lcsLengths[firstIndex][secondIndex] = lcsLengths[firstIndex - 1][secondIndex - 1] + 1;
                } else {
                    lcsLengths[firstIndex][secondIndex] =
                        Math.max(lcsLengths[firstIndex - 1][secondIndex], lcsLengths[firstIndex][secondIndex - 1]);
                }
            }
        }
