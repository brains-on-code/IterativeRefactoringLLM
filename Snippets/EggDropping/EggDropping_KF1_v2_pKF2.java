...
public final class EggDropping {
    ...
    /**
     * Returns the minimum number of attempts needed in the worst case to find
    ...
    public static int minAttempts(int eggs, int floors) {
        ...
        // Base cases for floors: 0 floors -> 0 attempts, 1 floor -> 1 attempt
        for (int e = 1; e <= eggs; e++) {
            dp[e][0] = 0;
            dp[e][1] = 1;
        }

        // Base case for eggs: with 1 egg, we must try every floor (linear search)
