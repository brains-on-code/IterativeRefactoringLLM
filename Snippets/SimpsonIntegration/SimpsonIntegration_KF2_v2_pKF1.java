...
public class SimpsonIntegration {
    ...
    public static void main(String[] args) {
        ...
        double stepSize = (upperLimit - lowerLimit) / (double) subIntervalCount;
        double integralApproximation = simpsonIntegration.integrateWithSimpson(subIntervalCount, stepSize, lowerLimit);
        System.out.println("The integral is equal to: " + integralApproximation);
    }

    public double integrateWithSimpson(int subIntervalCount, double stepSize, double lowerLimit) {
