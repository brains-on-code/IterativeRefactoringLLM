...
public class Class1<T> {
    ...
    /** Sentinel value representing "no index" / end of list. */
    private static final int NULL_INDEX = -1;

    /**
     * Index used as the head of the free-list.
     * The node at this index does not store user data; it only manages free nodes.
     */
    private static final int FREE_LIST_HEAD_INDEX = 0;

    /**
     * Internal node representation stored in the backing array.
     *
    ...
    /** Index of the first element in the list, or {@link #NULL_INDEX} if the list is empty. */
    private int headIndex;

    /** Backing array of nodes, including the free-list head at index {@link #FREE_LIST_HEAD_INDEX}. */
