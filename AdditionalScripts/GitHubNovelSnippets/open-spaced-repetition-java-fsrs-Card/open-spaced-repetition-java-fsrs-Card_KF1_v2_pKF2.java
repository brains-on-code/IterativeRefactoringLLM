...
public class Card {
    ...
    public static class CardBuilder {
        ...
        /**
         * Unique identifier for the card. If not provided, it will be generated
        ...
        /**
         * Number of times the card has been reviewed.
         * Defaults to 0 when the state is LEARNING and no value is provided.
         */
        ...
        /**
         * Timestamp when the card was created.
         * Defaults to {@link Instant#now()} if not provided.
         */
        ...
        public Card build() {
            ...
            if (this.id == null) {
                ...
                try {
                    ...
                    // Restore the interrupted status so higher-level code can react appropriately.
     ...
     *
     * @return JSON representation of this card
     */
