...
public class ShortestJobFirstScheduler {
    ...
    protected ArrayList<String> executionSequence;
    ...
    public void schedule() {
        ...
        while (completedProcessCount < totalProcessCount) {
            while (nextProcessToArriveIndex < totalProcessCount
                    && processes.get(nextProcessToArriveIndex).getArrivalTime() <= currentTime) {
                readyQueue.add(processes.get(nextProcessToArriveIndex));
            ...
            if (shortestJobProcess == null) {
                ...
                executionSequence.add(shortestJobProcess.getProcessId());
