...
/**
 * Computes all paths from a source vertex to a destination vertex
 * in a directed graph using depth-first search (DFS).
 *
 * <p>See: <a href="https://en.wikipedia.org/wiki/Shortest_path_problem">
 * Shortest path problem</a></p>
 */
