...
public final class EllipseMidpoint {
    ...
    public static List<int[]> generateEllipsePoints(int centerX, int centerY, int radiusX, int radiusY) {
        ...
        if (radiusX == 0) {
            // Degenerates to a vertical line segment
        ...
        if (radiusY == 0) {
            // Degenerates to a horizontal line segment
    ...
    private static void computeMidpointEllipse(
        ...
        // Region 1 decision parameters (starting at (0, radiusY))
        ...
        // Region 2 decision parameter (starting from last (x, y) of region 1)
