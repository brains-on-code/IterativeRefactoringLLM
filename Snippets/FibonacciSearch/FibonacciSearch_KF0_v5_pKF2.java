...
public class FibonacciSearch implements SearchAlgorithm {
    ...
    public <T extends Comparable<T>> int find(T[] array, T key) {
        ...
        while (fibM > 1) {
            ...
            if (cmp < 0) {
                // Shift window right: discard elements up to index i (inclusive)
                fibM = fibM1;
                fibM1 = fibM2;
                fibM2 = fibM - fibM1;
                offset = i;
            } else if (cmp > 0) {
                // Shift window left: discard elements after index i
                fibM = fibM2;
                fibM1 = fibM1 - fibM2;
                fibM2 = fibM - fibM1;
            } else {
        ...
        if (fibM1 == 1 && lastIndex < n && array[lastIndex].compareTo(key) == 0) {
            return lastIndex;
        }
