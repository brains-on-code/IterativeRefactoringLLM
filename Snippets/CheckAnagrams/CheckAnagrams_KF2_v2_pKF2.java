...
public final class CheckAnagrams {
    ...
    /**
     * Returns {@code true} if the two strings are anagrams of each other,
    ...
    /**
     * Returns {@code true} if the two strings are anagrams of each other,
     * assuming both consist only of ASCII characters (code points 0–127).
     *
     * @param s1 first string
     * @param s2 second string
     * @return {@code true} if {@code s1} and {@code s2} are anagrams;
    ...
    /**
     * Returns {@code true} if the two strings are anagrams of each other,
     * assuming both consist only of lowercase English letters {@code 'a'–'z'}.
     *
