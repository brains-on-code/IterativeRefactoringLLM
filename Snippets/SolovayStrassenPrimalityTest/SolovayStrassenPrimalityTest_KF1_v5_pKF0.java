...
final class Class1 {
    ...
    public int jacobiSymbol(long a, long n) {
        ...
        while (a != 0) {
            a = adjustForPowersOfTwo(a, n);
            result = updateResultForPowersOfTwo(a, n, result);
    ...
    private long adjustForPowersOfTwo(long a, long n) {
        while ((a & 1) == 0) {
            a >>= 1;
        }
        return a;
    ...
    private int updateResultForPowersOfTwo(long a, long n, int result) {
        while ((a & 1) == 0) {
            a >>= 1;
            long nMod8 = n & 7;
            if (nMod8 == 3 || nMod8 == 5) {
