...
public final class WordLadder {
    ...
    public static int ladderLength(String beginWord, String endWord, Collection<String> wordList) {
        ...
        while (!bfsQueue.isEmpty()) {
            ...
            for (int i = 0; i < levelSize; i++) {
                ...
                if (tryAllTransformations(currentWord, endWord, remainingWords, bfsQueue)) {
     ...
     * @param bfsQueue       the BFS queue to add new words to
     * @return true if endWord is found during transformation, false otherwise
     */
    private static boolean tryAllTransformations(
            String currentWord,
            String endWord,
