...
public class ScanScheduling {
    ...
    public List<Integer> execute(List<Integer> requests) {
        ...
        partitionRequests(requests, lowerThanHead, greaterOrEqualHead);

        Collections.sort(lowerThanHead);
        Collections.sort(greaterOrEqualHead);

        return movingUp
            ? processMovingUp(lowerThanHead, greaterOrEqualHead)
            : processMovingDown(lowerThanHead, greaterOrEqualHead);
    }
    ...
    private List<Integer> processMovingUp(
        List<Integer> lowerThanHead,
        List<Integer> greaterOrEqualHead
    ) {
    ...
    private List<Integer> processMovingDown(
        List<Integer> lowerThanHead,
        List<Integer> greaterOrEqualHead
    ) {
        List<Integer> serviceOrder = new ArrayList<>();
