...
public final class EulerMethod {
    ...
    public static void main(String[] args) {
        ...
        List<double[]> solution1 = solveDifferentialEquation(0, 4, 0.1, 0, derivative1);
        ...
        List<double[]> solution2 = solveDifferentialEquation(0, 4, 0.1, 1, derivative2);
        ...
        List<double[]> solution3 = solveDifferentialEquation(0, 0.1, 0.025, 1, derivative3);
