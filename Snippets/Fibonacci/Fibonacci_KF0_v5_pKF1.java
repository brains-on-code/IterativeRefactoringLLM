...
public final class Fibonacci {
    ...
    public static int fibonacciMemoized(int n) {
        ...
        if (n <= 1) {
            ...
            fibonacciNumber = fibonacciMemoized(n - 1) + fibonacciMemoized(n - 2);
            MEMOIZED_FIBONACCI.put(n, fibonacciNumber);
        }
    ...
    public static int fibonacciBottomUp(int n) {
        ...
        for (int i = 0; i <= n; i++) {
            ...
            if (i <= 1) {
                ...
                fibonacciNumber = fibonacciTable.get(i - 1) + fibonacciTable.get(i - 2);
            }
            fibonacciTable.put(i, fibonacciNumber);
        }
