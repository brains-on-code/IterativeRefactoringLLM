...
public class LookScheduling {
    ...
    public List<Integer> execute(List<Integer> requests) {
        ...
        // Partition valid requests into those below and at/above the current position
        ...
        if (movingUp) {
            // Move toward higher tracks first, then reverse
            ...
            // Move toward lower tracks first, then reverse
            Collections.reverse(lower);
            serviceOrder.addAll(lower);
            if (!lower.isEmpty()) {
