...
public final class Pangram {
    ...
    /**
     * Checks if the given string is a pangram using a {@link Set} to collect distinct letters.
     *
    ...
    /**
     * Checks if the given string is a pangram using a boolean array to track which
     * letters of the alphabet have been seen.
     *
     * @param text the input string to check
     * @return {@code true} if the string is a pangram, {@code false} otherwise
     */
    ...
    /**
     * Checks if the given string is a pangram by verifying that each letter from
     * {@code 'a'} to {@code 'z'} appears at least once.
     *
     * @param text the input string to check
     * @return {@code true} if the string is a pangram, {@code false} otherwise
     */
