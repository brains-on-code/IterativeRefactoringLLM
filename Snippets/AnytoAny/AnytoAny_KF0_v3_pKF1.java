...
public final class BaseConverter {
     ...
     *
     * @param sourceValue The number in the original base.
     * @param sourceBase The base of the given number.
     * @return The decimal representation of the number.
     */
    private static int convertToDecimal(int sourceValue, int sourceBase) {
        int decimalValue = 0;
        int placeValue = 1;

        int remainingValue = sourceValue;
