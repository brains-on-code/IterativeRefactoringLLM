...
public final class CirclePointsGenerator {
    ...
    private static void addSymmetricPoints(
        ...
        points.add(new int[] {xPlusOffsetX, yPlusOffsetY});
        points.add(new int[] {xMinusOffsetX, yPlusOffsetY});
        points.add(new int[] {xPlusOffsetX, yMinusOffsetY});
        points.add(new int[] {xMinusOffsetX, yMinusOffsetY});
        points.add(new int[] {xPlusOffsetY, yPlusOffsetX});
        points.add(new int[] {xMinusOffsetY, yPlusOffsetX});
        points.add(new int[] {xPlusOffsetY, yMinusOffsetX});
        points.add(new int[] {xMinusOffsetY, yMinusOffsetX});
    }
}