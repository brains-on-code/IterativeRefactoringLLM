...
public final class SlidingWindowMaximum {
    ...
    public static int[] maxSlidingWindow(int[] nums, int k) {
        ...
        /*
         * Deque of indices with these invariants:
         * 1. All indices are within the current window.
         * 2. Values at those indices are in non-increasing order.
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Add current index as a candidate for future windows
            deque.offerLast(i);
