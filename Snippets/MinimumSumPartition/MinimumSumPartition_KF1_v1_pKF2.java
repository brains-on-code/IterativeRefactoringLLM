...
public final class Class1 {
    ...
    /**
     * Validates that the input array does not contain negative numbers.
     *
     ...
     * we find the largest achievable subset sum not exceeding half of the
     * total sum, then derive the minimal difference from it.
     *
    ...
    public static int method2(final int[] numbers) {
        ...
        // Minimal difference = totalSum - 2 * bestAchievable
