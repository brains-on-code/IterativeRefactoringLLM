...
public class Class1<K, V> {
    ...
    public Class1() {
        this.buckets = createBucketList(INITIAL_CAPACITY);
        this.size = 0;
    }
    ...
    private List<LinkedList<Entry>> createBucketList(int capacity) {
        List<LinkedList<Entry>> newBuckets = new ArrayList<>(capacity);
