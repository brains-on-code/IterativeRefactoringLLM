...
public final class BaseConverter {
    ...
    private static int convertToDecimal(int sourceNumber, int sourceBase) {
        ...
        while (remainingSourceNumber != 0) {
            int currentDigit = remainingSourceNumber % 10;
            decimalNumber += currentDigit * positionalMultiplier;
            positionalMultiplier *= sourceBase;
            remainingSourceNumber /= 10;
        }
    ...
    private static int convertFromDecimal(int decimalNumber, int targetBase) {
        ...
        int remainingDecimalNumber = decimalNumber;
        while (remainingDecimalNumber != 0) {
            int currentDigit = remainingDecimalNumber % targetBase;
            convertedNumber += currentDigit * positionalMultiplier;
            positionalMultiplier *= 10;
            remainingDecimalNumber /= targetBase;
        }
