...
public final class FractionalKnapsack {
    ...
    public static int fractionalKnapsack(int[] weights, int[] values, int capacity) {
        ...
        for (int densityIndex = itemIndexAndValueDensity.length - 1; densityIndex >= 0; densityIndex--) {
            int originalItemIndex = (int) itemIndexAndValueDensity[densityIndex][0];
            double valuePerUnitWeight = itemIndexAndValueDensity[densityIndex][1];
