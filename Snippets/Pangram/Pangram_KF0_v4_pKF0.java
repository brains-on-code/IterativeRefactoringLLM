...
public final class Pangram {
    ...
    public static boolean isPangram(String text) {
        ...
        for (char character : text.toCharArray()) {
            ...
            if (!isAlphabetic(lowerCaseChar)) {
                continue;
            }

            int index = lowerCaseChar - FIRST_LETTER;
    ...
    public static boolean isPangram2(String text) {
        ...
        for (char character = FIRST_LETTER; character <= LAST_LETTER; character++) {
            if (lowerText.indexOf(character) == -1) {
                return false;
            }
        }
        return true;
