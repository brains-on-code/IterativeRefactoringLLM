...
public class MonteCarloTreeSearch {
    ...
    public class Node {
        ...
        private boolean playersTurn; // True if it is the player's turn.
        private boolean playerWon;   // True if the player won; false if the opponent won.
        private int score;
    ...
    private Node selectBestChildByUct(Node node) {
        ...
        for (Node child : node.getChildren()) {
            ...
            double exploration = Math.sqrt(
                Math.log(node.getVisitCount()) / (double) child.getVisitCount()
            );
    ...
    public void simulateRandomPlay(Node promisingNode) {
        ...
        boolean isPlayerWinner = promisingNode.isPlayerWon();
