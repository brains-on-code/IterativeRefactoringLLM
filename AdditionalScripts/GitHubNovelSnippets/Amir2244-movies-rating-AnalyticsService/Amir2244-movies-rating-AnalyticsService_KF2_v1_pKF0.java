...
public class AnalyticsService implements GetAnalyticsUseCase {
    ...
    public AnalyticsSummary getAnalyticsSummary() {
        ...
        String latestDate = loadAnalyticsPort.getLatestAnalyticsTimestamp().orElse(DEFAULT_DATE_VALUE);
        String oldestDate = loadAnalyticsPort.getOldestAnalyticsTimestamp().orElse(DEFAULT_DATE_VALUE);
