...
public class LiangBarsky {
    ...
    private Line buildClippedLine(Line line, double tEnter, double tLeave, double dx, double dy) {
        ...
        double clippedStartX = start.x + tEnter * dx;
        double clippedStartY = start.y + tEnter * dy;
        double clippedEndX = start.x + tLeave * dx;
        double clippedEndY = start.y + tLeave * dy;

        Point clippedStart = new Point(clippedStartX, clippedStartY);
        Point clippedEnd = new Point(clippedEndX, clippedEndY);
