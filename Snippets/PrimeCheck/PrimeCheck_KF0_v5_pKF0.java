...
public final class PrimeCheck {
    ...
    private static void printDeterministicCheckResult(int number) {
        ...
        System.out.println(buildResultMessage("algo1", number, isPrime));
    }
    ...
    private static void printFermatCheckResult(int number, int iterations) {
        ...
        System.out.println(buildResultMessage("algo2", number, isProbablyPrime));
    }

    private static String buildResultMessage(String algorithmLabel, int number, boolean isPrime) {
        String primeStatus = isPrime ? "" : "not ";
        return String.format(
            "%s verify that %d is %sa prime number",
            algorithmLabel,
            number,
            primeStatus
        );
