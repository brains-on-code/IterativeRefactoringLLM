...
public class CircleLinkedList<E> {
    ...
    public E remove(int pos) {
        ...
        previous = moveSteps(previous, pos);
    ...
    /**
     * Moves the given node forward by the specified number of steps.
     *
     * @param node  the starting node
     * @param steps the number of steps to move forward
     * @return the node reached after moving the given number of steps
     */
    private Node<E> moveSteps(Node<E> node, int steps) {
