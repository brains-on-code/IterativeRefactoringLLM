...
/**
 * Dual-pivot three-way quicksort implementation.
 */
public class Class1 implements SortAlgorithm {
    ...
    private static <T extends Comparable<T>> int[] partition(
         ...
         *
         *   [left + 1, less - 1]      : elements <  leftPivot
         *   [less,      current - 1]  : leftPivot ≤ elements ≤ rightPivot
         *   [current,   greater]      : unknown / unprocessed
         *   [greater + 1, right - 1]  : elements >  rightPivot
         */
        int less = left + 1;
        int current = left + 1;
        int greater = right - 1;
