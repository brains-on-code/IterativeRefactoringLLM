...
public class StrassenMatrixMultiplication {
    ...
    public int[][] multiply(int[][] a, int[][] b) {
        ...
        int[][] m1 = multiply(add(a11, a22), add(b11, b22));      // (a11 + a22) * (b11 + b22)
        int[][] m2 = multiply(add(a21, a22), b11);                // (a21 + a22) * b11
        int[][] m3 = multiply(a11, sub(b12, b22));                // a11 * (b12 - b22)
        int[][] m4 = multiply(a22, sub(b21, b11));                // a22 * (b21 - b11)
        int[][] m5 = multiply(add(a11, a12), b22);                // (a11 + a12) * b22
        int[][] m6 = multiply(sub(a21, a11), add(b11, b12));      // (a21 - a11) * (b11 + b12)
        int[][] m7 = multiply(sub(a12, a22), add(b21, b22));      // (a12 - a22) * (b21 + b22)
