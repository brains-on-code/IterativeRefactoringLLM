...
public final class Class1 {
    ...
    public static boolean method2(String first, String second) {
        return areAnagramsWithFrequencyArray(first, second);
    }
    ...
    /**
     * Helper method that checks if two lowercase alphabetic strings are anagrams
     * using a fixed-size frequency array for characters 'a'–'z'.
     */
    private static boolean areAnagramsWithFrequencyArray(String first, String second) {
        if (first.length() != second.length()) {
            return false;
        }
