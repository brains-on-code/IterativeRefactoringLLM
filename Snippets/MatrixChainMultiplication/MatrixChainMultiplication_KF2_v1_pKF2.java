...
public final class MatrixChainMultiplication {
    ...
    /**
     * DP table where m[i][j] stores the minimum number of scalar multiplications
     * needed to compute the matrix A_i..A_j.
     */
    private static int[][] m;

    /**
     * Table where s[i][j] stores the index k at which the optimal split occurs
    ...
    public static Result calculateMatrixChainOrder(ArrayList<Matrix> matrices) {
        ...
        // Build dimensions array p such that matrix i has dimensions p[i-1] x p[i]
