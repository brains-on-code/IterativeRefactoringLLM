...
public class DriveSubsystem extends FullSubsystem {
  ...
  private final Module[] swerveModules = new Module[MODULE_COUNT];
  ...
  public void resetModuleHeadingsToTranslations() {
    Rotation2d[] moduleHeadings = new Rotation2d[MODULE_COUNT];
    for (int moduleIndex = 0; moduleIndex < MODULE_COUNT; moduleIndex++) {
  ...
  private SwerveModuleState[] getMeasuredModuleStates() {
    SwerveModuleState[] measuredModuleStates = new SwerveModuleState[MODULE_COUNT];
    for (int moduleIndex = 0; moduleIndex < MODULE_COUNT; moduleIndex++) {
  ...
  private SwerveModulePosition[] getModulePositions() {
    SwerveModulePosition[] modulePositions = new SwerveModulePosition[MODULE_COUNT];
    for (int moduleIndex = 0; moduleIndex < MODULE_COUNT; moduleIndex++) {
  ...
  public double[] getWheelRadiusCharacterizationPositions() {
    double[] wheelRadiusCharacterizationPositions = new double[MODULE_COUNT];
    for (int moduleIndex = 0; moduleIndex < MODULE_COUNT; moduleIndex++) {
