...
public class HttpServer {
  ...
  private static final String ALL_PATHS_SERVLET_MAPPING = "/*";
  ...
  public void start() {
    ...
    contextHandler.addServlet(servletHolder, ALL_PATHS_SERVLET_MAPPING);

    Server server = new Server(port);
    server.setHandler(contextHandler);
    server.setStopAtShutdown(true);
    server.setStopTimeout(Duration.ofSeconds(SERVER_STOP_TIMEOUT_SECONDS).toMillis());
