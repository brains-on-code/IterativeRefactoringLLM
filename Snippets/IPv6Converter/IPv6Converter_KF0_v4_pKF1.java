...
public final class IPv6Converter {
    ...
    private static final int IPV6_MAPPED_IPV4_FF_FIRST_INDEX = 10;
    private static final int IPV6_MAPPED_IPV4_FF_SECOND_INDEX = 11;
    ...
    public static String ipv4ToIpv6(String ipv4Address) throws UnknownHostException {
        ...
        ipv6Bytes[IPV6_MAPPED_IPV4_FF_FIRST_INDEX] = (byte) 0xff;
        ipv6Bytes[IPV6_MAPPED_IPV4_FF_SECOND_INDEX] = (byte) 0xff;
        System.arraycopy(
            ipv4Bytes,
            0,
            ipv6Bytes,
        ...
        for (int index = IPV6_MAPPED_IPV4_PREFIX_LENGTH; index < IPV6_BYTE_LENGTH; index++) {
            ipv6AddressBuilder.append(ipv6Bytes[index] & 0xFF);
    ...
    private static boolean isIpv6MappedIpv4Address(byte[] ipv6Bytes) {
        ...
        return ipv6Bytes[IPV6_MAPPED_IPV4_FF_FIRST_INDEX] == (byte) 0xff
            && ipv6Bytes[IPV6_MAPPED_IPV4_FF_SECOND_INDEX] == (byte) 0xff;
    }
}