...
public final class BoundaryTraversal {
    ...
    public static List<Integer> getBoundaryTraversal(BinaryTree.Node root) {
    ...
    private static void addLeafNodes(BinaryTree.Node node, List<Integer> leaves) {
        if (node == null) {
            return;
        }
        if (isLeaf(node)) {
            ...
            addLeafNodes(node.left, leaves);
            addLeafNodes(node.right, leaves);
        }
    }
    ...
    public static List<Integer> getBoundaryTraversalWithStack(BinaryTree.Node root) {
        List<Integer> boundary = new ArrayList<>();
        if (root == null) {
            return boundary;
        }
