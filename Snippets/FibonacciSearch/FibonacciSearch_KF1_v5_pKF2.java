...
public class Class1 implements SearchAlgorithm {
    ...
    public <T extends Comparable<T>> int method1(T[] array, T key) {
        ...
        // Initialize Fibonacci numbers: fibM = fib(k), fibMMinus1 = fib(k-1), fibMMinus2 = fib(k-2)
        int fibMMinus2 = 0;
        int fibMMinus1 = 1;
        ...
        while (fibM > 1) {
            int index = Math.min(offset + fibMMinus2, n - 1);
            ...
            if (comparison < 0) {
                ...
                // Move the three Fibonacci variables down two steps
                fibM = fibMMinus2;
