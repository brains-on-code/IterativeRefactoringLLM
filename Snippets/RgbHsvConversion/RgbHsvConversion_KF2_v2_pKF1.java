...
public final class RgbHsvConversion {
    ...
    public static int[] hsvToRgb(double hueDegrees, double saturation, double value) {
        ...
        double intermediateComponent = chroma * (1 - Math.abs(hueSectorIndex % 2 - 1));
        double matchComponent = value - chroma;

        return getRgbFromHueSector(hueSectorIndex, chroma, matchComponent, intermediateComponent);
    }
    ...
    private static int[] getRgbFromHueSector(
            double hueSectorIndex, double chroma, double matchComponent, double intermediateComponent) {
