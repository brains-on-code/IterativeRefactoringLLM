...
{
    private Config driverConfiguration;
    ...
    public JdbcDriverRegistry()
    {
        ...
        File driversDirectory = driversPathProperty != null
                ? new File(driversPathProperty)
    ...
    public JSONObject findByName(String driverName)
    {
        ...
        {
            if(driverConfigEntry.getString("name").equalsIgnoreCase(driverName))
            {
                return driverConfigEntry;
            }
        }
    ...
    {
        driverConfiguration.insert(driverConfigEntry);
    }
    ...
    {
        driverConfiguration.delete(driverConfigEntry);
    }
    ...
    {
        if(driverConfigEntry == null || driverConfigEntry.isNull("driver"))
        {
            return null;
        }
        
        return (Driver)instantiateFromArtifacts(
                driverConfigEntry.getJSONArray("artifact"),
                driverConfigEntry.getString("driver")
        );
    }
    ...
    {
        if(driverConfigEntry == null || driverConfigEntry.isNull("datasource"))
        {
            return null;
        }
        ...
        return (DataSource)instantiateFromArtifacts(
                driverConfigEntry.getJSONArray("artifact"),
                driverConfigEntry.getString("datasource")
        );
    }
