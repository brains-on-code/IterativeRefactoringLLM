...
public final class PreOrderTraversal {
    ...
    public static List<Integer> recursivePreOrder(BinaryTree.Node root) {
        ...
        traversePreOrderRecursively(root, traversalResult);
    ...
    private static void traversePreOrderRecursively(BinaryTree.Node currentNode, List<Integer> traversalResult) {
        if (currentNode == null) {
            return;
        }

        traversalResult.add(currentNode.data);
        traversePreOrderRecursively(currentNode.left, traversalResult);
        traversePreOrderRecursively(currentNode.right, traversalResult);
    }
}