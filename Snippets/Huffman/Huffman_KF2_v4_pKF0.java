...
public final class Huffman {
    ...
    private static HuffmanNode buildHuffmanTree(char[] characters, int[] frequencies) {
        ...
        while (priorityQueue.size() > 1) {
            ...
            if (firstMin == null || secondMin == null) {
                throw new IllegalStateException("Priority queue returned null node while building Huffman tree.");
            }
    ...
    private static void validateInput(char[] characters, int[] frequencies) {
        ...
        if (characters.length == 0) {
            throw new IllegalArgumentException("Characters and frequencies must not be empty.");
        }
    }
