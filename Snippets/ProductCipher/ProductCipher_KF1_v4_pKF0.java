...
final class Class1 {
    ...
    public static void method1(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            String inputText = promptForInputText(scanner);
            int key = promptForKey(scanner);
    ...
    private static String promptForInputText(Scanner scanner) {
        System.out.println("Enter the input to be encrypted: ");
        return scanner.nextLine();
    }

    private static int promptForKey(Scanner scanner) {
        System.out.println();
