...
public final class SameTreesCheck {
    ...
    public static boolean check(BinaryTree.Node firstRoot, BinaryTree.Node secondRoot) {
        ...
        while (!firstQueue.isEmpty() && !secondQueue.isEmpty()) {
            ...
            if (!childrenEqualAndEnqueue(firstNode.left, secondNode.left, firstQueue, secondQueue)) {
                return false;
            }

            if (!childrenEqualAndEnqueue(firstNode.right, secondNode.right, firstQueue, secondQueue)) {
                return false;
            }
        }
