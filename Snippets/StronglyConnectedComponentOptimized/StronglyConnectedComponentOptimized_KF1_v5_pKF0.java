...
public class StronglyConnectedComponents {
    ...
    private Map<Integer, List<Integer>> buildTransposeGraph(
        ...
        Map<Integer, List<Integer>> transposeGraph = new HashMap<>(vertexCount);
    ...
    public int countStronglyConnectedComponents(
        ...
        int[] visited = createVisitedArray(vertexCount);
        Deque<Integer> stack = new ArrayDeque<>();

        performFirstPass(graph, vertexCount, visited, stack);

        Map<Integer, List<Integer>> transposeGraph = buildTransposeGraph(graph, vertexCount);

        Arrays.fill(visited, UNVISITED);
        return performSecondPass(transposeGraph, visited, stack);
    }

    private int[] createVisitedArray(int vertexCount) {
