...
public final class NumberToWordsConverter {
    ...
    /**
     * Returns the fractional part of a BigDecimal as a string of digits.
     *
    ...
    /**
     * Converts the integer part of a number to words, including scale words (thousand, million, etc.).
     *
