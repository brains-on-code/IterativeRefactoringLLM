...
public final class PrefixToInfixConverter {
    ...
    public static String convertPrefixToInfix(String prefixExpression) {
        ...
        for (int index = prefixExpression.length() - 1; index >= 0; index--) {
            ...
            if (isOperator(currentChar)) {
                combineTopTwoOperands(operandStack, currentChar);
            } else {
    ...
    private static void combineTopTwoOperands(Deque<String> operandStack, char operator) {
        ...
        String combinedExpression = "(" + leftOperand + operator + rightOperand + ")";
