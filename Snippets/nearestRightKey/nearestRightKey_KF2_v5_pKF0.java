...
final class NearestRightKey {
    ...
    public static int findNearestRightKey(NRKTreeNode root, int target) {
        ...
        NRKTreeNode current = root;

        while (current != null) {
            if (current.getData() > target) {
                nearestGreater = current.getData();
...
class NRKTreeNode {
    ...
    private NRKTreeNode left;
    private NRKTreeNode right;
    ...
    public NRKTreeNode getLeft() {
        return left;
    }

    public NRKTreeNode getRight() {
        return right;
    }
