...
/**
 * Orchestrates validation, execution, persistence, notification,
 * and audit logging for financial transactions.
 */
public class TransactionProcessor {
     ...
     *     <li>Execute funds transfer</li>
     *     <li>Persist result</li>
     *     <li>Send notifications</li>
     *     <li>Write audit log</li>
     * </ol>
     *
     * @param transaction the transaction to process (must not be {@code null})
    ...
    /**
     * Validates the basic business rules of a transaction.
     *
     * @param transaction the transaction to validate
     * @return a {@link ValidationResult} indicating validity and any errors
     */
    ...
    /**
     * Executes the monetary part of the transaction (debit/credit).
     *
     * @param transaction the transaction to execute
     * @return the same transaction instance, updated with execution details
     * @throws InsufficientFundsException if the source account lacks funds
     */
    ...
    /**
     * Processes a batch of transactions sequentially.
     *
