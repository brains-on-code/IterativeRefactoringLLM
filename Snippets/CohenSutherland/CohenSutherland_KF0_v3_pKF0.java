...
public class CohenSutherland {
    ...
    public Line cohenSutherlandClip(Line line) {
        ...
        while (true) {
            ...
            double[] intersection = computeIntersection(
                x1, y1, x2, y2, outsideCode
            );
            double xIntersection = intersection[0];
            double yIntersection = intersection[1];
    ...
    private double[] computeIntersection(
        double x1,
        double y1,
        double x2,
        double y2,
