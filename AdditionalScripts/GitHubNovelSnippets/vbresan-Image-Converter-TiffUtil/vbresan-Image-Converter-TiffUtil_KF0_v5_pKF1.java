...
public class TiffUtil {
    ...
    private static void convertTiffPageDirectly(
        ...
        // converterOptions.availableMemory = DEFAULT_AVAILABLE_MEMORY_BYTES;
    ...
    private static void convertSingleTiffPage(
         ...
         */
        Bitmap pageBitmap = TiffBitmapFactory.decodeFile(inputTiffFile, decodeOptions);
        int directoryIndex = decodeOptions.inDirectoryNumber;

        try {
            if (pageBitmap != null) {
                Converter.encodeBitmap(pageBitmap, outputFormat, outputFile);
                pageBitmap.recycle();
            } else {
    ...
    public static List<FilenameUriTuple> convertFromTiff(
        ...
        List<FilenameUriTuple> convertedFileTuples = new ArrayList<>();
