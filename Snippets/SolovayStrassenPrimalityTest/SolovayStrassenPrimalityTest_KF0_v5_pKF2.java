...
final class SolovayStrassenPrimalityTest {
    ...
    private static long modularExponentiation(long base, long exponent, long modulus) {
        ...
        while (exponent > 0) {
            boolean exponentIsOdd = (exponent & 1) == 1;
            if (exponentIsOdd) {
    ...
    public int calculateJacobi(long a, long n) {
        ...
        while (a != 0) {
            // Remove factors of 2 from a and adjust sign using (2/n) rules
            while ((a & 1) == 0) {
                a >>= 1;
                long nMod8 = n & 7;
                boolean nIs3Or5Mod8 = (nMod8 == 3 || nMod8 == 5);
                if (nIs3Or5Mod8) {
                    jacobi = -jacobi;
                }
            }
            ...
            boolean aIs3Mod4 = (a & 3) == 3;
            boolean nIs3Mod4 = (n & 3) == 3;
            if (aIs3Mod4 && nIs3Mod4) {
                jacobi = -jacobi;
            }
    ...
    public boolean solovayStrassen(long n, int iterations) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            boolean jacobiIsZero = jacobi == 0;
            boolean modDiffersFromJacobi = mod != jacobi;
            if (jacobiIsZero || modDiffersFromJacobi) {
                return false;
            }
        }
