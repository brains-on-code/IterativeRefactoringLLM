...
public class FloydWarshall {
    ...
    /**
     * Initializes the internal distance matrix from the given adjacency matrix.
     *
     * @param adjacencyMatrix weighted adjacency matrix of the graph
     */
    ...
    /**
     * Core dynamic programming step of the Floyd–Warshall algorithm.
     *
     * <p>Iteratively relaxes distances by allowing each vertex to be used
     * as an intermediate vertex between all pairs of vertices.</p>
     */
