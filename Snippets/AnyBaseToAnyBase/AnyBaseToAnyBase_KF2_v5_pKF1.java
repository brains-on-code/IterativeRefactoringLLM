...
public final class AnyBaseToAnyBase {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                if (!isNumberValidForBase(inputNumber, sourceBase)) {
    ...
    public static boolean isNumberValidForBase(String number, int base) {
        char[] digitAlphabet = {
            '0',
            '1',
            '2',
    ...
    public static String convertBase(String number, int sourceBase, int targetBase) {
        int decimalValue = 0;
        StringBuilder targetBaseNumberBuilder = new StringBuilder();
        ...
        while (decimalValue != 0) {
            ...
            if (remainder < 10) {
                targetBaseNumberBuilder.insert(0, remainder);
            } else {
                targetBaseNumberBuilder.insert(0, (char) (remainder + 55));
            }
            decimalValue /= targetBase;
        }

        return targetBaseNumberBuilder.toString();
    }
}