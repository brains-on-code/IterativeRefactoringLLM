...
public final class PalindromeSinglyLinkedList {
    ...
    /**
     * Returns {@code true} if the elements in the given {@link Iterable}
     * form a palindrome sequence.
     *
    ...
    /**
     * Returns {@code true} if the singly linked list starting at {@code head}
     * is a palindrome. Uses O(1) extra space.
     *
