...
public final class AmicableNumbers {
     ...
     *
     * <p>Proper divisors are all positive divisors of {@code number} excluding the
     * number itself.
     *
     * @param number the number whose proper divisors are summed, must be &gt; 0
    ...
    /**
     * Validates that the given range is positive and ordered correctly.
     *
    ...
    /**
     * Validates that all provided numbers are natural (greater than zero).
     *
     * @param numbers numbers to validate
     * @throws IllegalArgumentException if any number is not natural
     */
