...
public final class CrosswordSolver {
    ...
    public static boolean isValid(char[][] puzzle, String word, int row, int col, boolean vertical) {
        ...
        return vertical
            ? fitsVertically(puzzle, row, wordLength) && canPlaceVertically(puzzle, wordLength, row, col)
            : fitsHorizontally(puzzle, col, wordLength) && canPlaceHorizontally(puzzle, wordLength, row, col);
    }
