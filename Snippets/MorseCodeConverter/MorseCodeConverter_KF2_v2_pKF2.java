 ...
 * <p>Conventions:
 * <ul>
 *   <li>In text-to-Morse: input words are separated by a single space, output
 *       words are separated by {@code " | "}.</li>
 *   <li>In Morse-to-text: input words are separated by {@code " | "}.</li>
 * </ul>
 * </p>
 */
public final class MorseCodeConverter {

    /** Separator used between words in Morse representation. */
    private static final String MORSE_WORD_SEPARATOR = " | ";

    /** Separator used between letters in Morse representation. */
     ...
     *
     * <p>Input words must be separated by a single space. Output words are
