...
public final class WordPatternMatcher {
    ...
    public static boolean matchWordPattern(String pattern, String input) {
        ...
        return doesPatternMatch(pattern, input, 0, 0, charToWordMap, wordToCharMap);
    }
     ...
     */
    private static boolean doesPatternMatch(
        String pattern,
        String input,
        int patternIndex,
        int inputIndex,
        ...
        if (charToWordMap.containsKey(patternChar)) {
            String mappedWord = charToWordMap.get(patternChar);
        ...
        for (int endIndex = inputIndex + 1; endIndex <= input.length(); endIndex++) {
            ...
            charToWordMap.put(patternChar, candidateWord);
            wordToCharMap.put(candidateWord, patternChar);
            ...
            charToWordMap.remove(patternChar);
