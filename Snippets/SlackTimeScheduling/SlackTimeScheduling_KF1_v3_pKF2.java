...
public class TaskScheduler {
    ...
    /**
     * A scheduled task with a name, start time, and end time.
     */
    static class Task {
        ...
        /**
         * @return the duration of the task (endTime - startTime)
         */
        int getDuration() {
    ...
    /**
     * @return task names sorted by duration (shortest first)
     */
