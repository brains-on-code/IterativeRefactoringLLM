...
public final class CombinationsGenerator {
    ...
    public static List<List<Integer>> generateCombinations(int upperBound, int combinationSize) {
        ...
        backtrack(combinations, new ArrayList<>(), 0, upperBound, combinationSize);
        return combinations;
    }
     ...
     * @param nextValue          the current starting value for the next element to add
    ...
    private static void backtrack(
        ...
        for (int value = nextValue; value < upperBound; value++) {
            currentCombination.add(value);
            backtrack(combinations, currentCombination, value + 1, upperBound, combinationSize);
