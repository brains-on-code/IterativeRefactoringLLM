...
/**
 * Converts numbers from an arbitrary base (radix) to decimal.
 */
public final class AnyBaseToDecimal {

    /** Offset for numeric characters '0'–'9'. */
    private static final int DIGIT_CHAR_OFFSET = '0';

    /** Offset for uppercase alphabetic characters 'A'–'Z' (representing 10–35). */
