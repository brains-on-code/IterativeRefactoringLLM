...
public final class Class1 {
    ...
    public static boolean method1(BinaryTree.Node root1, BinaryTree.Node root2) {
        ...
        while (!firstQueue.isEmpty() && !secondQueue.isEmpty()) {
            ...
            if (!enqueueChildPair(firstNode.left, secondNode.left, firstQueue, secondQueue)) {
                return false;
            }

            if (!enqueueChildPair(firstNode.right, secondNode.right, firstQueue, secondQueue)) {
                return false;
            }
        }
    ...
    private static boolean enqueueChildPair(
