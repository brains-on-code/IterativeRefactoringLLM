...
class BellmanFord {
    ...
    public void runFromInput() {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            Edge[] inputEdges = readEdgesFromInput(sc, edgesCount);
            ...
            if (!hasNegativeCycle) {
                printDistancesFromSource(distance, 0);
                printAllPathsFromSource(parent, 0);
            }
        }
    }

    private Edge[] readEdgesFromInput(Scanner sc, int edgesCount) {
