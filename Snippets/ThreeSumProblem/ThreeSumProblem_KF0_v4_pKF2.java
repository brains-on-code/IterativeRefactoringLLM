...
public class ThreeSumProblem {
     ...
     *
     * Tries all possible triplets (i, j, k) with i < j < k and checks whether
     ...
     *    (i + 1 .. end) to find pairs such that nums[i] + nums[left] + nums[right] == target.
     ...
     *    compute the required third value as:
