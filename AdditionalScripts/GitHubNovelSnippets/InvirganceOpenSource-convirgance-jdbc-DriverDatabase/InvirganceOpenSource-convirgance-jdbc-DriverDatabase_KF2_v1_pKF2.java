...
class DriverDatabase implements Iterable<JSONObject> {
    ...
    public DriverDatabase() {
        ...
        File defaultLocation = new File(new File(new File(userHome, ".convirgance"), "database"), "drivers");
        File location = (driversProperty != null) ? new File(driversProperty) : defaultLocation;
