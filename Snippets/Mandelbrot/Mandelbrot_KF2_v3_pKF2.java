...
public final class Mandelbrot {
    ...
    /**
     * Maps a normalized escape distance to black or white.
     * Points that do not escape (normalized distance >= 1) are black; others are white.
     */
    ...
    /**
     * Maps a normalized escape distance to a simple HSV-like color gradient.
     * Points that do not escape (normalized distance >= 1) are black; others
     * receive a hue based on the normalized distance.
     */
     ...
     * the point did not escape within the maximum number of iterations.
     */
