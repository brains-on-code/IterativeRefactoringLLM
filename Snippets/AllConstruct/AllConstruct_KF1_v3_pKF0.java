...
public final class Class1 {
    ...
    public static List<List<String>> method1(String input, Iterable<String> dictionary) {
        ...
        for (int startIndex = 0; startIndex <= length; startIndex++) {
            List<List<String>> segmentationsStartingHere = segmentationsByIndex.get(startIndex);
            if (segmentationsStartingHere.isEmpty()) {
                continue;
            }
            ...
            for (String word : dictionary) {
                ...
                addWordToSegmentations(segmentationsByIndex, segmentationsStartingHere, word, endIndex);
            }
        }
    ...
    private static void addWordToSegmentations(
        ...
        for (List<String> baseSegmentation : baseSegmentations) {
            List<String> newSegmentation = new ArrayList<>(baseSegmentation);
