...
public final class AmicableNumbers {
    ...
    public static Set<Pair<Integer, Integer>> findAmicablePairs(int lowerBound, int upperBound) {
        ...
        for (int a = lowerBound; a < upperBound; a++) {
            ...
            if (!isValidAmicableCandidate(a, sumA, upperBound)) {
                continue;
            }
    ...
    private static boolean isValidAmicableCandidate(int number, int sumOfDivisors, int upperBound) {
        return sumOfDivisors > number && sumOfDivisors <= upperBound;
    }
    ...
    public static boolean areAmicable(int first, int second) {
        ...
        return sumOfProperDivisors(first) == second && sumOfProperDivisors(second) == first;
    }
