...
/**
 * Comparator for ordering Huffman nodes by frequency (ascending).
 */
...
/**
 * Demonstrates building a Huffman tree and printing the codes for each character.
 */
public final class Huffman {
    ...
    /**
     * Recursively traverses the Huffman tree and prints the code for each character.
     *
     * @param node current node in the Huffman tree
     * @param code binary code accumulated so far
     */
