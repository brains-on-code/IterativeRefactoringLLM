...
public final class Mandelbrot {
    ...
    private static double mapToRealCoordinate(
        ...
        return centerCoordinate + normalizedPosition * figureSize;
    }
    ...
    private static Color colorGradientMap(double normalizedDistance) {
        ...
        double fractionalPart = hue / 60 - Math.floor(hue / 60);

        int v = (int) value;
        int p = 0;
        int q = (int) (value * (1 - fractionalPart * saturation));
        int t = (int) (value * (1 - (1 - fractionalPart) * saturation));

        return switch (hueIndex) {
