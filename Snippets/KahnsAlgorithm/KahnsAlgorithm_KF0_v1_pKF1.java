...
class AdjacencyList<E extends Comparable<E>> {
     ...
     *
     * @param fromVertex the starting vertex of the directed edge
     * @param toVertex   the destination vertex of the directed edge
     */
    void addEdge(E fromVertex, E toVertex) {
        adjacencyMap.putIfAbsent(fromVertex, new ArrayList<>());
        adjacencyMap.get(fromVertex).add(toVertex);
        adjacencyMap.putIfAbsent(toVertex, new ArrayList<>());
    }
...
class TopologicalSort<E extends Comparable<E>> {
    ...
    void calculateInDegree() {
        ...
        for (E vertex : graph.getVertices()) {
            ...
            for (E adjacentVertex : graph.getAdjacents(vertex)) {
    ...
    ArrayList<E> topSortOrder() {
        ...
        while (!zeroInDegreeQueue.isEmpty()) {
            ...
            for (E adjacentVertex : graph.getAdjacents(currentVertex)) {
        ...
        if (processedVerticesCount != graph.getVertices().size()) {
...
public final class KahnsAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        for (String vertex : topologicalSort.topSortOrder()) {
