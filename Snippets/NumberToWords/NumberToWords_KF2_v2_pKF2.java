...
public final class NumberToWords {
    ...
    /** Word representations for numbers from 0 to 19. Index corresponds to the number. */
    ...
    /** Word representations for multiples of ten from 20 to 90. Index corresponds to the tens digit. */
    ...
    /** Scale words for powers of 1000. Index corresponds to the power (1000^index). */
     ...
     * @return the English word representation of the number, or "Invalid Input" if {@code number} is null
     */
     ...
     *
     * <p>For example, for 0.456 it returns "456". If the fractional part is zero or negative,
     ...
     *
     * <p>Each digit is converted individually (e.g., "0.45" -> "Point Four Five").
     *
     ...
     *
     * <p>The number is processed in chunks of three digits (thousands, millions, etc.).
     *
