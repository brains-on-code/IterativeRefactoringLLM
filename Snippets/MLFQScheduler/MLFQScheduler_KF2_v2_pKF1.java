...
public class MLFQScheduler {
    ...
    private final int[] timeQuantaPerLevel;
    private int currentTime;

    public MLFQScheduler(int numberOfPriorityLevels, int[] timeQuantaPerLevel) {
        ...
        this.timeQuantaPerLevel = timeQuantaPerLevel;
        this.currentTime = 0;
    }
        ...
        while (!areAllQueuesEmpty()) {
            for (int levelIndex = 0; levelIndex < priorityLevelQueues.size(); levelIndex++) {
                ...
                if (!queueAtCurrentLevel.isEmpty()) {
                    ...
                    int timeQuantumForCurrentLevel = timeQuantaPerLevel[levelIndex];

                    int timeSlice = Math.min(timeQuantumForCurrentLevel, processToRun.remainingTime);
