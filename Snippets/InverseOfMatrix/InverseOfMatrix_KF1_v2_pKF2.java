...
public final class Class1 {
    ...
    public static double[][] method1(double[][] matrix) {
        ...
        for (int col = 0; col < n; ++col) {
            // Backward substitution for Ux = y, where y is obtained implicitly
            // from forward substitution Ly = Pb using the pivot indices.
            inverse[n - 1][col] =
    ...
    private static void method2(double[][] matrix, int[] pivotIndices) {
        ...
        for (int col = 0; col < n - 1; ++col) {
            ...
            // Choose pivot row based on largest scaled element in this column.
            ...
            // Apply row permutation in pivot index array.
