...
public class BaconianCipher {
    ...
    private static void initializeMappings() {
        ...
        String jCode = BACONIAN_MAP.get('J');
        BACONIAN_MAP.put('I', jCode);
        REVERSE_BACONIAN_MAP.put(jCode, 'I');
    }
    ...
    public String decrypt(String ciphertext) {
        ...
        if (!isValidCiphertextLength(ciphertext)) {
            throw new IllegalArgumentException(
                "Ciphertext length must be a multiple of " + CODE_LENGTH
            );
        }
    ...
    private boolean isValidCiphertextLength(String ciphertext) {
        return ciphertext.length() % CODE_LENGTH == 0;
    }
}