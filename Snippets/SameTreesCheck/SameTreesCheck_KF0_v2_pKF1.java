...
public final class SameTreesCheck {
    ...
    public static boolean check(BinaryTree.Node firstRoot, BinaryTree.Node secondRoot) {
        ...
        while (!firstTreeQueue.isEmpty() && !secondTreeQueue.isEmpty()) {
            ...
            if (!nodesAreEqual(firstCurrentNode, secondCurrentNode)) {
                return false;
            }

            if (firstCurrentNode != null) {
                if (!nodesAreEqual(firstCurrentNode.left, secondCurrentNode.left)) {
                    return false;
                }
                ...
                if (!nodesAreEqual(firstCurrentNode.right, secondCurrentNode.right)) {
                    return false;
                }
