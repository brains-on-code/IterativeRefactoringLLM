...
public class CircularLookScheduling {
    ...
    public List<Integer> execute(List<Integer> requests) {
        ...
        List<Integer> scheduledRequests = movingUp
            ? scheduleWhenMovingUp(upRequests, downRequests)
            : scheduleWhenMovingDown(upRequests, downRequests);
    ...
    private List<Integer> scheduleWhenMovingUp(
        List<Integer> upRequests,
        List<Integer> downRequests
    ) {
        List<Integer> scheduled = new ArrayList<>(upRequests.size() + downRequests.size());
        scheduled.addAll(upRequests);
        scheduled.addAll(downRequests);
        return scheduled;
    }

    private List<Integer> scheduleWhenMovingDown(
        List<Integer> upRequests,
        List<Integer> downRequests
    ) {
        List<Integer> scheduled = new ArrayList<>(upRequests.size() + downRequests.size());
