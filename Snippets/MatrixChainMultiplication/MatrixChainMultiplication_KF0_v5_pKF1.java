...
public final class MatrixChainMultiplication {
    ...
    public static class Result {
         ...
         * @param splitIndexTable the matrix of optimal split points.
         */
