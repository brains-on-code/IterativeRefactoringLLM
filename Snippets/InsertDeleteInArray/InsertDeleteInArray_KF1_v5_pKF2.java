...
public final class Class1 {
    ...
    public static void method1(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            int[] arrayAfterInsertion = performInsertion(scanner, originalArray);
            int[] arrayAfterDeletion = performDeletion(scanner, arrayAfterInsertion);
    ...
    private static int[] performInsertion(Scanner scanner, int[] array) {
    ...
    private static int[] performDeletion(Scanner scanner, int[] array) {
