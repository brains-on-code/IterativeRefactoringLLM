...
public final class MidpointCircle {
     ...
     * @param centerX         The x-coordinate of the circle's center.
     * @param centerY         The y-coordinate of the circle's center.
     * @param xOffsetFromCenter The current x-offset from the center on the circumference.
     * @param yOffsetFromCenter The current y-offset from the center on the circumference.
     */
    private static void addSymmetricPoints(
        ...
        points.add(new int[] {centerX + xOffsetFromCenter, centerY + yOffsetFromCenter});
        points.add(new int[] {centerX - xOffsetFromCenter, centerY + yOffsetFromCenter});
        points.add(new int[] {centerX + xOffsetFromCenter, centerY - yOffsetFromCenter});
        points.add(new int[] {centerX - xOffsetFromCenter, centerY - yOffsetFromCenter});
        points.add(new int[] {centerX + yOffsetFromCenter, centerY + xOffsetFromCenter});
        points.add(new int[] {centerX - yOffsetFromCenter, centerY + xOffsetFromCenter});
        points.add(new int[] {centerX + yOffsetFromCenter, centerY - xOffsetFromCenter});
        points.add(new int[] {centerX - yOffsetFromCenter, centerY - xOffsetFromCenter});
    }
