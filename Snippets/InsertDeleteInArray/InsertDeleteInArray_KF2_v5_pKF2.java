...
public final class InsertDeleteInArray {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            int[] arrayAfterInsert = promptAndInsert(scanner, originalArray);
            System.out.println("Array after insertion:");
            printArray(arrayAfterInsert);

            int[] arrayAfterDelete = promptAndDelete(scanner, arrayAfterInsert);
    ...
    private static int[] promptAndInsert(Scanner scanner, int[] array) {
    ...
    private static int[] promptAndDelete(Scanner scanner, int[] array) {
