...
public final class InverseOfMatrix {
    ...
    private static void forwardSubstitution(double[][] lu, double[][] rhs, int[] pivotIndices) {
        int size = lu.length;
        ...
        for (int pivot = 0; pivot < size - 1; pivot++) {
            ...
            for (int row = pivot + 1; row < size; row++) {
                ...
                for (int col = 0; col < size; col++) {
                    rhs[currentRowIndex][col] -= factor * rhs[pivotRowIndex][col];
                }
            }
        }
    }
    ...
    private static void backSubstitution(
        ...
        for (int col = 0; col < size; col++) {
            ...
            inverse[size - 1][col] =
                rhs[lastPivotRowIndex][col] / lu[lastPivotRowIndex][size - 1];
