...
public class SimpleSubCipher {
    ...
    private Map<Character, Character> buildCipherMap(String cipherSmall, boolean encoding) {
        ...
        for (int i = 0; i < limit; i++) {
            ...
            if (encoding) {
                mapPlainToCipher(cipherMap, lowerPlain, upperPlain, lowerCipher, upperCipher);
            } else {
                mapCipherToPlain(cipherMap, lowerPlain, upperPlain, lowerCipher, upperCipher);
            }
        }
