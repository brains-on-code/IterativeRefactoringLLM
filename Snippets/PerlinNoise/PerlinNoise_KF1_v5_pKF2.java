...
public final class FractalNoiseGenerator {
    ...
    /**
     * Generates a 2D fractal noise map using multiple octaves of interpolated random noise.
     *
    ...
    static float[][] generateFractalNoise(
        ...
        float totalAmplitude = blendOctaves(resultNoise, octaveNoise, width, height, octaveCount, persistence);
        normalizeNoise(resultNoise, width, height, totalAmplitude);
    ...
    /**
     * Blends all octave noise maps into the result noise map.
     *
    ...
    /**
     * CLI entry point: generates a noise map and prints it using a character set as a gradient.
     *
     * @param args ignored
     */
