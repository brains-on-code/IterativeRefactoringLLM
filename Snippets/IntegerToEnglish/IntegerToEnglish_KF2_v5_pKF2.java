...
public final class IntegerToEnglish {
    ...
    /**
     * Appends the English words for the tens and ones part (0–99) of a number.
     *
     * @param result    the StringBuilder to append to
     * @param remainder the value between 0 and 99
     */
    ...
    /**
     * Prepends the appropriate thousand-power suffix (e.g., "Thousand", "Million")
     * to a group of words and inserts it into the final result.
     *
     * @param result             the StringBuilder holding the final phrase
     * @param groupWords         the words for the current 3-digit group
     * @param thousandGroupIndex the index of the group (0 = units, 1 = thousands, etc.)
     */
