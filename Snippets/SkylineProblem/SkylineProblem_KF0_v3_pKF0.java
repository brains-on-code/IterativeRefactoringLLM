...
public class SkylineProblem {
    ...
    public List<Skyline> mergeSkyline(List<Skyline> leftSkyline, List<Skyline> rightSkyline) {
        ...
        appendRemainingPoints(merged, leftSkyline, leftIndex, currentMaxHeight);
        appendRemainingPoints(merged, rightSkyline, rightIndex, currentMaxHeight);

        return merged;
    }

    private void appendRemainingPoints(List<Skyline> result, List<Skyline> source, int startIndex, int currentMaxHeight) {
        int lastHeight = currentMaxHeight;
        for (int i = startIndex; i < source.size(); i++) {
            Skyline point = source.get(i);
