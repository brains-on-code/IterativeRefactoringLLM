...
/**
 * Computes strongly connected components (SCCs) in a directed graph
...
public class StronglyConnectedComponents {
     ...
     *
     * Runs DFS on the original graph and pushes each vertex onto the stack
     * after exploring all its descendants. The stack will contain vertices
     * ordered by decreasing finishing time.
     */
     ...
     *
     * Starting from a given vertex, this DFS collects all vertices reachable
     * in the transposed graph, which together form a single SCC.
     */
    ...
    public int countStronglyConnectedComponents(
        ...
        // First pass: DFS on the original graph to fill the stack by finish time
