...
class BMPUtil {
    ...
    private static final int BITS_PER_PIXEL = 24; // RGB
    private static final int COMPRESSION = 0;     // BI_RGB
    private int imageSize = 0x030000;
    private static final int X_PIXELS_PER_METER = 0x0;
    private static final int Y_PIXELS_PER_METER = 0x0;
