...
public final class CrosswordSolver {
    ...
    public static boolean isValid(char[][] puzzle, String word, int row, int col, boolean vertical) {
        ...
        if (vertical) {
            return fitsVertically(puzzle, row, wordLength)
                && canPlaceVertically(puzzle, wordLength, row, col);
        }

        return fitsHorizontally(puzzle, col, wordLength)
            && canPlaceHorizontally(puzzle, wordLength, row, col);
    }
    ...
    private static boolean canPlaceVertically(char[][] puzzle, int wordLength, int row, int col) {
    ...
    private static boolean canPlaceHorizontally(char[][] puzzle, int wordLength, int row, int col) {
        for (int i = 0; i < wordLength; i++) {
