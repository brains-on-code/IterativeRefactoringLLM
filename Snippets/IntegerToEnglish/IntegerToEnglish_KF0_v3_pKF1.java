...
public final class IntegerToEnglish {
    ...
    private static String convertNumberUnderThousandToWords(int numberUnderThousand) {
        ...
        if (lastTwoDigits <= 20) {
            ...
            String tensWord = BASE_NUMBERS_MAP.getOrDefault(tens * 10, "");
            String onesWord = BASE_NUMBERS_MAP.getOrDefault(ones, "");
        ...
        int hundreds = numberUnderThousand / 100;
        if (hundreds > 0) {
            if (wordsBuilder.length() > 0) {
                wordsBuilder.insert(0, " ");
            }
            wordsBuilder.insert(0, String.format("%s Hundred", BASE_NUMBERS_MAP.get(hundreds)));
        }
    ...
    public static String integerToEnglishWords(int number) {
        ...
        while (number > 0) {
            ...
            if (threeDigitGroup > 0) {
                String groupWords = convertNumberUnderThousandToWords(threeDigitGroup);
