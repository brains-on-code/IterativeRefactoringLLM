...
public final class Manacher {
    ...
    public static String longestPalindrome(String s) {
        ...
        // radius[i] is the radius of the palindrome centered at i in the processed string
        ...
        for (int i = 1; i < n - 1; i++) {
            ...
            // Initialize radius[i] using the mirror's radius if within the current right boundary
            if (i < right) {
            ...
            // Update center and right if the palindrome at i extends beyond the current right boundary
            if (i + radius[i] > right) {
                center = i;
                right = i + radius[i];
            }
        ...
        // Map back from processed string indices to original string indices
