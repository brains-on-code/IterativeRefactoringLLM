...
public final class CatalanNumber {
    ...
    static long computeCatalanNumber(int n) {
        ...
        for (int index = 2; index <= n; index++) {
            catalanNumbers[index] = 0;
            for (int partitionIndex = 0; partitionIndex < index; partitionIndex++) {
                catalanNumbers[index] +=
                    catalanNumbers[partitionIndex] * catalanNumbers[index - partitionIndex - 1];
            }
        }
