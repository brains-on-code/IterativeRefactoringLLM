...
public class GepettoApplication {
	...
	private CommandLine createConfiguredCommandLine(CommandLine.IFactory factory, GepettoCommand command) {
		return new CommandLine(command, factory)
				...
				.setParameterExceptionHandler(this::handleParameterException);
	}

	private int handleExecutionException(Throwable ex, CommandLine commandLine, CommandLine.ParseResult parseResult) {
