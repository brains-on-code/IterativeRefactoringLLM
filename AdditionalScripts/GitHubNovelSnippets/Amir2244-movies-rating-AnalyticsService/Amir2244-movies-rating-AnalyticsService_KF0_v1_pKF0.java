...
public class AnalyticsService implements GetAnalyticsUseCase {
    ...
    public AnalyticsSummary getAnalyticsSummary() {
        ...
        String latestDate = loadAnalyticsPort.getLatestAnalyticsTimestamp().orElse(NOT_AVAILABLE);
        String oldestDate = loadAnalyticsPort.getOldestAnalyticsTimestamp().orElse(NOT_AVAILABLE);
