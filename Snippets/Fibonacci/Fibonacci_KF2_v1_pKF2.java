...
public final class Fibonacci {
    ...
    /** Cache used for memoized Fibonacci computation. */
     ...
     * Note: This method uses floating-point arithmetic and may be inaccurate
     * for large values of n due to rounding errors.
     *
     * @param n index of the Fibonacci number (must be non-negative)
