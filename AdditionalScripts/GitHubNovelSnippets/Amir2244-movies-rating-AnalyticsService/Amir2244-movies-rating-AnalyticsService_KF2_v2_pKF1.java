...
public class AnalyticsService implements GetAnalyticsUseCase {
    ...
    public List<AnalyticsTypeInfo> getAvailableAnalyticsTypes() {
        ...
        return analyticsCountByType.entrySet().stream()
                .map(analyticsTypeCountEntry -> new AnalyticsTypeInfo(
                        analyticsTypeCountEntry.getKey().name(),
                        analyticsTypeCountEntry.getKey().getCategory(),
                        analyticsTypeCountEntry.getKey().getDescription(),
                        analyticsTypeCountEntry.getValue()
                ))
