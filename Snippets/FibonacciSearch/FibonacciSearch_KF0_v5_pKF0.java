...
public class FibonacciSearch implements SearchAlgorithm {
    ...
    public <T extends Comparable<T>> int find(T[] array, T key) {
        ...
        int fibCurrent = smallestFibGreaterOrEqual(fibMinusTwo, fibMinusOne, length);
        int offset = -1;
        ...
        while (fibCurrent > 1) {
            ...
            if (comparison < 0) {
                // Move the three Fibonacci variables down one
                int previousFibMinusOne = fibMinusOne;
                fibMinusOne = fibMinusTwo;
                fibMinusTwo = fibCurrent - fibMinusOne;
                fibCurrent = previousFibMinusOne;
                offset = index;
    ...
    private int smallestFibGreaterOrEqual(int fibMinusTwo, int fibMinusOne, int length) {
        int fibCurrent = fibMinusOne + fibMinusTwo;
