...
public final class PangramUtils {
    ...
    /**
     * Simple self-test for the pangram checker {@link #isPangramWithBooleanArray(String)}.
     *
     * @param args ignored
     */
     ...
     *     <li>Ignore non-letter characters</li>
     *     <li>Count distinct alphabetic characters</li>
     * </ol>
     *
     ...
     *     <li>Map letters 'a'–'z' to indices 0–25</li>
     *     <li>Mark presence of each letter</li>
     * </ol>
     *
     * @param text the input string to check
     * @return {@code true} if the string is a pangram, {@code false} otherwise
     ...
     * Steps:
     * <ol>
     *     <li>Return early if the string is shorter than 26 characters</li>
     *     <li>Convert the string to lowercase</li>
     *     <li>Verify that each letter 'a'–'z' appears at least once</li>
     * </ol>
     *
     * @param text the input string to check
     * @return {@code true} if the string is a pangram, {@code false} otherwise
