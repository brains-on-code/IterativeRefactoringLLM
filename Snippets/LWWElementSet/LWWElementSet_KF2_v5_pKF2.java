...
class LWWElementSet {
    ...
    /**
     * Adds or updates an element in the remove-set only if it is
     * currently present according to LWW semantics.
     */
    ...
    /**
     * Checks whether the given key is currently present
     * in the set according to LWW semantics.
     */
    public boolean lookup(String key) {
        Element addedElement = addSet.get(key);
        Element removedElement = removeSet.get(key);
