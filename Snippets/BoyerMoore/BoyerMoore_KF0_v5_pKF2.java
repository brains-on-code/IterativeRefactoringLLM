...
public final class BoyerMoore {
    ...
    public static Optional<Integer> findMajorityElement(int[] array) {
        ...
        if (isMajority(occurrences, array.length)) {
    ...
    /**
     * Runs the Boyer–Moore voting process to select a majority candidate.
     * Note: the returned candidate is not guaranteed to be a majority element.
     *
     * @param array the input array (assumed non-empty)
