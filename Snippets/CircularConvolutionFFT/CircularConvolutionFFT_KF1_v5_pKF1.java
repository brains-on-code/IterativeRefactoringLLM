...
public final class ConvolutionUtils {
    ...
    public static ArrayList<FFT.Complex> convolve(ArrayList<FFT.Complex> firstSignal,
        ...
        ArrayList<FFT.Complex> frequencyDomainSamples = new ArrayList<>(paddedLength);
        for (int i = 0; i < paddedLength; i++) {
            FFT.Complex sampleProduct = firstSignal.get(i).multiply(secondSignal.get(i));
            frequencyDomainSamples.add(sampleProduct);
        }

        FFTBluestein.fftBluestein(frequencyDomainSamples, true);
