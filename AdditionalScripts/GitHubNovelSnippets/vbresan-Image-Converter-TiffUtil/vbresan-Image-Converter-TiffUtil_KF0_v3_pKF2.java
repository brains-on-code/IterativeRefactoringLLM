...
public class TiffUtil {
    ...
    /**
     * Reads basic TIFF info (dimensions, directory count, etc.) without decoding pixels.
     */
    ...
    /**
     * Builds a new filename with page index and desired extension.
     *
     * Example:
     *   base: "image.tif", current: 1, total: 10, format: JPG
     *   -> "image (0001 of 0010).jpg"
     */
    ...
    /**
     * Uses the library's direct TIFF → {BMP,JPG,PNG} conversion for a single directory.
     */
    ...
    /**
     * Encodes a bitmap into a TIFF file.
     */
    ...
    /**
     * Converts a single TIFF directory (page) to the requested format.
     *
     * Tries to decode to Bitmap first; if that fails (bitmap == null),
     * falls back to direct TIFF → {BMP,JPG,PNG} conversion.
     */
    private static void convertFromTIFSinglePage(
        ...
        /*
         * For some files (e.g. "0004 TEST.tif") this call may return null.
         * It ultimately calls the native method NativeDecoder.getBitmap().
         * In that case we fall back to direct conversion.
         */
    ...
    /**
     * Converts all pages (directories) of a TIFF file to the given format.
     *
     * @return list of output filenames and their URIs
     * @throws EncodeException if one or more pages fail to convert
     */
    ...
    /**
     * Checks whether the given file is a TIFF by attempting to read its bounds.
     */
