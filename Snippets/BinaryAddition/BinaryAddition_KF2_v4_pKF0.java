...
public class BinaryAddition {
    ...
    public String addBinary(String firstBinary, String secondBinary) {
        ...
        for (int index = maxLength - 1; index >= 0; index--) {
            char firstBit = paddedFirst.charAt(index);
            char secondBit = paddedSecond.charAt(index);

            char sumBit = calculateSumBit(firstBit, secondBit, carry);
            carry = calculateCarryBit(firstBit, secondBit, carry);
