...
public final class PalindromicPartitioning {
    ...
    /**
     * Fills the isPalindrome table where isPalindrome[i][j] is true
     * if and only if the substring word[i..j] is a palindrome.
     */
    ...
    /**
     * Uses the precomputed palindrome table to fill the minCuts array,
     * where minCuts[i] is the minimum number of cuts needed for word[0..i].
     */
