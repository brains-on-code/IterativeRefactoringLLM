...
/**
 * Utility methods for working with integer intervals.
 *
...
public final class IntervalUtils {
    ...
    /**
     * Returns whether any two intervals in the given array overlap.
     *
     * <p>Two intervals overlap if there exists at least one point that belongs
    ...
    /**
     * Applies the difference-array technique to mark interval coverage.
     *
     * <p>For each interval {@code [start, end]}, this:
     * <ul>
     *   <li>increments {@code diff[start]}</li>
     *   <li>decrements {@code diff[end + 1]}</li>
     * </ul>
     *
     * <p>A subsequent prefix sum over {@code diff} yields the number of active
     ...
     * by taking a prefix sum over the difference array.
     *
     * @param diff difference array representing interval starts and ends
     * @return maximum number of active intervals at any point
     */
