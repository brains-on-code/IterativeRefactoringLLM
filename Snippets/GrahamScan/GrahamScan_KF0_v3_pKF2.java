...
public class GrahamScan {
    ...
    /**
     * Sorts points so that:
     * 1. points[0] is the reference point (lowest y, then lowest x)
     * 2. Remaining points are sorted by polar angle with respect to points[0]
     */
    ...
    /**
     * Returns the index of the first point that is not equal to points[0].
     * If all points are equal, returns points.length.
     */
    ...
    /**
     * Returns the index of the first point that is not collinear with points[0]
     * and points[firstDistinctIndex], scanning forward from firstDistinctIndex + 1.
     */
    ...
    /**
     * Constructs the convex hull using a stack-based Graham Scan.
     */
