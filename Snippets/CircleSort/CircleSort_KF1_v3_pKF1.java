...
public class SymmetryPartitionSort implements SortAlgorithm {
    ...
    private <T extends Comparable<T>> boolean partitionAndSwap(final T[] array, final int startIndex, final int endIndex) {
        ...
        final boolean leftPartitionSwapped = partitionAndSwap(array, startIndex, middleIndex);
        final boolean rightPartitionSwapped = partitionAndSwap(array, middleIndex + 1, endIndex);

        return didSwap || leftPartitionSwapped || rightPartitionSwapped;
    }
}