...
public final class Class1 {
     ...
     * @return true if a valid mapping exists from this state onward
     */
    private static boolean backtrack(
        ...
        // Existing mapping for currentChar: verify it matches at the current position in str
        ...
        // No mapping yet: try all possible non-empty substrings starting at strIndex
