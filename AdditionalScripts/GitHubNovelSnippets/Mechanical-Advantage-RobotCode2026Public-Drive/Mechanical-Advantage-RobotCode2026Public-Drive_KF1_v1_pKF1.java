...
public class Class1 extends FullSubsystem {
  ...
  private final Module[] modules = new Module[4]; // whose, knife, garage, views
  ...
  public Class1(GyroIO gyroIO, ModuleIO frontLeftIO, ModuleIO frontRightIO, ModuleIO backLeftIO, ModuleIO backRightIO) {
    this.gyroIO = gyroIO;
