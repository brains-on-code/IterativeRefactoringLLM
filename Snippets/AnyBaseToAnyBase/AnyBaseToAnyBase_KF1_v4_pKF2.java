...
public final class BaseConverter {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (true) {
                try {
                    ...
                    System.out.print(
                        "Enter beginning base (between " + MIN_BASE + " and " + MAX_BASE + "): "
                    );
                    ...
                    System.out.print(
                        "Enter end base (between " + MIN_BASE + " and " + MAX_BASE + "): "
                    );
    ...
    /**
     * Returns whether a base is within the supported range.
     *
     * @param base the base to check
     * @return {@code true} if {@code base} is between {@link #MIN_BASE} and {@link #MAX_BASE}
    ...
    /**
     * Returns whether the given number string is valid for the specified base.
     *
     * @param number the number as a string (using digits 0–9 and uppercase A–Z)
     * @param base   the base to validate against
     * @return {@code true} if {@code number} is valid for {@code base}, {@code false} otherwise
     */
