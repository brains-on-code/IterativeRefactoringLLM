...
public final class PrimeCheck {
    ...
    private static void printDeterministicCheckResult(int number) {
        String message = isPrime(number)
            ? "algo1 verify that " + number + " is a prime number"
            : "algo1 verify that " + number + " is not a prime number";
        System.out.println(message);
    }

    private static void printFermatCheckResult(int number, int iterations) {
        String message = isProbablyPrimeFermat(number, iterations)
            ? "algo2 verify that " + number + " is a prime number"
            : "algo2 verify that " + number + " is not a prime number";
        System.out.println(message);
    }
