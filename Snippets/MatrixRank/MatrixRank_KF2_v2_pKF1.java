...
public final class MatrixRank {
    ...
    public static int computeRank(double[][] inputMatrix) {
        ...
        double[][] workingMatrix = deepCopyMatrix(inputMatrix);
    ...
    private static double[][] deepCopyMatrix(double[][] sourceMatrix) {
